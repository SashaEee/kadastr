...
class SearchAddressItem(object):
    ...
    def serialize(self, xml0_ : XmlWriter) -> None:
        ...
        if (self.ignore_territories): 
            xml0_.write_attribute_string("ignoreterr", "true")
    ...
    def deserialize(self, xml0_ : xml.etree.ElementTree.Element) -> None:
        if (xml0_.attrib is not None): 
            for a in xml0_.attrib.items(): 
                ...
                elif (Utils.getXmlAttrLocalName(a) == "ignoreterr"): 
                    self.ignore_territories = a[1] == "true"
        for x in xml0_: 
    ...
    @staticmethod
    def _new87(_arg1 : 'SearchLevel', _arg2 : str) -> 'SearchAddressItem':
    ...
    @staticmethod
    def _new88(_arg1 : 'SearchLevel', _arg2 : str) -> 'SearchAddressItem':
        res = SearchAddressItem()
        res.level = _arg1
        res.text = _arg2
        return res
    ...
    @staticmethod
    def _new97(_arg1 : str, _arg2 : 'SearchLevel', _arg3 : object, _arg4 : str) -> 'SearchAddressItem':
        res = SearchAddressItem()
        res.id0_ = _arg1
        res.level = _arg2
        res.tag = _arg3
    ...
    @staticmethod
    def _new99(_arg1 : str, _arg2 : object, _arg3 : 'SearchLevel', _arg4 : 'SearchAddressItem', _arg5 : str) -> 'SearchAddressItem':
        res = SearchAddressItem()
        res.id0_ = _arg1
        res.tag = _arg2
        res.level = _arg3
    ...
    @staticmethod
    def _new101(_arg1 : str, _arg2 : object, _arg3 : 'SearchLevel', _arg4 : str) -> 'SearchAddressItem':
        res = SearchAddressItem()
        res.id0_ = _arg1
        res.tag = _arg2
        res.level = _arg3
