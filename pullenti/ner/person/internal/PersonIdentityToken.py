...
class PersonIdentityToken(MetaToken):
    ...
    def create_lastname(pit : 'PersonItemToken', inf : 'MorphBaseInfo') -> 'PersonMorphCollection':
        ...
        if (pit.lastname is None): 
            ...
            mc = pit.begin_token.get_morph_class_in_dictionary()
            if (mc.is_noun and not mc.is_proper_surname): 
                if (pit.begin_token.is_value("ОТВЕТЧИК", None) or pit.begin_token.is_value("ИСТЕЦ", None)): 
                    return None
            ...
            for ot in otl: 
                if (ot.end_token == pits[ind].end_token): 
                    ...
                    if (inf.gender == MorphGender.MASCULINE): 
                        ...
                        pass
                    inf0 = MorphBaseInfo._new2775(inf.case_, inf.gender)
                    ...
                    if ((pit is None and len(pits) == 1 and len(vars0_) == 0) and pers.find_slot(None, pits[0].value, True) is not None): 
                        ...
                        pit = PersonIdentityToken._new2776(pits[0].begin_token, pits[0].end_token, 3, FioTemplateType.UNDEFINED)
                        pit.ontology_person = p
    ...
    def try_attach_for_ext_onto(pits : typing.List['PersonItemToken']) -> typing.List['PersonIdentityToken']:
        ...
        if (len(pits) == 3): 
            if (pits[0].typ == PersonItemToken.ItemType.VALUE and pits[1].typ == PersonItemToken.ItemType.INITIAL and pits[2].typ == PersonItemToken.ItemType.VALUE): 
                pit = PersonIdentityToken._new2777(pits[0].begin_token, pits[2].end_token, FioTemplateType.NAMEISURNAME)
                ...
                if (pits[0].firstname is None and pits[1].middlename is None and ((pits[1].firstname is not None or pits[2].middlename is not None))): 
                    ...
                    ok = True
                if (ok): 
                    pit = PersonIdentityToken._new2777(pits[0].begin_token, pits[2].end_token, FioTemplateType.SURNAMENAMESECNAME)
            ...
            for i in range(2):
                if (((pits[i].firstname is not None and pits[i].firstname.is_in_dictionary)) or ((pits[i ^ 1].lastname is not None and ((pits[i ^ 1].lastname.is_in_dictionary or pits[i ^ 1].lastname.is_lastname_has_std_tail))))): 
                    ...
                    break
            if (nam is not None): 
                pit = PersonIdentityToken._new2777(pits[0].begin_token, pits[1].end_token, (FioTemplateType.NAMESURNAME if nam == pits[0] else FioTemplateType.SURNAMENAME))
    ...
    def manage_lastname(res : 'PersonIdentityToken', pit : 'PersonItemToken', inf : 'MorphBaseInfo') -> None:
        if (pit.lastname is None): 
            ...
            if (len(res.lastname.items) == 0 and pit.value is not None): 
                res.lastname.items.append(PersonMorphCollection.PersonMorphVariant._new2780(pit.value))
        ...
        if (pit.firstname is None): 
            ...
            if (pit.value.find('-') > 0 and pit.end_token.get_morph_class_in_dictionary().is_proper_name): 
                if (pit.lastname is not None): 
                    ...
                    res.firstname.items.append(PersonMorphCollection.PersonMorphVariant._new2780(pit.value))
            else: 
                if (pit.lastname is not None): 
                    res.coef -= 1
                if (pit.is_in_dictionary): 
    ...
    def __try_attach_single_surname(pits : typing.List['PersonItemToken'], ind : int, inf : 'MorphBaseInfo') -> 'PersonIdentityToken':
        ...
        if (ind == 0 and len(pits) == 1): 
            ...
            if (((ind + 1) < len(pits)) and ((not pits[ind + 1].is_in_dictionary or pits[ind + 1].typ == PersonItemToken.ItemType.INITIAL or pits[ind + 1].firstname is not None))): 
                res.coef -= 1
            if (((ind + 1) < len(pits)) and (isinstance(pits[ind + 1].begin_token, ReferentToken))): 
                res.coef += 1
    ...
    def __try_attach_name_surname(pits : typing.List['PersonItemToken'], ind : int, inf : 'MorphBaseInfo', prev_has_this_typ : bool=False, is_attr_before : bool=False) -> 'PersonIdentityToken':
        ...
        if (PersonIdentityToken.__is_both_surnames(pits[ind], pits[ind + 1])): 
            if (len(pits) == 2 and ind == 0 and is_attr_before): 
                ...
                return None
        if (pits[ind].begin_token.is_value("СЛАВА", None)): 
            mc2 = pits[ind].begin_token.get_morph_class_in_dictionary()
            if (not mc2.is_proper_surname): 
                return None
        res = PersonIdentityToken._new2777(pits[ind].begin_token, pits[ind + 1].end_token, FioTemplateType.NAMESURNAME)
        res.coef -= (ind)
        ...
        if (res.morph.gender == MorphGender.MASCULINE or res.morph.gender == MorphGender.FEMINIE): 
            if (pits[ind + 1].lastname is not None and not pits[ind + 1].lastname.morph.case_.is_undefined): 
                ...
                if ((pits[ind].lastname is not None and pits[ind].lastname.is_lastname_has_std_tail and pits[ind + 1].firstname is not None) and pits[ind + 1].firstname.is_in_dictionary): 
                    if (pits[ind].firstname is not None and pits[ind + 1].lastname is not None and pits[ind + 1].lastname.is_lastname_has_std_tail): 
                        pass
                    else: 
                        res.coef -= (2)
            inf = (res.morph)
        ...
        if (mc.is_pronoun and pits[ind].firstname is None): 
            return None
        if (mc.is_proper_geo): 
            mc1 = pits[ind + 1].begin_token.get_morph_class_in_dictionary()
            if (mc1.is_proper_geo): 
                res.coef -= (3)
        ...
        if (pits[ind].is_in_dictionary): 
            if (pits[ind + 1].is_in_dictionary): 
                ...
                if (pits[ind + 1].is_newline_after): 
                    res.coef += 1
                elif (isinstance(pits[ind + 1].end_token.next0_, TextToken)): 
                    ttt = pits[ind + 1].end_token.next0_
                    if (ttt.is_char_of(".,:")): 
                        res.coef += 1
                    elif (ttt.is_pure_verb and pits[ind + 1].chars.is_capital_upper): 
                        res.coef += (3)
        ...
        if (ind > 0 and res.coef > 0 and pits[ind].is_hiphen_before): 
            ...
            if (b1 is not None and b1.second_count == b1.pair_count): 
                res0 = PersonIdentityToken._new2777(pits[ind].begin_token, pits[ind + 1].end_token, FioTemplateType.NAMESURNAME)
    ...
    def __try_attach_name_secname_surname(pits : typing.List['PersonItemToken'], ind : int, inf : 'MorphBaseInfo', prev_has_this_typ : bool=False) -> 'PersonIdentityToken':
        ...
        if (pits[ind + 1].middlename is None and pits[ind + 1].lastname is not None): 
            if (pits[ind + 2].lastname is not None and (((pits[ind + 2].lastname.is_in_dictionary or pits[ind + 2].lastname.is_in_ontology or pits[ind + 2].lastname.is_has_std_postfix) or pits[ind + 2].lastname.is_lastname_has_hiphen or pits[ind + 2].lastname.is_lastname_has_std_tail))): 
                pass
            else: 
                res.coef -= (2)
    ...
    def __try_attach_surname_name(pits : typing.List['PersonItemToken'], ind : int, inf : 'MorphBaseInfo', prev_has_this_typ : bool=False) -> 'PersonIdentityToken':
        ...
        if (pits[ind + 1].begin_token.chars.is_all_upper and not pits[ind].begin_token.chars.is_all_upper): 
            if (pits[ind + 1].firstname is None or not pits[ind + 1].firstname.is_in_dictionary): 
                return None
        if (inf is not None and ((inf.gender == MorphGender.MASCULINE or inf.gender == MorphGender.FEMINIE))): 
            mas = 0
            fam = 0
            pp = pits[ind].lastname
            if (pp is not None and len(pp.vars0_) == 1): 
                if (pp.vars0_[0].gender == MorphGender.FEMINIE): 
                    fam += 1
                elif (pp.vars0_[0].gender == MorphGender.MASCULINE): 
                    mas += 1
            pp = pits[ind + 1].firstname
            if (pp is not None and len(pp.vars0_) == 1): 
                if (pp.vars0_[0].gender == MorphGender.FEMINIE): 
                    fam += 1
                elif (pp.vars0_[0].gender == MorphGender.MASCULINE): 
                    mas += 1
            if (mas > fam and inf.gender == MorphGender.FEMINIE): 
                return None
            if ((mas < fam) and inf.gender == MorphGender.MASCULINE): 
                return None
        res = PersonIdentityToken._new2777(pits[ind].begin_token, pits[ind + 1].end_token, FioTemplateType.SURNAMENAME)
        res.coef -= (ind)
        if (pits[ind].is_newline_after): 
            res.coef -= 1
        ...
        if (pits[0].lastname is None or not pits[0].lastname.is_lastname_has_std_tail): 
            ...
            if (stat is not None and stata is not None and statb is not None): 
                if (stat.like_chars_after_words is not None and stat.like_chars_before_words is not None): 
                    coua = 0
                    coub = 0
                    wrapcoua2786 = RefOutArgWrapper(0)
                    Utils.tryGetValue(stat.like_chars_after_words, stata, wrapcoua2786)
                    coua = wrapcoua2786.value
                    wrapcoub2785 = RefOutArgWrapper(0)
                    Utils.tryGetValue(stat.like_chars_before_words, statb, wrapcoub2785)
                    coub = wrapcoub2785.value
    ...
    def __try_attach_surname_name_secname(pits : typing.List['PersonItemToken'], ind : int, inf : 'MorphBaseInfo', prev_has_this_typ : bool=False, always : bool=False) -> 'PersonIdentityToken':
        ...
        if (pits[ind].lastname is None and not prev_has_this_typ): 
            ...
            if (len(pits) == 3 and not always): 
                ...
                if (tt1 is not None and not tt1.is_newline_before and PersonAttrToken.try_attach(tt1, PersonAttrToken.PersonAttrAttachAttrs.ONLYKEYWORD) is not None): 
                    ...
                    return None
        if (pits[ind].fio_pref == 1 and pits[ind + 1].fio_pref == 2 and pits[ind + 2].fio_pref == 3): 
            always = True
        if (not always): 
            if (PersonIdentityToken.__is_both_surnames(pits[ind], pits[ind + 2])): 
                return None
        ...
        if (pits[ind + 2].begin_token.chars.is_all_upper and not pits[ind].begin_token.chars.is_all_upper and pits[ind + 2].typ == PersonItemToken.ItemType.VALUE): 
            if (pits[ind + 2].middlename is None or not pits[ind + 2].middlename.is_in_dictionary): 
                return None
        res = PersonIdentityToken._new2777(pits[ind].begin_token, pits[ind + 2].end_token, FioTemplateType.SURNAMENAMESECNAME)
        ...
        if (tt is not None): 
            if (tt.is_value("УВАЖАЕМЫЙ", None) or tt.is_value("ДОРОГОЙ", None) or tt.is_value("ГЛУБОКОУВАЖАЕМЫЙ", None)): 
                res.coef -= (2)
        ...
        if (pits[ind].is_in_dictionary and pits[ind + 1].is_in_dictionary and pits[ind + 2].is_in_dictionary): 
            ...
            if ((mc.is_adverb or mc.is_verb or mc.is_preposition) or mc.is_conjunction): 
                res.coef -= 1
        if ((pits[ind].fio_pref == 1 and pits[ind + 1].fio_pref == 2 and pits[ind + 2].fio_pref == 3) and (res.coef < 10)): 
            res.coef = (10)
        return res
    ...
    def __try_attach_surnameii(pits : typing.List['PersonItemToken'], ind : int, inf : 'MorphBaseInfo') -> 'PersonIdentityToken':
        ...
        if (pits[ind].lastname is None): 
            return None
        if ((pits[ind].begin_token.is_value("РИСУНОК", None) or pits[ind].begin_token.is_value("ФОРМУЛА", None) or pits[ind].begin_token.is_value("ЛИСТ", None)) or pits[ind].begin_token.is_value("БЛОК", None) or pits[ind].begin_token.is_value("ФОРМА", None)): 
            return None
        res = PersonIdentityToken._new2777(pits[ind].begin_token, pits[ind + 1].end_token, FioTemplateType.SURNAMEI)
        res.coef -= (ind)
        PersonIdentityToken.manage_lastname(res, pits[ind], inf)
        ...
        res.morph = res.morph.clone()
        if (inf is not None and inf.case_.value == MorphCase.NOMINATIVE.value): 
            res.morph.remove_items(MorphCase.NOMINATIVE, False)
            res.morph.case_ = MorphCase.NOMINATIVE
        if (res.lastname.gender == MorphGender.FEMINIE or res.lastname.gender == MorphGender.MASCULINE): 
            res.morph.remove_items(res.lastname.gender, False)
    ...
    def __try_attachiisurname(pits : typing.List['PersonItemToken'], ind : int, inf : 'MorphBaseInfo') -> 'PersonIdentityToken':
        ...
        if (pits[ind].is_newline_after): 
            return None
        res = PersonIdentityToken._new2777(pits[ind].begin_token, pits[ind + 1].end_token, FioTemplateType.ISURNAME)
        res.coef -= (ind)
        res.firstname = PersonMorphCollection()
            ...
            if (ind > 0): 
                ...
                if (prev is not None): 
                    if (PersonAttrToken.try_attach_word(prev.begin_token, True) is not None): 
                        prev = (None)
                        res.coef += 1
                    elif (prev.is_in_dictionary and i1 == (len(pits) - 1)): 
                        prev = (None)
    ...
    def __try_attach_king(pits : typing.List['PersonItemToken'], ind : int, inf : 'MorphBaseInfo', prev_has_this_typ : bool=False) -> 'PersonIdentityToken':
        ...
        if (num < 1): 
            ...
            if (not ok): 
                return None
        res = PersonIdentityToken._new2777(pits[0].begin_token, pits[0].end_token, FioTemplateType.KING)
    ...
    def __try_attach_arabic(pits : typing.List['PersonItemToken'], ind : int, inf : 'MorphBaseInfo', prev_has_this_typ : bool=False) -> 'PersonIdentityToken':
        ...
        if ((((i < 5) or i != len(pits))) and not has_hiph): 
            if (((len(pits) == 4 and i == len(pits) and pits[0].firstname is not None) and pits[1].firstname is not None and pits[2].firstname is not None) and pits[3].firstname is None and pits[3].middlename is None): 
                ...
                return None
        if (pits[0].firstname is not None and pits[1].lastname is not None and pits[2].firstname is not None): 
            if (len(pits) == 5 and pits[4].lastname is not None): 
                return None
        res = PersonIdentityToken._new2777(pits[0].begin_token, pits[i - 1].end_token, FioTemplateType.ARABICLONG)
        ...
        if (pits[0].firstname is not None): 
            ...
            res.lastname.items.append(PersonMorphCollection.PersonMorphVariant._new2780(pits[0].value))
        j = 1
        while j < i: 
            p = pits[j]
    ...
    def __try_attach_asian(pits : typing.List['PersonItemToken'], ind : int, inf : 'MorphBaseInfo', cou : int, prev_has_this_typ : bool=False) -> 'PersonIdentityToken':
        ...
        res = PersonIdentityToken._new2777(pits[0].begin_token, pits[cou].end_token, FioTemplateType.ASIANNAME)
        ...
        for i in range(2):
            ...
            if (not cas.is_undefined): 
                if (inf is not None and not inf.case_.is_undefined and not ((inf.case_) & cas).is_undefined): 
                    cas &= inf.case_
                res.add_item(MorphBaseInfo._new2794(g, cas))
    ...
    def check_latin_after(pit : 'PersonIdentityToken') -> 'PersonIdentityToken':
        ...
        if (nam is None or sur is None): 
            return None
        res = PersonIdentityToken._new2777(t, et, pit.typ)
        res.lastname = PersonMorphCollection()
    ...
    @staticmethod
    def _new2776(_arg1 : 'Token', _arg2 : 'Token', _arg3 : float, _arg4 : 'FioTemplateType') -> 'PersonIdentityToken':
    ...
    @staticmethod
    def _new2777(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'FioTemplateType') -> 'PersonIdentityToken':
        res = PersonIdentityToken(_arg1, _arg2)
        res.typ = _arg3
        return res