...
class NamedEntityAnalyzer(Analyzer):
    ...
    def images(self) -> typing.List[tuple]:
        res = dict()
        res[Utils.enumToString(NamedEntityKind.MONUMENT)] = ResourceHelper3.get_bytes("monument.png")
        res[Utils.enumToString(NamedEntityKind.PLANET)] = ResourceHelper3.get_bytes("planet.png")
        res[Utils.enumToString(NamedEntityKind.LOCATION)] = ResourceHelper3.get_bytes("location.png")
        res[Utils.enumToString(NamedEntityKind.BUILDING)] = ResourceHelper3.get_bytes("building.png")
        res[Utils.enumToString(NamedEntityKind.AWARD)] = ResourceHelper3.get_bytes("award.png")
        res[Utils.enumToString(NamedEntityKind.ART)] = ResourceHelper3.get_bytes("art.png")
        return res
    ...
    def __try_attach(toks : typing.List['NamedItemToken']) -> 'ReferentToken':
        ...
        if (not ok or ki == NamedEntityKind.UNDEFINED): 
            return None
        nam = NamedEntityReferent._new1957(ki)
        if (typ is not None): 
