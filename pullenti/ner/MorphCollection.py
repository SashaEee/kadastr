...
class MorphCollection(MorphBaseInfo):
    ...
    def __init__(self, source : 'MorphCollection'=None) -> None:
        ...
        self.__m_class = MorphClass._new327(source.__m_class.value)
        self.__m_gender = source.__m_gender
        self.__m_case = MorphCase._new303(source.__m_case.value)
        self.__m_number = source.__m_number
        self.__m_language = MorphLang._new330(source.__m_language.value)
    ...
    def clone(self) -> 'MorphCollection':
        ...
        if (not self.__m_need_recalc): 
            res.__m_class = MorphClass._new327(self.__m_class.value)
            res.__m_gender = self.__m_gender
            res.__m_case = MorphCase._new303(self.__m_case.value)
            res.__m_number = self.__m_number
            res.__m_language = MorphLang._new330(self.__m_language.value)
    ...
    def __remove_items_morph_case(self, cas : 'MorphCase') -> None:
        ...
        for i in range(len(self.__m_items) - 1, -1, -1):
            if (((self.__m_items[i].case_) & cas).is_undefined): 
                if (self.__m_items[i].case_.is_undefined): 
                    continue
                del self.__m_items[i]
                self.__m_need_recalc = True
    ...
    def _deserialize(self, stream : Stream) -> None:
        self.__m_class = MorphClass._new327(SerializerHelper.deserialize_short(stream))
        self.__m_case = MorphCase._new303(SerializerHelper.deserialize_short(stream))
        ...
        self.__m_language = MorphLang._new330(SerializerHelper.deserialize_short(stream))
    ...
    def __deserialize_item(self, stream : Stream) -> 'MorphBaseInfo':
        ...
        res.class0_ = MorphClass._new327(SerializerHelper.deserialize_short(stream))
        res.case_ = MorphCase._new303(SerializerHelper.deserialize_short(stream))
        ...
        res.language = MorphLang._new330(SerializerHelper.deserialize_short(stream))
        if (ty == 0): 
            return res
    ...
    @staticmethod
    def _new955(_arg1 : 'MorphClass') -> 'MorphCollection':
        res = MorphCollection()
        res.class0_ = _arg1
        return res
    
    @staticmethod
    def _new2638(_arg1 : 'MorphGender') -> 'MorphCollection':
        res = MorphCollection()
        res.gender = _arg1
        return res
    
    @staticmethod
    def _new2689(_arg1 : 'MorphCase') -> 'MorphCollection':
        res = MorphCollection()
        res.case_ = _arg1
        return res
