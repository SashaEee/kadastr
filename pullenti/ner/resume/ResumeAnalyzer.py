...
class ResumeAnalyzer(Analyzer):
    ...
    def images(self) -> typing.List[tuple]:
        res = dict()
        res[str(MetaResume.IMAGE_ID)] = ResourceHelper3.get_bytes("resume.png")
        return res
    ...
    def __parse_education(t : 'Token') -> 'MetaToken':
        ...
        if (neok): 
            val += ",неоконч"
        return MetaToken._new933(t0, t1, val)
    ...
    def __parse_moral(t : 'Token') -> 'MetaToken':
        ...
        return MetaToken._new933(t, t1, val)
    ...
    def __parse_onto(t : 'Token') -> 'MetaToken':
        ...
        return MetaToken._new933(t, lii[0].end_token, val)
