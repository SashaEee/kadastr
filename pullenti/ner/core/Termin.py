...
class Termin:
    ...
    class Term:
        ...
        @staticmethod
        def _new2208(_arg1 : 'TextToken', _arg2 : bool) -> 'Term':
    ...
    class Abridge:
        ...
        def add_part(self, val : str, has_delim : bool=False) -> None:
            self.parts.append(Termin.AbridgePart._new1012(val, has_delim))
            ...
            if (self.tail is None): 
                ...
                while i < len(self.parts): 
                    ...
                    if (tt is not None and ((tt.is_hiphen or tt.is_char_of("\\/.")))): 
                        ...
                        if (tt is None or (tt.length_char < 2)): 
                            return None
                    if (tt is None): 
                        return None
                    ...
                    tt = tt.next0_
                    i += 1
                res = TerminToken._new1013(t0, te, t0 == te)
                if (point): 
    ...
    class AbridgePart:
        ...
        @staticmethod
        def _new1012(_arg1 : str, _arg2 : bool) -> 'AbridgePart':
        ...
        @staticmethod
        def _new1014(_arg1 : str) -> 'AbridgePart':
            res = Termin.AbridgePart()
            res.value = _arg1
            return res
    ...
    def add_abridge(self, abr : str) -> 'Abridge':
        ...
        if (i == 0): 
            return None
        a.parts.append(Termin.AbridgePart._new1014(abr[0:0+i].upper()))
                ...
                if (str.isalpha(abr[i])): 
                    ...
                    while j < len(abr): 
                        if (not str.isalpha(abr[j])): 
                            break
                        j += 1
                    p = Termin.AbridgePart._new1014(abr[i:i+j - i].upper())
                    if (j < len(abr)): 
        ...
        if (self.acronym_smart is not None and (((pars) & (TerminParseAttr.FULLWORDSONLY))) == (TerminParseAttr.NO) and term is not None): 
            if (self.acronym_smart == term or self.acronym_smart == term0): 
                if (t0.next0_ is not None and t0.next0_.is_char('.') and not t0.is_whitespace_after): 
                    return TerminToken._new838(t0, t0.next0_, self)
                else: 
                    return TerminToken._new838(t0, t0, self)
            i = 0
            t1 = Utils.asObjectOrNull(t0, TextToken)
            ...
            if (i >= len(self.acronym)): 
                return TerminToken._new838(t0, t1, self)
            ...
            if (ok and i >= len(self.terms)): 
                ...
                if (t0 != t1 and t0.morph.class0_.is_adjective): 
                    ...
                    if (npt is not None and npt.end_char <= t1.end_char): 
                        mc = npt.morph
                if (has_bracket and BracketHelper.can_be_end_of_sequence(t1.next0_, False, None, False)): 
                    t1 = t1.next0_
                return TerminToken._new1021(t0, t1, mc)
    ...
    def try_parse_sim(self, t0 : 'Token', simd : float, pars : 'TerminParseAttr'=TerminParseAttr.NO) -> 'TerminToken':
        ...
        if (len(self.terms) > 0): 
            ...
            return TerminToken._new1027(t0, t1, mc, self)
        if (self.abridges is not None and (((pars) & (TerminParseAttr.FULLWORDSONLY))) == (TerminParseAttr.NO)): 
            res = None
            for a in self.abridges: 
                r = a.try_attach(t0)
    ...
    @staticmethod
    def _new124(_arg1 : str, _arg2 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        return res
    
    @staticmethod
    def _new359(_arg1 : str, _arg2 : object, _arg3 : 'MorphLang') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.lang = _arg3
        return res
    ...
    @staticmethod
    def _new360(_arg1 : str, _arg2 : object, _arg3 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag2 = _arg3
        return res
    ...
    @staticmethod
    def _new362(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.tag = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new365(_arg1 : str, _arg2 : object, _arg3 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag3 = _arg3
        return res
    ...
    @staticmethod
    def _new375(_arg1 : str, _arg2 : str, _arg3 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.tag = _arg3
        return res
    ...
    @staticmethod
    def _new386(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
    ...
    @staticmethod
    def _new387(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : str, _arg5 : object, _arg6 : object) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
    ...
    @staticmethod
    def _new394(_arg1 : str, _arg2 : str, _arg3 : str, _arg4 : object, _arg5 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
    ...
    @staticmethod
    def _new400(_arg1 : str, _arg2 : object, _arg3 : object, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag2 = _arg3
        res.tag3 = _arg4
    ...
    @staticmethod
    def _new406(_arg1 : str, _arg2 : str, _arg3 : object) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.tag = _arg3
        return res
    ...
    @staticmethod
    def _new407(_arg1 : str, _arg2 : object, _arg3 : str) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        return res
    ...
    @staticmethod
    def _new410(_arg1 : str, _arg2 : object, _arg3 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
    ...
    @staticmethod
    def _new453(_arg1 : str, _arg2 : object, _arg3 : object, _arg4 : str, _arg5 : bool, _arg6 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag2 = _arg3
        res.acronym = _arg4
    ...
    @staticmethod
    def _new576(_arg1 : str, _arg2 : object, _arg3 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.gender = _arg3
        return res
    ...
    @staticmethod
    def _new577(_arg1 : str, _arg2 : object, _arg3 : 'MorphLang', _arg4 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.lang = _arg3
        res.gender = _arg4
    ...
    @staticmethod
    def _new579(_arg1 : str, _arg2 : object, _arg3 : object, _arg4 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag2 = _arg3
        res.gender = _arg4
    ...
    @staticmethod
    def _new580(_arg1 : str, _arg2 : object, _arg3 : 'MorphLang', _arg4 : object, _arg5 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.lang = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new620(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : object, _arg5 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.tag = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new621(_arg1 : str, _arg2 : object, _arg3 : str, _arg4 : object, _arg5 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new625(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : 'MorphLang', _arg5 : object, _arg6 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.tag = _arg3
        res.lang = _arg4
    ...
    @staticmethod
    def _new627(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.tag = _arg3
        res.gender = _arg4
    ...
    @staticmethod
    def _new631(_arg1 : str, _arg2 : object, _arg3 : str, _arg4 : 'MorphGender') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        res.gender = _arg4
    ...
    @staticmethod
    def _new749(_arg1 : str, _arg2 : object, _arg3 : object, _arg4 : 'MorphLang') -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag2 = _arg3
        res.lang = _arg4
    ...
    @staticmethod
    def _new816(_arg1 : str, _arg2 : 'MorphLang', _arg3 : object) -> 'Termin':
        res = Termin(_arg1, _arg2)
        res.tag = _arg3
        return res
    
    @staticmethod
    def _new848(_arg1 : str, _arg2 : 'MorphLang', _arg3 : bool, _arg4 : str, _arg5 : object) -> 'Termin':
    ...
    @staticmethod
    def _new978(_arg1 : str, _arg2 : 'MorphLang', _arg3 : bool, _arg4 : object) -> 'Termin':
        res = Termin(_arg1, _arg2, _arg3)
        res.tag = _arg4
        return res
    
    @staticmethod
    def _new1132(_arg1 : str, _arg2 : 'MorphLang', _arg3 : bool, _arg4 : str) -> 'Termin':
        res = Termin(_arg1, _arg2, _arg3)
        res.canonic_text = _arg4
        return res
    
    @staticmethod
    def _new1308(_arg1 : str, _arg2 : str) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        return res
    
    @staticmethod
    def _new1330(_arg1 : str, _arg2 : 'MorphLang', _arg3 : str) -> 'Termin':
        res = Termin(_arg1, _arg2)
        res.canonic_text = _arg3
        return res
    
    @staticmethod
    def _new1333(_arg1 : str, _arg2 : str, _arg3 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.acronym_can_be_lower = _arg3
        return res
    ...
    @staticmethod
    def _new1344(_arg1 : str, _arg2 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.ignore_terms_order = _arg2
        return res
    
    @staticmethod
    def _new1401(_arg1 : str, _arg2 : str) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        return res
    
    @staticmethod
    def _new1425(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.acronym_can_be_lower = _arg3
    ...
    @staticmethod
    def _new1427(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
    ...
    @staticmethod
    def _new1473(_arg1 : str, _arg2 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag3 = _arg2
        return res
    
    @staticmethod
    def _new1504(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.acronym_can_be_lower = _arg3
        res.tag3 = _arg4
    ...
    @staticmethod
    def _new1505(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : object, _arg5 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.acronym_can_be_lower = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new1507(_arg1 : str, _arg2 : object, _arg3 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag2 = _arg2
        res.tag3 = _arg3
        return res
    ...
    @staticmethod
    def _new1553(_arg1 : str, _arg2 : str, _arg3 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.tag3 = _arg3
        return res
    ...
    @staticmethod
    def _new1569(_arg1 : str, _arg2 : 'MorphLang', _arg3 : object, _arg4 : 'MorphGender', _arg5 : object) -> 'Termin':
        res = Termin(_arg1)
        res.lang = _arg2
        res.tag2 = _arg3
        res.gender = _arg4
    ...
    @staticmethod
    def _new1580(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : bool, _arg5 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.acronym_can_be_lower = _arg3
        res.acronym_can_be_smart = _arg4
    ...
    @staticmethod
    def _new1590(_arg1 : str, _arg2 : object, _arg3 : 'MorphGender', _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.gender = _arg3
        res.tag3 = _arg4
    ...
    @staticmethod
    def _new1605(_arg1 : str, _arg2 : object, _arg3 : object, _arg4 : 'MorphGender', _arg5 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.tag2 = _arg3
        res.gender = _arg4
    ...
    @staticmethod
    def _new1609(_arg1 : str, _arg2 : str, _arg3 : bool, _arg4 : bool, _arg5 : object, _arg6 : object) -> 'Termin':
        res = Termin(_arg1)
        res.acronym = _arg2
        res.acronym_can_be_smart = _arg3
        res.acronym_can_be_lower = _arg4
    ...
    @staticmethod
    def _new1617(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : object, _arg5 : 'MorphGender', _arg6 : object) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.tag = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new1618(_arg1 : str, _arg2 : object, _arg3 : str, _arg4 : object, _arg5 : 'MorphGender', _arg6 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new1620(_arg1 : str, _arg2 : object, _arg3 : str, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new1624(_arg1 : str, _arg2 : object, _arg3 : str, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        res.tag3 = _arg4
    ...
    @staticmethod
    def _new1630(_arg1 : str, _arg2 : object, _arg3 : str, _arg4 : bool, _arg5 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.acronym = _arg3
        res.acronym_can_be_lower = _arg4
    ...
    @staticmethod
    def _new1706(_arg1 : str, _arg2 : 'MorphLang') -> 'Termin':
        res = Termin(_arg1)
        res.lang = _arg2
        return res
    
    @staticmethod
    def _new1707(_arg1 : str, _arg2 : 'MorphLang') -> 'Termin':
        res = Termin()
        res.acronym = _arg1
        res.lang = _arg2
        return res
    ...
    @staticmethod
    def _new2625(_arg1 : str, _arg2 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag2 = _arg2
        return res
    
    @staticmethod
    def _new2947(_arg1 : str, _arg2 : 'MorphLang', _arg3 : bool, _arg4 : object) -> 'Termin':
        res = Termin(_arg1, _arg2, _arg3)
        res.tag2 = _arg4
        return res
    
    @staticmethod
    def _new3023(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : str) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.tag = _arg3
        res.acronym = _arg4
    ...
    @staticmethod
    def _new3033(_arg1 : str, _arg2 : str, _arg3 : object, _arg4 : str, _arg5 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.tag = _arg3
        res.acronym = _arg4
    ...
    @staticmethod
    def _new3046(_arg1 : str, _arg2 : 'MorphLang', _arg3 : bool, _arg4 : str, _arg5 : object, _arg6 : object) -> 'Termin':
        res = Termin(_arg1, _arg2, _arg3)
        res.canonic_text = _arg4
        res.tag = _arg5
        res.tag2 = _arg6
    ...
    @staticmethod
    def _new3050(_arg1 : str, _arg2 : str, _arg3 : str, _arg4 : object, _arg5 : object, _arg6 : bool) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.acronym = _arg3
        res.tag = _arg4
    ...
    @staticmethod
    def _new3062(_arg1 : str, _arg2 : object, _arg3 : bool, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.tag = _arg2
        res.ignore_terms_order = _arg3
        res.tag2 = _arg4
    ...
    @staticmethod
    def _new3100(_arg1 : str, _arg2 : str, _arg3 : str, _arg4 : object) -> 'Termin':
        res = Termin(_arg1)
        res.canonic_text = _arg2
        res.acronym = _arg3
        res.tag = _arg4
