...
class VerbPhraseHelper:
    ...
    def __try_parse_ru(t : 'Token', can_be_partition : bool, can_be_adj_partition : bool, force_parse : bool) -> 'VerbPhraseToken':
        ...
        first_pass3444 = True
        while True:
            if first_pass3444: first_pass3444 = False
            else: t = t.next0_
            ...
            if (tt.term == "НЕТ"): 
                ...
                if (mc.is_preposition or mc.is_misc or mc.is_pronoun): 
                    ...
                    if (((tt.term == "СТАЛИ" or tt.term == "СТЕКЛО" or tt.term == "БЫЛИ") or tt.term == "ДАМ" or tt.term == "ПОДАТЬ") or tt.term == "ГОТОВ"): 
                        ty = 1
            ...
            res.end_token = t
            it = VerbPhraseItemToken._new1055(t, t, MorphCollection(t.morph))
            ...
            if (norm is None): 
                ...
                if (ty == 1 and not tt.morph.case_.is_undefined): 
                    mi = MorphWordForm._new1056(MorphCase.NOMINATIVE, MorphNumber.SINGULAR, MorphGender.MASCULINE)
