...
class VerbPhraseItemToken(MetaToken):
    ...
    def verb_morph(self) -> 'MorphWordForm':
        ...
        if (self.__m_normal == "НЕТ"): 
            return MorphWordForm._new1059(MorphClass.VERB, MorphMiscInfo())
        return None
    @verb_morph.setter
    ...
    @staticmethod
    def _new1055(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'MorphCollection') -> 'VerbPhraseItemToken':
