...
class StreetItemToken(MetaToken):
    ...
    def __try_parse_list(t : 'Token', max_count : int, ad : 'GeoAnalyzerData') -> typing.List['StreetItemToken']:
        ...
        while True:
                ...
                if (((t.whitespaces_after_count < 15) and sit is not None and sit.typ == StreetItemType.NOUN) and t.chars.is_capital_upper): 
                    ...
                    if (len(res) == 1 and res[0].typ == StreetItemType.NAME): 
                        ...
                        if (sit1 is not None and sit1.typ == StreetItemType.NOUN): 
                            ...
                            if (sit2 is None): 
                                ok = True
                    elif (len(res) == 2 and res[0].typ == StreetItemType.NOUN and res[1].typ == StreetItemType.STDADJECTIVE): 
                        sit1 = StreetItemToken.try_parse(sit.end_token.next0_, sit, False, ad)
                        if (sit1 is not None and ((sit1.typ == StreetItemType.STDNAME or sit1.typ == StreetItemType.NAME))): 
                            if (AddressItemToken.check_house_after(sit1.end_token.next0_, False, False)): 
                                ok = True
                    if (not ok): 
                        break
            if (t.is_hiphen and sit is not None and ((sit.typ == StreetItemType.NAME or sit.typ == StreetItemType.STDNAME or ((sit.typ == StreetItemType.STDADJECTIVE))))): 
                ...
                if (sit1 is None): 
                    ...
                    if (num is not None): 
                        sit = StreetItemToken._new568(t, num.end_token, StreetItemType.NUMBER, num.value, True)
                        res.append(sit)
                        t = sit.end_token
                        continue
                    break
                ...
                if (sit1.typ != StreetItemType.NAME and sit1.typ != StreetItemType.NAME): 
                    if (sit1.typ == StreetItemType.NOUN and sit1.noun_can_be_name): 
                        pass
                    elif (sit1.typ == StreetItemType.STDADJECTIVE): 
                        pass
                    else: 
                        break
            ...
            if (t.is_char('.') and sit is not None and sit.typ == StreetItemType.NOUN): 
                ...
                if (t.previous.get_morph_class_in_dictionary().is_noun): 
                    if (not sit.is_in_dictionary): 
                        ...
                        first_pass3360 = True
                        while True:
                            if first_pass3360: first_pass3360 = False
                            else: tt = tt.next0_
                ...
                if (sit is None): 
                    ...
                    if (((isinstance(t, TextToken)) and ((len(res) == 2 or len(res) == 3)) and res[0].typ == StreetItemType.NOUN) and res[1].typ == StreetItemType.NUMBER and (((t.term == "ГОДА" or t.term == "МАЯ" or t.term == "МАРТА") or t.term == "СЪЕЗДА"))): 
                        sit = StreetItemToken._new558(t, t, StreetItemType.STDNAME, t.term)
                        res.append(sit)
                        continue
                    sit = res[len(res) - 1]
                    if (t is None): 
                    ...
                    if (sit.typ == StreetItemType.NOUN and ((sit.termin.canonic_text == "МИКРОРАЙОН" or sit.termin.canonic_text == "МІКРОРАЙОН")) and (t.whitespaces_before_count < 2)): 
                        ...
                        if (((isinstance(tt1, TextToken)) and tt1.length_char == 1 and tt1.chars.is_letter) and ((AddressItemToken.check_house_after(tt2, False, True) or tt2 is None))): 
                            sit = StreetItemToken._new558(t, (tt1.next0_ if br else tt1), StreetItemType.NAME, tt1.term)
                        ...
                        if (sit1.typ == StreetItemType.NOUN and ((sit1.noun_is_doubt_coef == 0 or (((isinstance(t.next0_, TextToken)) and not t.next0_.chars.is_all_lower))))): 
                            ...
                            if (br is not None and (br.length_char < 50)): 
                                ...
                                if (sit2 is not None and sit2.end_token.next0_ == br.end_token): 
                                    ...
                                    res.append(sit2)
                                    continue
                                res.append(StreetItemToken._new571(t, br.end_token, StreetItemType.NAME, MiscHelper.get_text_value(t, br.end_token, GetTextAttr.NO), True))
                                t = br.end_token
                                continue
                    if (t.is_hiphen and (isinstance(t.next0_, NumberToken)) and t.next0_.int_value is not None): 
                        ...
                        if (sit.typ == StreetItemType.NOUN and (((sit.termin.canonic_text == "КВАРТАЛ" or sit.termin.canonic_text == "МИКРОРАЙОН" or sit.termin.canonic_text == "ГОРОДОК") or sit.termin.canonic_text == "МІКРОРАЙОН"))): 
                            sit = StreetItemToken._new572(t, t.next0_, StreetItemType.NUMBER, t.next0_.value, t.next0_.typ, True)
                            res.append(sit)
                            t = t.next0_
                            continue
                    ...
                    if ((t.is_char('(') and t.next0_ is not None and (isinstance(t.next0_.get_referent(), GeoReferent))) and t.next0_.next0_ is not None and t.next0_.next0_.is_char(')')): 
                        ...
                        if (sit is not None and sit.typ == StreetItemType.NOUN): 
                            res[len(res) - 1]._area = AddressItemToken._new476(AddressItemType.REGION, t, t.next0_.next0_, t.next0_.get_referent())
                            res.append(sit)
                            t = sit.end_token
                            continue
                    break
        ...
        first_pass3361 = True
        while True:
            if first_pass3361: first_pass3361 = False
            else: i += 1
        ...
        first_pass3362 = True
        while True:
            if first_pass3362: first_pass3362 = False
            else: i += 1
            if (not (i < (len(res) - 1))): break
                ...
                if (tt is not None and (isinstance(tt.get_referent(), GeoReferent))): 
                    ...
                    if (g2 is not None): 
                        if (g1.is_city and g2.is_city): 
                            nam = StreetItemToken._new574(res[0].end_token.next0_, tt, StreetItemType.NAME)
                    ...
                    if (br is not None): 
                        nam = StreetItemToken._new575(tt, br.end_token, StreetItemType.NAME, True)
        ...
        while len(res) > 1:
            it = res[len(res) - 1]
            if (it.begin_token == it.end_token and it.length_char == 1 and it.is_value("В", None)): 
                if (isinstance(it.end_token.next0_, ReferentToken)): 
                    res.remove(it)
                    continue
            if (len(res) == 4): 
                if ((res[0].typ == StreetItemType.NOUN and res[1].typ == StreetItemType.NUMBER and res[2].typ == StreetItemType.NOUN) and res[3].typ == StreetItemType.NUMBER): 
                    break
            if (len(res) == 5): 
                if (((res[0].typ == StreetItemType.NOUN and res[0].termin.canonic_text == "УЛИЦА" and res[1].typ == StreetItemType.NOUN) and res[2].typ == StreetItemType.NUMBER and res[3].typ == StreetItemType.NOUN) and res[4].typ == StreetItemType.NUMBER): 
                    break
            ...
            if (it.typ == StreetItemType.NUMBER and not it.number_has_prefix and not it.is_number_km): 
                if (isinstance(it.begin_token, NumberToken)): 
                    if (len(res) == 2 and res[0].typ == StreetItemType.NOUN): 
                        break
                    if (MiscLocationHelper.is_user_param_gar_address(res[0])): 
                        break
                    if (not it.begin_token.morph.class0_.is_adjective or it.begin_token.morph.class0_.is_noun): 
                        if (AddressItemToken.check_house_after(it.end_token.next0_, False, True)): 
                            ...
                            it.number_has_prefix = True
                        elif (((len(res) > 1 and res[len(res) - 2].typ == StreetItemType.NAME and res[len(res) - 2].begin_token == res[len(res) - 2].end_token) and it.begin_token.previous.get_morph_class_in_dictionary().is_proper_name and (isinstance(it.begin_token, NumberToken))) and it.begin_token.int_value is not None and (it.begin_token.int_value < 3)): 
                            it.number_has_prefix = True
                        else: 
                            del res[len(res) - 1]
                            continue
        ...
        while i < len(res): 
            if (res[i].next_item is not None): 
                if (res[i].typ == StreetItemType.NUMBER and i > 0 and res[i - 1].typ == StreetItemType.NAME): 
                    pass
                else: 
        ...
        if (len(res) > 1): 
            if (res[len(res) - 1]._org0_ is not None): 
                if (len(res) == 2 and res[0].typ == StreetItemType.NOUN): 
                    ...
                    del res[len(res) - 1]
        if (len(res) == 2 and res[0].typ == StreetItemType.NOUN and res[1].typ == StreetItemType.NOUN): 
            if (not res[1].chars.is_all_lower and not res[1].is_abridge and res[1].begin_token == res[1].end_token): 
                res[1] = res[1].clone()
                res[1].typ = StreetItemType.NAME
                res[1].value = MiscHelper.get_text_value_of_meta_token(res[1], GetTextAttr.NO)
        if (len(res) == 0): 
            return None
        return res
    ...
    def initialize() -> None:
        ...
        t = None
        t = Termin._new576("УЛИЦА", StreetItemType.NOUN, MorphGender.FEMINIE)
        t.add_abridge("УЛ.")
        t.add_abridge("УЛЮ")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new577("ВУЛИЦЯ", StreetItemType.NOUN, MorphLang.UA, MorphGender.FEMINIE)
        t.add_abridge("ВУЛ.")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new124("STREET", StreetItemType.NOUN)
        t.add_abridge("ST.")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("ПЛОЩАДЬ", StreetItemType.NOUN, 1, MorphGender.FEMINIE)
        t.add_abridge("ПЛ.")
        t.add_abridge("ПЛОЩ.")
        t.add_abridge("ПЛ-ДЬ")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new580("ПЛОЩА", StreetItemType.NOUN, MorphLang.UA, 1, MorphGender.FEMINIE)
        t.add_abridge("ПЛ.")
        t.add_abridge("ПЛОЩ.")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("МАЙДАН", StreetItemType.NOUN, 0, MorphGender.MASCULINE)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new124("SQUARE", StreetItemType.NOUN)
        t.add_abridge("SQ.")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("ПРОЕЗД", StreetItemType.NOUN, 1, MorphGender.MASCULINE)
        t.add_abridge("ПР.")
        t.add_abridge("П-Д")
        t.add_abridge("ПР-Д")
        t.add_abridge("ПР-ЗД")
        t.add_abridge("ПД")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new580("ПРОЕЗД", StreetItemType.NOUN, MorphLang.UA, 1, MorphGender.MASCULINE)
        t.add_abridge("ПР.")
        t.add_abridge("П-Д")
        t.add_abridge("ПР-Д")
        t.add_abridge("ПР-ЗД")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("ЛИНИЯ", StreetItemType.NOUN, 2, MorphGender.FEMINIE)
        t.add_abridge("ЛИН.")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new580("ЛІНІЯ", StreetItemType.NOUN, MorphLang.UA, 2, MorphGender.FEMINIE)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("РЯД", StreetItemType.NOUN, 2, MorphGender.MASCULINE)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("БЛОК", StreetItemType.NOUN, 2, MorphGender.MASCULINE)
        StreetItemToken.__m_block = t
        t.add_abridge("БЛ.")
        t.add_variant("БЛОК ГАРАЖЕЙ", False)
        t.add_variant("ГАРАЖНЫЙ БЛОК", False)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("ПАНЕЛЬ", StreetItemType.NOUN, 2, MorphGender.FEMINIE)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("КУСТ", StreetItemType.NOUN, 2, MorphGender.MASCULINE)
        t.add_variant("КУСТ ГАЗОВЫХ СКВАЖИН", False)
        t.add_variant("КУСТОВАЯ ПЛОЩАДКА СКВАЖИН", False)
        t.add_variant("КУСТ СКВАЖИН", False)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("ПРОСПЕКТ", StreetItemType.NOUN, 0, MorphGender.MASCULINE)
        ...
        t.add_abridge("ПР Т")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("ПЕРЕУЛОК", StreetItemType.NOUN, 0, MorphGender.MASCULINE)
        t.add_abridge("ПЕР.")
        t.add_abridge("ПЕР-К")
        t.add_abridge("П-К")
        t.add_variant("ПРЕУЛОК", False)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("ПРОУЛОК", StreetItemType.NOUN, 0, MorphGender.MASCULINE)
        t.add_abridge("ПРОУЛ.")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new580("ПРОВУЛОК", StreetItemType.NOUN, MorphLang.UA, 0, MorphGender.MASCULINE)
        t.add_abridge("ПРОВ.")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new360("LANE", StreetItemType.NOUN, 0)
        t.add_abridge("LN.")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("ТУПИК", StreetItemType.NOUN, 1, MorphGender.MASCULINE)
        t.add_abridge("ТУП.")
        t.add_abridge("Т.")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("БУЛЬВАР", StreetItemType.NOUN, 0, MorphGender.MASCULINE)
        t.add_abridge("БУЛЬВ.")
        t.add_abridge("БУЛ.")
        t.add_abridge("Б-Р")
        t.add_abridge("Б-РЕ")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new360("BOULEVARD", StreetItemType.NOUN, 0)
        t.add_abridge("BLVD")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new360("СКВЕР", StreetItemType.NOUN, 1)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("НАБЕРЕЖНАЯ", StreetItemType.NOUN, 0, MorphGender.FEMINIE)
        t.add_abridge("НАБ.")
        t.add_abridge("НАБЕР.")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new580("НАБЕРЕЖНА", StreetItemType.NOUN, MorphLang.UA, 0, MorphGender.FEMINIE)
        t.add_abridge("НАБ.")
        t.add_abridge("НАБЕР.")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("АЛЛЕЯ", StreetItemType.NOUN, 0, MorphGender.FEMINIE)
        t.add_abridge("АЛ.")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new580("АЛЕЯ", StreetItemType.NOUN, MorphLang.UA, 0, MorphGender.FEMINIE)
        t.add_abridge("АЛ.")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new360("ALLEY", StreetItemType.NOUN, 0)
        t.add_abridge("ALY.")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("АВЕНЮ", StreetItemType.NOUN, 0, MorphGender.FEMINIE)
        t.add_variant("АВЕНЬЮ", False)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("ПРОСЕКА", StreetItemType.NOUN, 1, MorphGender.FEMINIE)
        t.add_variant("ПРОСЕК", False)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("ПЛОЩАДКА", StreetItemType.NOUN, 1, MorphGender.FEMINIE)
        t.add_abridge("ПЛ-КА")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new580("ПРОСІКА", StreetItemType.NOUN, MorphLang.UA, 1, MorphGender.FEMINIE)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("ТРАКТ", StreetItemType.NOUN, 1, MorphGender.NEUTER)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("ШОССЕ", StreetItemType.NOUN, 1, MorphGender.NEUTER)
        t.add_abridge("Ш.")
        t.add_abridge("ШОС.")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new580("ШОСЕ", StreetItemType.NOUN, MorphLang.UA, 1, MorphGender.NEUTER)
        t.add_abridge("Ш.")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new360("ROAD", StreetItemType.NOUN, 1)
        t.add_abridge("RD.")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("МИКРОРАЙОН", StreetItemType.NOUN, 0, MorphGender.MASCULINE)
        t.add_abridge("МКР.")
        t.add_abridge("МКН.")
        ...
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("КВАРТАЛ", StreetItemType.NOUN, 2, MorphGender.MASCULINE)
        t.add_abridge("КВАРТ.")
        t.add_abridge("КВ-Л")
        t.add_abridge("КВ.")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("КАДАСТРОВЫЙ КВАРТАЛ", StreetItemType.NOUN, 2, MorphGender.MASCULINE)
        t.add_abridge("КАД.КВАРТ.")
        t.add_abridge("КАД.КВ-Л")
        t.add_abridge("КАД.КВ.")
        t.add_abridge("КАД.КВАРТАЛ")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("ТОРФЯНОЙ УЧАСТОК", StreetItemType.NOUN, 2, MorphGender.MASCULINE)
        t.add_variant("ТОРФУЧАСТОК", False)
        t.add_variant("ТОРФОУЧАСТОК", False)
        t.add_abridge("ТОРФ.УЧАСТОК")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("МОСТ", StreetItemType.NOUN, 2, MorphGender.MASCULINE)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new580("МІСТ", StreetItemType.NOUN, MorphLang.UA, 2, MorphGender.MASCULINE)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new360("PLAZA", StreetItemType.NOUN, 1)
        t.add_abridge("PLZ")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new620("СТАНЦИЯ МЕТРО", "МЕТРО", StreetItemType.NOUN, 0, MorphGender.FEMINIE)
        ...
        t.add_abridge("МЕТРО")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new621("АВТОДОРОГА", StreetItemType.NOUN, "ФАД", 0, MorphGender.FEMINIE)
        ...
        t.add_variant("АВТОМАГ", False)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new620("ДОРОГА", "АВТОДОРОГА", StreetItemType.NOUN, 1, MorphGender.FEMINIE)
        t.add_variant("ТРАССА", False)
        t.add_abridge("ДОР.")
        t.add_variant("ДОР", False)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new579("МАГИСТРАЛЬ", StreetItemType.NOUN, 1, MorphGender.FEMINIE)
        t.add_variant("МГСТР", False)
        t.add_abridge("МАГ-ЛЬ")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new580("АВТОДОРОГА", StreetItemType.NOUN, MorphLang.UA, 0, MorphGender.FEMINIE)
        ...
        StreetItemToken._m_ontology.add(t)
        t = Termin._new625("ДОРОГА", "АВТОДОРОГА", StreetItemType.NOUN, MorphLang.UA, 1, MorphGender.FEMINIE)
        t.add_variant("ТРАСА", False)
        t.add_variant("МАГІСТРАЛЬ", False)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new580("МАГІСТРАЛЬ", StreetItemType.NOUN, MorphLang.UA, 1, MorphGender.FEMINIE)
        t.add_variant("МГСТР", False)
        t.add_abridge("МАГ-ЛЬ")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new627("МОСКОВСКАЯ КОЛЬЦЕВАЯ АВТОМОБИЛЬНАЯ ДОРОГА", "МКАД", StreetItemType.FIX, MorphGender.FEMINIE)
        t.add_variant("МОСКОВСКАЯ КОЛЬЦЕВАЯ АВТОДОРОГА", False)
        StreetItemToken._m_ontology.add(t)
        StreetItemToken._m_ontology.add(Termin._new124("САДОВОЕ КОЛЬЦО", StreetItemType.FIX))
        StreetItemToken._m_ontology.add(Termin._new124("БУЛЬВАРНОЕ КОЛЬЦО", StreetItemType.FIX))
        StreetItemToken._m_ontology.add(Termin._new124("ТРАНСПОРТНОЕ КОЛЬЦО", StreetItemType.FIX))
        t = Termin._new631("ПОЧТОВОЕ ОТДЕЛЕНИЕ", StreetItemType.NOUN, "ОПС", MorphGender.NEUTER)
        t.add_abridge("П.О.")
        ...
        StreetItemToken._m_ontology.add(t)
        t = Termin._new576("БУДКА", StreetItemType.NOUN, MorphGender.FEMINIE)
        t.add_variant("ЖЕЛЕЗНОДОРОЖНАЯ БУДКА", False)
        t.add_abridge("Ж/Д БУДКА")
        t.add_abridge("ЖЕЛ.ДОР.БУДКА")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new576("КАЗАРМА", StreetItemType.NOUN, MorphGender.FEMINIE)
        t.add_variant("ЖЕЛЕЗНОДОРОЖНАЯ КАЗАРМА", False)
        t.add_abridge("Ж/Д КАЗАРМА")
        t.add_abridge("ЖЕЛ.ДОР.КАЗАРМА")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new576("СТОЯНКА", StreetItemType.NOUN, MorphGender.FEMINIE)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new576("ПУНКТ", StreetItemType.NOUN, MorphGender.MASCULINE)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new576("РАЗЪЕЗД", StreetItemType.NOUN, MorphGender.MASCULINE)
        t.add_abridge("РЗД")
        t.add_abridge("Ж/Д РАЗЪЕЗД")
        t.add_variant("ЖЕЛЕЗНОДОРОЖНЫЙ РАЗЪЕЗД", False)
        t.add_abridge("ЖЕЛ.ДОР.РАЗЪЕЗД")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new576("ЗАЕЗД", StreetItemType.NOUN, MorphGender.MASCULINE)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new576("ПЕРЕЕЗД", StreetItemType.NOUN, MorphGender.MASCULINE)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new124("БОЛЬШОЙ", StreetItemType.STDADJECTIVE)
        t.add_abridge("БОЛ.")
        t.add_abridge("Б.")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new124("ВЕЛИКИЙ", StreetItemType.STDADJECTIVE)
        t.add_abridge("ВЕЛ.")
        t.add_abridge("В.")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new124("МАЛЫЙ", StreetItemType.STDADJECTIVE)
        t.add_abridge("МАЛ.")
        t.add_abridge("М.")
        t.add_variant("МАЛИЙ", False)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new124("СРЕДНИЙ", StreetItemType.STDADJECTIVE)
        t.add_abridge("СРЕД.")
        t.add_abridge("СР.")
        t.add_abridge("С.")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new359("СЕРЕДНІЙ", StreetItemType.STDADJECTIVE, MorphLang.UA)
        t.add_abridge("СЕРЕД.")
        t.add_abridge("СЕР.")
        t.add_abridge("С.")
        StreetItemToken._m_ontology.add(t)
        t = Termin._new124("ВЕРХНИЙ", StreetItemType.STDADJECTIVE)
        t.add_abridge("ВЕРХН.")
        t.add_abridge("ВЕРХ.")
        t.add_abridge("ВЕР.")
        t.add_abridge("В.")
        ...
        StreetItemToken._m_ontology.add(t)
        t = Termin._new124("НИЖНИЙ", StreetItemType.STDADJECTIVE)
        t.add_abridge("НИЖН.")
        t.add_abridge("НИЖ.")
        t.add_abridge("Н.")
        t.add_variant("НИЖНІЙ", False)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new124("СТАРЫЙ", StreetItemType.STDADJECTIVE)
        t.add_abridge("СТАР.")
        t.add_abridge("СТ.")
        t.add_variant("СТАРИЙ", False)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new124("НОВЫЙ", StreetItemType.STDADJECTIVE)
        t.add_abridge("НОВ.")
        t.add_abridge("Н.")
        t.add_variant("НОВИЙ", False)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new124("КРАСНЫЙ", StreetItemType.STDADJECTIVE)
        t.add_abridge("КРАСН.")
        t.add_abridge("КР.")
        t.add_abridge("КРАС.")
        t.add_variant("ЧЕРВОНИЙ", False)
        StreetItemToken._m_ontology.add(t)
        t = Termin._new124("НОМЕР", StreetItemType.STDADJECTIVE)
        t.add_abridge("N")
        t.add_abridge("№")
        t.add_abridge("НОМ.")
        StreetItemToken._m_ontology.add(t)
        for s in ["ПРОЕКТИРУЕМЫЙ", "МИРА", "СВОБОДЫ"]: 
            pp = Utils.splitString(s, ';', False)
            t = Termin._new410(pp[0], StreetItemType.STDNAME, True)
            kk = 1
            while kk < len(pp): 
                if (pp[kk].find('.') > 0): 
                    t.add_abridge(pp[kk])
        ...
        for s in NameToken._standard_names: 
            ...
            kk = 1
            while kk < len(pp): 
                if (pp[kk].find('.') > 0 or pp[kk].find('/') > 0 or pp[kk].find('-') > 0): 
                    t.add_abridge(pp[kk])
        ...
        for s in ["МАРТА", "МАЯ", "ОКТЯБРЯ", "НОЯБРЯ", "БЕРЕЗНЯ", "ТРАВНЯ", "ЖОВТНЯ", "ЛИСТОПАДА", "ДОРОЖКА", "ЛУЧ", "НАДЕЛ", "ПОЛЕ", "СКЛОН"]: 
            StreetItemToken._m_ontology.add(Termin._new124(s, StreetItemType.STDNAME))
        for s in ["МАРШАЛА", "ГЕНЕРАЛА", "ГЕНЕРАЛ-МАЙОРА", "ГЕНЕРАЛ-ЛЕЙТЕНАНТА", "ГЕНЕРАЛ-ПОЛКОВНИКА", "АДМИРАЛА", "КОНТРАДМИРАЛА", "КОСМОНАВТА", "ЛЕТЧИКА", "ЛЕТЧИКА-ИСПЫТАТЕЛЯ", "ПИЛОТА", "ПОГРАНИЧНИКА", "ПУТЕШЕСТВЕННИКА", "ПАРТИЗАНА", "АТАМАНА", "ВОЕВОДЫ", "ТАНКИСТА", "ОРУЖЕЙНИКА", "ПОЛЯРНИКА", "АВИАКОНСТРУКТОРА", "АРХИТЕКТОРА", "ГЛАВНОГО АРХИТЕКТОРА", "СКУЛЬПТОРА", "ХУДОЖНИКА", "КОНСТРУКТОРА", "ГЛАВНОГО КОНСТРУКТОРА", "АКАДЕМИКА", "ПРОФЕССОРА", "КОМПОЗИТОРА", "ПИСАТЕЛЯ", "ПОЭТА", "ДИРИЖЕРА", "ГЕРОЯ", "БРАТЬЕВ", "ЛЕЙТЕНАНТА", "СТАРШЕГО ЛЕЙТЕНАНТА", "КАПИТАНА", "КАПИТАНА-ЛЕЙТЕНАНТА", "МАЙОРА", "ПОДПОЛКОВНИКА", "ПОЛКОВНИКА", "СЕРЖАНТА", "МЛАДШЕГО СЕРЖАНТА", "СТАРШЕГО СЕРЖАНТА", "ЕФРЕЙТОРА", "СТАРШИНЫ", "ПРАПОРЩИКА", "СТАРШЕГО ПРАПОРЩИКА", "ПОЛИТРУКА", "МИТРОПОЛИТА", "ПАТРИАРХА", "ИЕРЕЯ", "ПРОТОИЕРЕЯ", "МОНАХА", "СВЯТОГО", "СВЯТИТЕЛЯ", "ШЕЙХА", "БАЛЕРИНЫ", "ПЕВИЦЫ", "ХИРУРГА", "НАРОДНОГО АРТИСТА"]: 
            ...
            t = Termin._new124(s, StreetItemType.STDPARTOFNAME)
        ...
        for s in ["МАРШАЛА", "ГЕНЕРАЛА", "ГЕНЕРАЛ-МАЙОРА", "ГЕНЕРАЛ-ЛЕЙТЕНАНТА", "ГЕНЕРАЛ-ПОЛКОВНИКА", "АДМІРАЛА", "КОНТРАДМІРАЛА", "КОСМОНАВТА", "ЛЬОТЧИКА", " ПРИКОРДОННИКА", " МАНДРІВНИКА", "ПАРТИЗАНА", "ОТАМАНА", "ТАНКІСТА", "АВІАКОНСТРУКТОРА", "АРХІТЕКТОРА", "СКУЛЬПТОРА", "ХУДОЖНИКА", "КОНСТРУКТОРА", "АКАДЕМІКА", "ПРОФЕСОРА", "КОМПОЗИТОРА", "ПИСЬМЕННИКА", "ПОЕТА", "ДИРИГЕНТА", "ГЕРОЯ", "ЛЕЙТЕНАНТА", "КАПІТАНА", "КАПІТАНА-ЛЕЙТЕНАНТА", "МАЙОРА", "ПІДПОЛКОВНИКА", "ПОЛКОВНИКА", "СЕРЖАНТА", "ЄФРЕЙТОРА", " СТАРШИНИ", " ПРАПОРЩИКА", "ПОЛІТРУКА", "ПОЛІЦІЇ", "МІЛІЦІЇ", "ГВАРДІЇ", "АРМІЇ", "МИТРОПОЛИТА", "ПАТРІАРХА", "ІЄРЕЯ", "ПРОТОІЄРЕЯ", "ЧЕНЦЯ", "СВЯТОГО", "СВЯТИТЕЛЯ"]: 
            StreetItemToken.__m_std_ont_misc.add(Termin(s))
            t = Termin._new359(s, StreetItemType.STDPARTOFNAME, MorphLang.UA)
            if (s == "СВЯТОГО" or s == "СВЯТИТЕЛЯ"): 
                t.add_abridge("СВ.")
                t.add_abridge("СВЯТ.")
            else: 
            ...
            StreetItemToken._m_ontology.add(t)
        t = Termin._new124("ЛЕНИНСКИЕ ГОРЫ", StreetItemType.FIX)
        StreetItemToken._m_ontology.add(t)
        ...
        for s in ["НЕТ", "НЕ УКАЗАНА", "НЕ ЗАДАНА", "ОТСУТСТВУЕТ"]: 
            StreetItemToken._m_ontology.add(Termin._new124(s, StreetItemType.ABSENT))
        StreetItemToken.__m_misc_nouns = TerminCollection()
        for s in ["ВАЛ", "ПОЛЕ", "СПУСК", "ВЗВОЗ", "РЯД", "СЛОБОДА", "РОЩА", "ПРУД", "СЪЕЗД", "КОЛЬЦО", "УЗВІЗ", "УЗВІЗ", "ГАЙ", "СТАВОК", "ЗЇЗД", "КІЛЬЦЕ"]: 
            StreetItemToken.__m_misc_nouns.add(Termin(s))
    ...
    def is_road(self) -> bool:
        if (self.termin is None): 
            return False
        if (((self.termin.canonic_text == "АВТОДОРОГА" or self.termin.canonic_text == "ШОССЕ" or self.termin.canonic_text == "ТРАКТ") or self.termin.canonic_text == "АВТОШЛЯХ" or self.termin.canonic_text == "ШОСЕ") or self.termin.canonic_text == "МАГИСТРАЛЬ" or self.termin.canonic_text == "МАГІСТРАЛЬ"): 
            return True
        return False
    ...
    def _prepare_all_data(t0 : 'Token') -> None:
        ...
        while t is not None: 
            ...
            first_pass3363 = True
            while True:
                if first_pass3363: first_pass3363 = False
                ...
                if (str0_._no_geo_in_this_token): 
                    if (((prev is not None and prev.typ == StreetItemType.NOUN)) or StreetItemToken.check_keyword(str0_.end_token.next0_)): 
                        ...
                        while tt is not None and tt.end_char <= str0_.end_char: 
                            ...
                            dd.no_geo = True
                            tt = tt.next0_
                if (str0_.misc is not None and str0_.begin_token != str0_.end_token): 
                    tt = str0_.begin_token
                    while tt is not None and tt.end_char <= str0_.end_char: 
                        dd = Utils.asObjectOrNull(tt.tag, GeoTokenData)
                        if (dd is None): 
    ...
    def try_parse(t : 'Token', prev : 'StreetItemToken'=None, in_search : bool=False, ad : 'GeoAnalyzerData'=None) -> 'StreetItemToken':
        ...
        if ((StreetItemToken.SPEED_REGIME and ((ad.sregime or ad.all_regime)) and not in_search) and not (isinstance(t, ReferentToken))): 
            if ((isinstance(t, TextToken)) and t.is_char('м')): 
                ...
                if (d.street is not None): 
                    if (d.street._cond is None or d.no_city): 
                        return d.street
                    if (d.street._cond.check()): 
                        return d.street
                    return None
                if (d.org0_ is not None): 
                    return StreetItemToken._new536(t, d.org0_.end_token, StreetItemType.FIX, d.org0_)
                return None
        if (ad.slevel > 3): 
            return None
        ad.slevel += 1
        ...
        if (res is not None and res.typ != StreetItemType.NOUN): 
            ...
            if (tt is not None and res.typ == StreetItemType.NUMBER and tt.is_value("ОТДЕЛЕНИЕ", None)): 
                ...
                if ((ait is not None and ait.typ == AddressItemType.STREET and ait.end_token.next0_ is not None) and ait.end_token.next0_.is_char(')')): 
                    ...
                    if ((sit is not None and ((sit.typ == StreetItemType.NAME or sit.typ == StreetItemType.STDNAME)) and sit.end_token.next0_ is not None) and sit.end_token.next0_.is_char(')')): 
                        oty = OrgTypToken.try_parse(tt.next0_, False, None)
                        if (oty is not None and oty.end_token == sit.end_token): 
            ...
            if (res.begin_token == res.end_token and ((res.typ == StreetItemType.NAME or res.typ == StreetItemType.STDNAME or res.typ == StreetItemType.STDPARTOFNAME))): 
                ...
                if (end is not None): 
                    tok = StreetItemToken._m_ontology.try_parse(end, TerminParseAttr.NO)
                    if (tok is not None): 
                        if ((Utils.valToEnum(tok.termin.tag, StreetItemType)) == StreetItemType.NOUN or (Utils.valToEnum(tok.termin.tag, StreetItemType)) == StreetItemType.STDPARTOFNAME): 
                            end = (None)
                if (end is not None): 
                    res.end_token = end
                    if (res.value is None): 
        ...
        if (res is not None and res.is_road): 
            ...
            first_pass3364 = True
            while True:
                if first_pass3364: first_pass3364 = False
                else: tt = tt.next0_
                if (not (tt is not None)): break
    ...
    def _try_parse(t : 'Token', ignore_onto : bool, prev : 'StreetItemToken', in_search : bool) -> 'StreetItemToken':
        ...
        if (res1 is not None): 
            if (res1[0].typ == StreetItemType.NAME or res1[0].typ == StreetItemType.STDNAME): 
                return res1[0]
            if (len(res1) == 1 and res1[0].typ == StreetItemType.NUMBER and res1[0].number_has_prefix): 
                return res1[0]
        ...
        if ((t.is_value("А", None) or t.is_value("АД", None) or t.is_value("АВТ", None)) or t.is_value("АВТОДОР", None)): 
            ...
            if (t.is_value("А", None)): 
                ...
                if (tt1 is not None and tt1.is_char_of("\\/")): 
                    tt1 = tt1.next0_
                elif ((tt1 is not None and not tt1.is_whitespace_after and tt1.is_char_of(",.")) and MiscLocationHelper.is_user_param_address(tt1)): 
                    tt1 = tt1.next0_
                ...
                tt1 = tt1.next0_
            if (tt1 is not None): 
                if (t == tt1 and (t.length_char < 5) and not MiscLocationHelper.is_user_param_address(t)): 
                    pass
                else: 
                    res = StreetItemToken._new658(t, tt1, StreetItemType.NOUN, StreetItemToken.__m_road)
                    if (res.length_char >= 4): 
                        return res
        ...
        if ((((t.is_value("Ж", None) or t.is_value("ЖЕЛ", None))) and t.next0_ is not None and t.next0_.is_char_of("\\/")) and (isinstance(t.next0_.next0_, TextToken)) and t.next0_.next0_.is_value("ДОРОЖНЫЙ", None)): 
            return StreetItemToken._new558(t, t.next0_.next0_, StreetItemType.NAME, "ЖЕЛЕЗНО" + t.next0_.next0_.term)
        if ((((t.is_value("ФЕДЕРАЛЬНЫЙ", None) or t.is_value("ГОСУДАРСТВЕННЫЙ", None) or t.is_value("АВТОМОБИЛЬНЫЙ", None)) or t.is_value("ФЕД", None) or t.is_value("ФЕДЕРАЛ", None)) or t.is_value("ГОС", None) or t.is_value("АВТО", None)) or t.is_value("АВТОМОБ", None)): 
            ...
            if (tok2 is not None and ((tok2.termin.canonic_text == "АВТОДОРОГА" or tok2.termin.canonic_text == "МАГИСТРАЛЬ"))): 
                return StreetItemToken._new658(t, tok2.end_token, StreetItemType.NOUN, tok2.termin)
        if (t.is_hiphen and prev is not None and prev.typ == StreetItemType.NAME): 
            num = NumberHelper.try_parse_roman(t.next0_)
            if (num is not None): 
                return StreetItemToken._new568(t, num.end_token, StreetItemType.NUMBER, num.value, True)
        if (t.is_value("НОЛЬ", None) or t.is_value("НУЛЬ", None)): 
            if (isinstance(t.next0_, NumberToken)): 
                return StreetItemToken._new558(t, t.next0_, StreetItemType.NUMBER, "0" + t.next0_.value)
        if (t.is_newline_before): 
            if (t.is_value("ТАБЛИЦА", None) or t.is_value("РИСУНОК", None) or t.is_value("ФОРМУЛА", None)): 
                return None
        t0 = t
        tn = None
        ...
        if (org1 is not None): 
            ...
            if (org1.is_gsk or not org1.is_doubt or org1.has_terr_keyword): 
                return StreetItemToken._new536(t0, org1.end_token, StreetItemType.FIX, org1)
        ...
        if (geo1 is not None and geo1.is_city and MiscLocationHelper.is_user_param_address(t)): 
            for ty in geo1.typs: 
                if ((ty == "поселок" or ty == "станция" or ty == "слобода") or ty == "хутор"): 
                    return StreetItemToken._new664(t0, t, StreetItemType.FIX, geo1)
        ...
        if (nnn2 is not None and ((nnn2.has_prefix or nnn2.is_cadaster_number))): 
            return StreetItemToken._new665(t, nnn2.end_token, nnn2.value, StreetItemType.NUMBER, True)
        if (prev is not None): 
            pass
        has_named = False
        ...
        if (t.is_value("ГЕРОЙ", None)): 
            if ((isinstance(t, TextToken)) and t.term == "ГЕРОЕВ"): 
                pass
            else: 
                ...
                if (ters is not None and len(ters) > 0): 
                    ...
                    if (nnn is not None and nnn.typ == StreetItemType.NAME): 
                        return nnn
        if (t.is_value("БОЙЦОВ", None)): 
            if ((isinstance(t.next0_, NumberToken)) and (isinstance(t.next0_.next0_, TextToken)) and t.next0_.next0_.morph.case_.is_genitive): 
                return StreetItemToken._new558(t, t.next0_, StreetItemType.NUMBER, t.next0_.value)
        if (t.is_value("НЕЗАВИСИМОСТЬ", None)): 
            ...
            if (ters is not None and len(ters) > 0): 
                ...
                if (ters[0].onto_item is not None): 
                    ...
                    tok2 = ters[1]
                if (tok2 is not None): 
                    res = StreetItemToken._new574(t, tok2.end_token, StreetItemType.NAME)
        ...
        if (nt is not None and nt.int_value is not None): 
            return StreetItemToken._new668(nt.begin_token, nt.end_token, StreetItemType.AGE, nt.value, NumberSpellingType.AGE)
        ...
        if ((nt) is not None): 
            if (nt.int_value is None): 
                ...
                if (prev is not None and prev.typ == StreetItemType.NOUN): 
                    ...
                    if (next0__ is not None and next0__.typ == StreetItemType.NOUN): 
                        ...
                        return None
            res = StreetItemToken._new669(nt, nt, StreetItemType.NUMBER, nt.value, nt.typ, nt.morph)
            res.value = nt.value
            ...
            if (nex is not None): 
                if (nex.ex_typ == NumberExType.KILOMETER): 
                    ...
                    if (res.value.startswith("0") and len(res.value) > 1): 
        ...
        if ((ntt is not None and (isinstance(ntt, NumberToken)) and prev is not None) and ntt.int_value is not None): 
            return StreetItemToken._new572(t, ntt, StreetItemType.NUMBER, ntt.value, ntt.typ, True)
        ...
        if ((isinstance(t, ReferentToken)) and t.begin_token == t.end_token and not t.chars.is_all_lower): 
            if (prev is not None and prev.typ == StreetItemType.NOUN): 
                if (((prev.morph.number) & (MorphNumber.PLURAL)) == (MorphNumber.UNDEFINED)): 
                    res = StreetItemToken._new558(t, t, StreetItemType.NAME, MiscHelper.get_text_value_of_meta_token(Utils.asObjectOrNull(t, ReferentToken), GetTextAttr.NO))
                    if ((t.next0_ is not None and t.next0_.is_hiphen and (isinstance(t.next0_.next0_, TextToken))) and not t.is_whitespace_after and not t.next0_.is_whitespace_after): 
                        res.end_token = t.next0_.next0_
                        res.value = "{0} {1}".format(res.value, res.end_token.term)
                    return res
        if (t.is_value("ЧАСТЬ", None)): 
            return None
        if (t.is_value("УГОЛ", None)): 
            if (prev is not None and ((prev.typ == StreetItemType.NOUN or prev.typ == StreetItemType.STDADJECTIVE))): 
                pass
            else: 
                return None
        ...
        if (tt is not None and tt.morph.class0_.is_adjective): 
            if (tt.chars.is_capital_upper or MiscLocationHelper.is_user_param_address(tt) or ((prev is not None and prev.typ == StreetItemType.NUMBER and tt.is_value("ТРАНСПОРТНЫЙ", None)))): 
                ...
                if (npt is not None and len(npt.adjectives) == 1): 
                    tte = npt.end_token
                if (StreetItemToken.__m_misc_nouns.try_parse(tte, TerminParseAttr.NO) is not None): 
                    sit = StreetItemToken._new672(tt, tte, True)
                ...
                if (npt is not None and npt.begin_token != npt.end_token and len(npt.adjectives) <= 1): 
                    ...
                    if (oo is not None): 
                        if ((Utils.valToEnum(oo.termin.tag, StreetItemType)) == StreetItemType.NOUN or (Utils.valToEnum(oo.termin.tag, StreetItemType)) == StreetItemType.STDPARTOFNAME): 
                            npt = (None)
                ...
                if (npt is not None and npt.begin_token != npt.end_token and len(npt.adjectives) <= 1): 
                    ...
                    if (ok): 
                        ...
                        return sit
        if (tt is not None and (isinstance(tt.next0_, TextToken)) and ((not tt.next0_.chars.is_all_lower or MiscLocationHelper.is_user_param_address(tt)))): 
            if (StreetItemToken.__m_misc_nouns.try_parse(tt, TerminParseAttr.NO) is not None): 
                sit = StreetItemToken.try_parse(tt.next0_, None, False, None)
            ...
            if (tt.is_value("М", None) or tt.is_value("M", None)): 
                if (prev is not None and prev.typ == StreetItemType.NOUN): 
                    ...
                    if (tok1 is not None and tok1.termin.canonic_text == "МИКРОРАЙОН"): 
                        return StreetItemToken._new673(tt, tok1.end_token, tok1.termin, StreetItemType.NOUN)
                    if (NameToken.check_initial(tt) is not None or MiscLocationHelper.is_user_param_address(tt)): 
                        pass
                    else: 
                        return StreetItemToken._new674(tt, tt.next0_, StreetItemToken.__m_metro, StreetItemType.NOUN, True)
        ot = None
            ...
            if (ot is not None and ot.begin_token == ot.end_token and ot.morph.class0_.is_adjective): 
                ...
                if (tok0 is not None): 
                    if ((Utils.valToEnum(tok0.termin.tag, StreetItemType)) == StreetItemType.STDADJECTIVE): 
                        ot = (None)
        if (ot is not None): 
            res0 = StreetItemToken._new675(ot.begin_token, ot.end_token, StreetItemType.NAME, Utils.asObjectOrNull(ot.item.referent, StreetReferent), ot.morph, True)
            return res0
        if (prev is not None and prev.typ == StreetItemType.NOUN and prev.termin.canonic_text == "ПРОЕЗД"): 
            if (t.is_value("ПР", None)): 
                res1 = StreetItemToken._new558(t, t, StreetItemType.NAME, "ПРОЕКТИРУЕМЫЙ")
        ...
        if (tok is not None and tok.begin_token == tok.end_token): 
            if (((Utils.valToEnum(tok.termin.tag, StreetItemType)) == StreetItemType.NAME or t.is_value("ГАРАЖНО", None) or t.length_char == 1) or t.is_value("СТ", None)): 
                ...
                if (org0_ is not None): 
                    tok = (None)
                    if (t.length_char < 3): 
                        return StreetItemToken._new536(t, org0_.end_token, StreetItemType.FIX, org0_)
        ...
        if (tok is not None and not ignore_onto): 
            if ((Utils.valToEnum(tok.termin.tag, StreetItemType)) == StreetItemType.NUMBER): 
                if ((isinstance(tok.end_token.next0_, NumberToken)) and tok.end_token.next0_.int_value is not None): 
                    return StreetItemToken._new678(t, tok.end_token.next0_, StreetItemType.NUMBER, tok.end_token.next0_.value, tok.end_token.next0_.typ, True, tok.morph)
                return None
            if ((Utils.valToEnum(tok.termin.tag, StreetItemType)) == StreetItemType.ABSENT): 
                return StreetItemToken._new574(t, tok.end_token, StreetItemType.ABSENT)
            if (tt is None): 
                return None
            abr = True
            ...
            if (swichVal == StreetItemType.STDADJECTIVE): 
                    ...
                    if (tt.is_value(tok.termin.canonic_text, None)): 
                        ...
                        if (not tok.end_token.is_char('.')): 
                            ...
                            if (tok.end_token.is_newline_after and prev is not None and prev.typ != StreetItemType.NOUN): 
                                ...
                                if (next0__ is not None and ((next0__.typ == StreetItemType.NAME or next0__.typ == StreetItemType.NOUN))): 
                                    ...
                                    oo2 = True
                            if (oo2): 
                                return StreetItemToken._new680(tok.begin_token, tok.end_token, StreetItemType.STDADJECTIVE, tok.termin, abr, tok.morph)
                            break
                        ...
                        if (isinstance(tt2, TextToken)): 
                            ...
                            if (tt2.chars.is_capital_upper): 
                                ...
                                if (is_sur): 
                                    break
                    res1 = StreetItemToken._new680(tok.begin_token, tok.end_token, StreetItemType.STDADJECTIVE, tok.termin, abr, tok.morph)
                ...
                while True:
                    ...
                    if ((tok.end_token == tok.begin_token and not t.chars.is_all_lower and t.morph.class0_.is_proper_surname) and t.chars.is_cyrillic_letter): 
                        if (((t.morph.number) & (MorphNumber.PLURAL)) != (MorphNumber.UNDEFINED) and not MiscLocationHelper.is_user_param_address(t)): 
                            if (not t.is_value("НАБЕРЕЖНЫЙ", None)): 
                                return None
                    if (tt.term == "ДОРОГОЙ" or tt.term == "РЯДОМ"): 
                        return None
                    if (tt.is_value("ЗАЕЗД", None) or tt.is_value("ВЫЕЗД", None)): 
                        if (not MiscLocationHelper.is_user_param_address(tt)): 
                            return None
                    if (tt.is_value("НАБЕРЕЖНЫЙ", None) and (isinstance(tt, TextToken))): 
                        is_name = False
                        next0__ = StreetItemToken._try_parse(tt.next0_, ignore_onto, None, in_search)
                        if (prev is not None): 
                            if (next0__ is not None and next0__.typ == StreetItemType.NAME): 
                                pass
                            elif (prev.typ == StreetItemType.NOUN or prev.typ == StreetItemType.NUMBER): 
                                is_name = True
                        elif (next0__ is None): 
                            is_name = True
                        elif (next0__.typ == StreetItemType.NOUN or next0__.typ == StreetItemType.NUMBER): 
                            is_name = True
                        if (is_name): 
                            return StreetItemToken._new558(tt, tt, StreetItemType.NAME, tt.term)
                    alt = None
                    ...
                    res = StreetItemToken._new683(tok.begin_token, tok.end_token, StreetItemType.NOUN, tok.termin, alt, abr, tok.morph, (tok.termin.tag2 if isinstance(tok.termin.tag2, int) else 0))
                ...
                if (((t.length_char == 1 and t.next0_ is not None and t.next0_.is_char('.')) and t.next0_.next0_ is not None and t.next0_.next0_.length_char == 1) and t.next0_.next0_.end_char <= tok.end_char): 
                ...
                if (tok.begin_token.chars.is_all_lower and not is_post_off and tok.end_token.chars.is_all_lower): 
                    if (StreetItemToken.check_keyword(tok.end_token.next0_)): 
                        ...
                        return None
                sits = StreetItemToken._new684(tok.begin_token, tok.end_token, StreetItemType.STDNAME, tok.morph, tok.termin.canonic_text)
                ...
                if ((isinstance(sits.end_token.next0_, TextToken)) and sits.end_token.next0_.length_char == 1): 
                    if (NameToken.check_initial_and_surname(sits.end_token.next0_.term, sits.begin_token)): 
                        sits.end_token = sits.end_token.next0_
                        if (sits.end_token.next0_ is not None and sits.end_token.next0_.is_char('.')): 
                            sits.end_token = sits.end_token.next0_
                return sits
                ...
                if (tt1.next0_ is not None): 
                    if ((tt1.next0_.is_value("ПОЛИЦИИ", None) or tt1.next0_.is_value("МИЛИЦИИ", None) or tt1.next0_.is_value("ГВАРДИИ", None)) or tt1.next0_.is_value("АРМИИ", None)): 
                        tt1 = tt1.next0_
                    if (tt1.next0_ is not None and (isinstance(tt1.next0_.get_referent(), GeoReferent))): 
                        tt1 = tt1.next0_
                    else: 
                        ter = TerrItemToken.try_parse(tt1.next0_, None, None)
                        if (ter is not None and ter.onto_item is not None): 
                            tt1 = ter.end_token
                            no_geo = True
                sit = StreetItemToken.try_parse(tt1.next0_, None, False, None)
                if ((sit is None and tt1.next0_ is not None and vvv is not None) and tt1.next0_.is_hiphen): 
                    sit = StreetItemToken.try_parse(tt1.next0_.next0_, None, False, None)
                ...
                if (sit is None or tt1.whitespaces_after_count > 3): 
                    for m in tok.morph.items: 
                        if (m.number == MorphNumber.PLURAL and m.case_.is_genitive): 
                            return StreetItemToken._new684(tok.begin_token, tt1, StreetItemType.NAME, tok.morph, MiscHelper.get_text_value_of_meta_token(tok, GetTextAttr.NO))
                    return StreetItemToken._new686(tok.begin_token, tt1, StreetItemType.STDPARTOFNAME, tok.morph, tok.termin)
                if (sit.typ == StreetItemType.NUMBER or sit.typ == StreetItemType.STDADJECTIVE): 
                    return StreetItemToken._new684(tok.begin_token, tt1, StreetItemType.NAME, tok.morph, MiscHelper.get_text_value_of_meta_token(tok, GetTextAttr.NO))
                ...
                if (sit.typ == StreetItemType.NOUN): 
                    if (((tok.morph.number) & (MorphNumber.PLURAL)) == (MorphNumber.PLURAL)): 
                        return StreetItemToken._new688(tok.begin_token, tt1, StreetItemType.NAME, StreetItemType.STDPARTOFNAME, tok.morph, MiscHelper.get_text_value_of_meta_token(tok, GetTextAttr.NO))
                    else: 
                        return StreetItemToken._new689(tok.begin_token, tt1, StreetItemType.NAME, StreetItemType.STDPARTOFNAME, tok.morph, tok.termin)
                if (sit.value is not None): 
                    sit.misc = vvv
                elif (sit.exist_street is None): 
                    if (vvv == "ГЕРОЯ"): 
                        if (tt1.term != "ГЕРОЕВ" and sit.begin_token.morph.class0_.is_proper_surname): 
                ...
                if (sit0 is not None and sit0.typ == StreetItemType.NAME and sit0.end_char > tok.end_char): 
                    ...
                    return sit0
                sit1 = StreetItemToken._new690(tok.begin_token, tok.end_token, StreetItemType.NAME, tok.morph, True)
                ...
                return StreetItemToken._new691(tok.begin_token, tok.end_token, StreetItemType.FIX, tok.morph, True, tok.termin)
        if (tt is not None and ((tt.is_value("КИЛОМЕТР", None) or tt.is_value("КМ", None)))): 
            ...
            if ((tt1.whitespaces_after_count < 3) and (isinstance(tt1.next0_, NumberToken))): 
                sit = StreetItemToken._new574(tt, tt1.next0_, StreetItemType.NUMBER)
        ...
        if (tokn is not None): 
            return StreetItemToken._new558(tt, tokn.end_token, StreetItemType.NAME, tokn.termin.canonic_text)
        if (tt is not None): 
            if (((tt.is_value("РЕКА", None) or tt.is_value("РЕЧКА", "РІЧКА"))) and tt.next0_ is not None and ((not tt.next0_.chars.is_all_lower or MiscLocationHelper.is_user_param_address(tt)))): 
                ...
                if (nam is not None and nam.name is not None and nam.number is None): 
                    return StreetItemToken._new694(tt, nam.end_token, StreetItemType.NAME, tt.morph, "реки", nam.name)
                ...
                if (tt.is_value("БАКИНСКИЙ", None) or "БАКИНСК".startswith(tt.term)): 
                    ...
                    if (isinstance(tt2.next0_, TextToken)): 
                        ...
                        if (tt2.is_value("КОМИССАР", None) or tt2.is_value("КОММИССАР", None) or "КОМИС".startswith(tt2.term)): 
                            if (tt2.next0_ is not None and tt2.next0_.is_char('.')): 
                                tt2 = tt2.next0_
                            sit = StreetItemToken._new696(tt, tt2, StreetItemType.STDNAME, True, "БАКИНСКИХ КОМИССАРОВ", tt2.morph)
                            return sit
            if ((tt.next0_ is not None and ((tt.next0_.is_char('.') or ((tt.next0_.is_hiphen and tt.length_char == 1)))) and ((not tt.chars.is_all_lower or MiscLocationHelper.is_user_param_address(tt)))) and (tt.next0_.whitespaces_after_count < 3) and (isinstance(tt.next0_.next0_, TextToken))): 
                ...
                if (sit is not None): 
                    ait = AddressItemToken.try_parse_pure_item(tt, None, None)
                    if (ait is not None): 
                        if (not Utils.isNullOrEmpty(ait.value) and ait.value != "0" and str.isdigit(ait.value[0])): 
                            sit = (None)
                    ...
                    if (sit.is_in_dictionary): 
                        ...
                        if (MiscLocationHelper.check_geo_object_before(tt, False)): 
                            ...
                            if (not ad.sregime and StreetItemToken.SPEED_REGIME): 
                                ok = True
                                sit._cond = Condition._new697(tt, True)
                    ...
                    if (ok): 
                        ...
                        if (tok is not None and (Utils.valToEnum(tok.termin.tag, StreetItemType)) == StreetItemType.STDADJECTIVE and not has_named): 
                            if ((isinstance(tok.end_token.next0_, TextToken)) and tok.end_token.next0_.length_char == 1 and tok.end_token.next0_.chars.is_letter): 
                                ...
                                sit.std_adj_version = StreetItemToken._new698(tok.begin_token, tok.end_token, StreetItemType.STDADJECTIVE, tok.termin, True)
            ...
            if (tt.chars.is_cyrillic_letter and tt.length_char > 1 and not tt.morph.class0_.is_preposition): 
                if (((tt.is_value("ОБЪЕЗД", None) or tt.is_value("ОБХОД", None))) and tt.next0_ is not None): 
                    ...
                    if (prev.is_road): 
                        ...
                        if (cits is not None and (len(cits) < 3)): 
                            resr = StreetItemToken._new699(tt, cits[len(cits) - 1].end_token, StreetItemType.NAME, True)
                            for ci in cits: 
                        ...
                        if (npt2 is not None and npt2.morph.case_.is_genitive): 
                            ...
                            if (tee is not None): 
                                ...
                                if ((tee) is not None): 
                                    tt2 = tee.end_token
                    if (tt2 is not None): 
                        re = StreetItemToken._new700(tt, tt2, StreetItemType.STDPARTOFNAME, MiscHelper.get_text_value(tt, tt2, GetTextAttr.NO), True)
                        ...
                        if (sit is None or sit.typ != StreetItemType.NAME): 
                            ...
                            if (sit is not None and ((sit.typ == StreetItemType.STDADJECTIVE or sit.typ == StreetItemType.NOUN))): 
                                ...
                                ok2 = True
                            if (ok2): 
                                sit = StreetItemToken._new574(tt, tt2, StreetItemType.NAME)
                ...
                if (ani is not None): 
                    return StreetItemToken._new702(t, ani.end_token, StreetItemType.AGE, NumberSpellingType.AGE, ani.value)
                num1 = NumToken.try_parse(t, GeoTokenType.STREET)
                if (num1 is not None): 
                    return StreetItemToken._new702(t, num1.end_token, StreetItemType.NUMBER, NumberSpellingType.ROMAN, num1.value)
                if (prev is not None and prev.typ == StreetItemType.NOUN): 
                    pass
                else: 
                    org0_ = OrgItemToken.try_parse(t, None)
                ...
                if (not tt.chars.is_all_lower): 
                    ...
                    if (ait is not None): 
                        if (tt.next0_ is not None and tt.next0_.is_hiphen): 
                            ...
                            ok1 = True
                        elif ((ait.typ != AddressItemType.NUMBER and ait.typ != AddressItemType.POTCH and ait.typ != AddressItemType.NONUMBER) and ait.begin_token == ait.end_token and not ait.chars.is_all_lower): 
                            ok1 = True
                    else: 
                        ok1 = True
                    ...
                    if (not ok1): 
                        ...
                        if (tt1 is not None and (isinstance(tt1.get_referent(), GeoReferent))): 
                            ...
                            if (not ad.sregime and StreetItemToken.SPEED_REGIME): 
                                ok1 = True
                                cond = Condition._new697(prev.begin_token, True)
                    ...
                    if (nex is not None and nex.termin is not None): 
                        ...
                        aaa = AddressItemToken.try_parse_pure_item(tt, None, None)
                        if (aaa is None): 
                            ok1 = True
                        elif (tt.is_value("УГОЛ", None)): 
                            ok1 = True
                ...
                if (ok1): 
                    ...
                    if (dc.is_adverb and not MiscLocationHelper.is_user_param_address(tt)): 
                        if (not ((dc.is_proper))): 
                            if (tt.next0_ is not None and tt.next0_.is_hiphen): 
                                ...
                                return None
                    res = StreetItemToken._new706(tt, tt, StreetItemType.NAME, tt.morph, cond)
                    if ((tt.next0_ is not None and ((tt.next0_.is_hiphen)) and (isinstance(tt.next0_.next0_, TextToken))) and not tt.is_whitespace_after and not tt.next0_.is_whitespace_after): 
                        ...
                        if (ok2): 
                            ...
                            if (res.end_token.chars.is_latin_letter): 
                                lat = NumberHelper.try_parse_roman(res.end_token)
                                if (lat is not None): 
                                    res.value = MiscHelper.get_text_value(tt, tt, GetTextAttr.NO)
                                    res.next_item = StreetItemToken._new568(tt.next0_.next0_, lat.end_token, StreetItemType.NUMBER, lat.value, True)
                                    res.end_token = tt.next0_
                                    return res
                            if (tt.get_morph_class_in_dictionary().is_proper_name and not tt.term.endswith("О") and res.end_token.morph.class0_.is_proper_surname): 
                                res.misc = MiscHelper.get_text_value(tt, tt, GetTextAttr.NO)
                        ...
                        if (tt.next0_.is_value("БИ", None) or tt.next0_.is_value("АТА", None) or tt.next0_.is_value("СУ", None)): 
                            ...
                            if (nn is None or nn.typ == StreetItemType.NAME): 
                                ...
                                elif ((nn is not None and t.length_char >= 3 and t.get_morph_class_in_dictionary().is_proper_name) and ((nn.begin_token.morph.class0_.is_proper_surname or nn.end_token.morph.class0_.is_proper_surname or nn.begin_token.morph.class0_.is_proper_secname))): 
                                    res.end_token = nn.end_token
                                    if (nn.begin_token.next0_ == nn.end_token and nn.begin_token.morph.class0_.is_proper_secname): 
                                        res.value = MiscHelper.get_text_value(nn.begin_token.next0_, nn.end_token, GetTextAttr.NO)
                                    elif (nn._orto_terr is not None): 
                                        res.value = MiscHelper.get_text_value(nn.begin_token, nn.begin_token, GetTextAttr.NO)
                                        res._orto_terr = nn._orto_terr
                                    else: 
                                        res.value = MiscHelper.get_text_value_of_meta_token(nn, GetTextAttr.NO)
                                    res.misc = MiscHelper.get_text_value(t, t, GetTextAttr.NO)
                                    if (nn.begin_token.morph.class0_.is_proper_secname and nn.end_token.next0_ is not None and nn.end_token.next0_.morph.class0_.is_proper_surname): 
                                        res.end_token = nn.end_token.next0_
                                        res.value = MiscHelper.get_text_value(res.end_token, res.end_token, GetTextAttr.NO)
                                elif ((tt1 is not None and tt1.length_char > 2 and AddressItemToken.check_house_after(tt1.next0_, False, False)) and tt1.chars.is_cyrillic_letter == tt.chars.is_cyrillic_letter and (t.whitespaces_after_count < 2)): 
                                    if (tt1.morph.class0_.is_verb and not tt1.is_value("ДАЛИ", None)): 
                                        pass
                                    elif (npt is None and ((not tt1.chars.is_all_lower or MiscLocationHelper.is_user_param_address(tt1))) and not is_pref): 
                                        pass
                                    else: 
                                        res.end_token = tt1
                                ...
                                elif (nn is not None and nn.begin_token.next0_ == nn.end_token and nn.end_token.morph.class0_.is_proper_surname): 
                                    res.end_token = nn.end_token
                                    if (nn.misc is not None and nn.end_token.morph.class0_.is_proper_secname): 
                                        res.value = MiscHelper.get_text_value(t, t, GetTextAttr.NO)
                                        res.misc = nn.misc
                                    else: 
                                        res.value = MiscHelper.get_text_value(nn.end_token, nn.end_token, GetTextAttr.NO)
                                        res.misc = MiscHelper.get_text_value(t, t, GetTextAttr.NO)
                                ...
                                if (gen != MorphGender.UNDEFINED and ((not nn.morph.case_.is_nominative or nn.morph.number != MorphNumber.SINGULAR))): 
                                    ...
                                    var = None
                                    try: 
                                        var = MorphologyService.get_wordform(res.value, MorphBaseInfo._new708(MorphCase.NOMINATIVE, MorphClass.ADJECTIVE, MorphNumber.SINGULAR, gen))
                    ...
                    if (res is not None and res.typ == StreetItemType.NAME and (res.whitespaces_after_count < 2)): 
                        ...
                        if (NameToken.check_initial_back(tt)): 
                            ...
                            if ((((res.whitespaces_after_count < 2) and tt is not None and tt.length_char == 1) and tt.chars.is_all_upper and tt.next0_ is not None) and tt.next0_.is_char('.')): 
                                res.end_token = tt.next0_
                            tt = (Utils.asObjectOrNull(res.end_token.next0_, TextToken))
                        elif ((tt is not None and tt.length_char == 1 and tt.next0_ is not None) and ((tt.chars.is_all_upper or ((MiscLocationHelper.is_user_param_address(tt) and tt.next0_.is_char('.'))))) and tt.next0_.is_char_of(".,")): 
                            if (StreetItemToken.try_parse(tt, None, False, None) is not None or ((not tt.next0_.is_comma and AddressItemToken.check_house_after(tt, False, False)))): 
                                ...
                                if (rt is None): 
                                    ...
                                    res.end_token = tt.next0_
                                    tt = (Utils.asObjectOrNull(res.end_token.next0_, TextToken))
                                    if (((res.whitespaces_after_count < 2) and tt is not None and tt.length_char == 1) and ((tt.chars.is_all_upper or MiscLocationHelper.is_user_param_address(tt)))): 
                                ...
                                if (ok2): 
                                    ...
                                    if (res.begin_token != res.end_token): 
                                        ...
                                        if (((mc1.is_proper_name and not mc2.is_proper_name)) or ((not mc1.is_proper_surname and mc2.is_proper_surname))): 
                                            res.misc = res.value
                                            res.value = MiscHelper.get_text_value(res.end_token, res.end_token, GetTextAttr.NO)
                                        elif (mc1.is_proper_name and ((mc2.is_proper_surname or mc2.is_proper_name or mc2.is_undefined))): 
                                            res.misc = res.value
                                            res.value = MiscHelper.get_text_value(res.end_token, res.end_token, GetTextAttr.NO)
                                        else: 
                                            ...
                                            if (pp is not None and pp.end_token == res.end_token.previous and not mc1.is_proper_surname): 
                                                res.misc = res.value
                                                res.value = MiscHelper.get_text_value(res.end_token, res.end_token, GetTextAttr.NO)
                                            elif ((res.begin_token.morph.class0_.is_proper_surname and res.begin_token.next0_.morph.class0_.is_proper_name and res.begin_token.next0_.next0_ == res.end_token) and res.end_token.morph.class0_.is_proper_secname): 
                                                res.misc = MiscHelper.get_text_value(res.end_token.previous, res.end_token.previous, GetTextAttr.NO)
                                            else: 
                    ...
                    if (res.begin_token == res.end_token): 
                        ...
                        elif (res.typ == StreetItemType.NAME): 
                            cou = 0
                            ttt = res.end_token.next0_
                            while ttt is not None and (cou < 2): 
                                if (not ttt.is_hiphen): 
                                    break
                                if (ttt.is_whitespace_before or ttt.is_whitespace_after): 
                                    break
                                if (not (isinstance(ttt.next0_, TextToken)) or (ttt.next0_.length_char < 2) or ttt.next0_.chars.is_latin_letter): 
                                    break
                                if (StreetItemToken._m_ontology.try_parse(ttt.next0_, TerminParseAttr.NO) is not None): 
                                    break
                                ttt = ttt.next0_
                                if (res.value is None): 
                                    res.value = MiscHelper.get_text_value_of_meta_token(res, GetTextAttr.NO)
                                res.value = "{0} {1}".format(res.value, ttt.term)
                                if (res.alt_value is not None): 
                                    res.alt_value = "{0} {1}".format(res.alt_value, ttt.term)
                                res.end_token = ttt
            ...
            if (tt.is_value("№", None) or tt.is_value("НОМЕР", None) or tt.is_value("НОМ", None)): 
                ...
                if ((isinstance(tt1, NumberToken)) and tt1.int_value is not None): 
                    return StreetItemToken._new709(tt, tt1, StreetItemType.NUMBER, tt1.typ, tt1.value, True)
            if (tt.is_hiphen and (isinstance(tt.next0_, NumberToken)) and tt.next0_.int_value is not None): 
                if (prev is not None and prev.typ == StreetItemType.NOUN): 
                    if ((prev.noun_can_be_name or prev.termin.canonic_text == "МИКРОРАЙОН" or prev.termin.canonic_text == "КВАРТАЛ") or LanguageHelper.ends_with(prev.termin.canonic_text, "ГОРОДОК")): 
                        return StreetItemToken._new709(tt, tt.next0_, StreetItemType.NUMBER, tt.next0_.typ, tt.next0_.value, True)
            if (((isinstance(tt, TextToken)) and tt.length_char == 1 and (tt.whitespaces_before_count < 2)) and tt.chars.is_letter and tt.chars.is_all_upper): 
                if (prev is not None and prev.typ == StreetItemType.NOUN): 
                    nn = NumToken.try_parse(tt, GeoTokenType.STRONG)
                    if (nn is not None): 
                        if (nn.end_token != tt): 
                            return StreetItemToken._new558(tt, nn.end_token, StreetItemType.NUMBER, nn.value)
            ...
            if (prev is not None and prev.typ == StreetItemType.NOUN): 
                if (AddressItemToken.check_house_after(t.next0_, False, False)): 
                    ...
                    if (res1 is not None and res1.end_char == t.end_char): 
                        ...
                        return res1
                    res = StreetItemToken._new558(t, t, StreetItemType.NAME, MiscHelper.get_text_value(t, t, GetTextAttr.NO))
                    return res
        if (((isinstance(tt, TextToken)) and tt.chars.is_capital_upper and tt.chars.is_latin_letter) and (tt.whitespaces_after_count < 2)): 
            ...
            if (tok1 is not None): 
                return StreetItemToken._new684(tt, tt2.previous, StreetItemType.NAME, tt.morph, tt.term)
        if (((prev is not None and prev.typ == StreetItemType.NAME and prev.begin_token == prev.end_token) and (isinstance(tt, TextToken)) and tt.chars.is_latin_letter) and tt.previous is not None and tt.previous.get_morph_class_in_dictionary().is_proper_name): 
            num = NumberHelper.try_parse_roman(tt)
            if (num is not None): 
                return StreetItemToken._new558(tt, num.end_token, StreetItemType.NUMBER, num.value)
        if (((tt is not None and tt.is_value("ПОДЪЕЗД", None) and prev is not None) and prev.is_road and tt.next0_ is not None) and tt.next0_.is_value("К", None) and tt.next0_.next0_ is not None): 
            sit = StreetItemToken._new574(tt, tt.next0_, StreetItemType.NAME)
    ...
    def _try_parse_spec(t : 'Token', prev : 'StreetItemToken') -> typing.List['StreetItemToken']:
        ...
        res = None
        sit = None
        if (t.is_value2("ЗА", "ЛИНИЕЙ")): 
            next0__ = AddressItemToken.try_parse(t.next0_.next0_, False, None, None)
            if (next0__ is not None): 
                sit = StreetItemToken._new574(t, next0__.end_token, StreetItemType.STDNAME)
                nnn = (str(next0__.referent).upper() if next0__.referent is not None else str(next0__).upper())
                if (nnn.startswith("ТЕРРИТОРИЯ ")): 
                    nnn = nnn[11:]
                sit.value = ("ЗА ЛИНИЕЙ " + nnn)
                res = list()
                res.append(sit)
                return res
        if (isinstance(t.get_referent(), DateReferent)): 
            ...
            if (not (isinstance(t.begin_token, NumberToken))): 
                if (dr.month > 0 and t.begin_token == t.end_token): 
                    res = list()
                    sit = StreetItemToken._new558(t, t, StreetItemType.STDNAME, MiscHelper.get_text_value_of_meta_token(Utils.asObjectOrNull(t, ReferentToken), GetTextAttr.NO))
                    res.append(sit)
                    return res
                return None
            if (dr.year == 0 and dr.day > 0 and dr.month > 0): 
                res = list()
                res.append(StreetItemToken._new721(t, t, StreetItemType.NUMBER, True, NumberSpellingType.DIGIT, str(dr.day)))
                tmp = dr.to_string_ex(False, t.morph.language, 0)
                i = tmp.find(' ')
                sit = StreetItemToken._new558(t, t, StreetItemType.STDNAME, tmp[i + 1:].upper())
                res.append(sit)
                sit.chars.is_capital_upper = True
                return res
            if (dr.year > 0 and dr.month == 0): 
                res = list()
                res.append(StreetItemToken._new721(t, t, StreetItemType.NUMBER, True, NumberSpellingType.DIGIT, str(dr.year)))
                sit = StreetItemToken._new558(t, t, StreetItemType.STDNAME, ("РОКУ" if t.morph.language.is_ua else "ГОДА"))
                res.append(sit)
                sit.chars.is_capital_upper = True
                return res
            return None
        if (prev is not None and prev.typ == StreetItemType.AGE): 
            ...
            if (isinstance(t.get_referent(), GeoReferent)): 
                sit = StreetItemToken._new725(t, t, StreetItemType.NAME, t.get_source_text().upper(), t.get_referent().to_string_ex(True, t.kit.base_language, 0).upper())
                res.append(sit)
            elif (t.is_value("ГОРОД", None) or t.is_value("МІСТО", None)): 
                sit = StreetItemToken._new558(t, t, StreetItemType.NAME, "ГОРОДА")
                res.append(sit)
            else: 
                return None
            return res
        if (prev is not None and prev.typ == StreetItemType.NOUN): 
            ...
            if (num is not None): 
                res = list()
                sit = StreetItemToken._new558(num.begin_token, num.end_token, StreetItemType.NUMBER, num.value)
                res.append(sit)
                return res
        can_be_road = False
        if (prev is not None and prev.is_road and (t.whitespaces_before_count < 3)): 
            can_be_road = True
        elif (((prev is None and t.next0_ is not None and t.next0_.is_hiphen) and MiscLocationHelper.is_user_param_address(t) and t.next0_.next0_ is not None) and t.next0_.next0_.length_char > 1): 
            cou = 5
            tt = t.next0_
        ...
        if (can_be_road): 
            ...
            while True:
                ...
                if (not (tt is not None)): break
                if (tt.whitespaces_before_count > 3 and tt != t): 
                    break
                ...
                if (tt.next0_ is not None and tt.next0_.is_hiphen): 
                    tt = tt.next0_
                elif (tt.next0_ is not None and tt.next0_.is_comma and br): 
                    tt = tt.next0_
                else: 
                    break
            if (vals is not None): 
                ...
                if (ok): 
                    ...
                    sit = StreetItemToken._new574(t, t1, StreetItemType.NAME)
                    res.append(sit)
                    if (len(vals) == 1): 
                        sit.value = vals[0]
                    elif (len(vals) == 2): 
            ...
            if (((isinstance(t, TextToken)) and t.length_char == 1 and t.chars.is_letter) and t.next0_ is not None): 
                ...
                if (isinstance(tt, NumberToken)): 
                    res = list()
                    prev.noun_is_doubt_coef = 0
                    sit = StreetItemToken._new574(t, tt, StreetItemType.NAME)
                    res.append(sit)
                    ch = t.term[0]
        ...
        if ((isinstance(t, TextToken)) and t.length_char == 1 and t.chars.is_letter): 
            ...
            if (tt2 is not None and tt2.is_hiphen): 
                tt2 = tt2.next0_
            if ((isinstance(tt2, NumberToken)) and not tt2.is_whitespace_before): 
                if (prev is not None and prev.typ == StreetItemType.NAME): 
                    if (not AddressItemToken.check_house_after(t, False, False)): 
                        res = list()
                        res.append(StreetItemToken._new730(t, tt2, StreetItemType.NUMBER, True, tt2.value))
                        return res
        return None
    ...
    def __try_attach_road_num(t : 'Token') -> 'StreetItemToken':
        ...
        if (not (isinstance(tt, NumberToken))): 
            return None
        res = StreetItemToken._new574(t, tt, StreetItemType.NAME)
        res.value = "{0}{1}".format(t.get_source_text().upper(), tt.value)
        return res
    
    @staticmethod
    def _new536(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'OrgItemToken') -> 'StreetItemToken':
    ...
    @staticmethod
    def _new558(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : str) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        return res
    ...
    @staticmethod
    def _new568(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : str, _arg5 : bool) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
    ...
    @staticmethod
    def _new571(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : str, _arg5 : bool) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
    ...
    @staticmethod
    def _new572(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : str, _arg5 : 'NumberSpellingType', _arg6 : bool) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
    ...
    @staticmethod
    def _new574(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType') -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        return res
    
    @staticmethod
    def _new575(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : bool) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
    ...
    @staticmethod
    def _new658(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'Termin') -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.termin = _arg4
        return res
    ...
    @staticmethod
    def _new664(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'GeoReferent') -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res._city = _arg4
        return res
    ...
    @staticmethod
    def _new665(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str, _arg4 : 'StreetItemType', _arg5 : bool) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.value = _arg3
        res.typ = _arg4
        res.number_has_prefix = _arg5
    ...
    @staticmethod
    def _new668(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : str, _arg5 : 'NumberSpellingType') -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.number_type = _arg5
    ...
    @staticmethod
    def _new669(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : str, _arg5 : 'NumberSpellingType', _arg6 : 'MorphCollection') -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.number_type = _arg5
    ...
    @staticmethod
    def _new672(_arg1 : 'Token', _arg2 : 'Token', _arg3 : bool) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.has_std_suffix = _arg3
        return res
    
    @staticmethod
    def _new673(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'Termin', _arg4 : 'StreetItemType') -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.termin = _arg3
        res.typ = _arg4
        return res
    ...
    @staticmethod
    def _new674(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'Termin', _arg4 : 'StreetItemType', _arg5 : bool) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.termin = _arg3
        res.typ = _arg4
    ...
    @staticmethod
    def _new675(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'StreetReferent', _arg5 : 'MorphCollection', _arg6 : bool) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
    ...
    @staticmethod
    def _new678(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : str, _arg5 : 'NumberSpellingType', _arg6 : bool, _arg7 : 'MorphCollection') -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.number_type = _arg5
    ...
    @staticmethod
    def _new680(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'Termin', _arg5 : bool, _arg6 : 'MorphCollection') -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.termin = _arg4
        res.is_abridge = _arg5
    ...
    @staticmethod
    def _new683(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'Termin', _arg5 : 'Termin', _arg6 : bool, _arg7 : 'MorphCollection', _arg8 : int) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.termin = _arg4
    ...
    @staticmethod
    def _new684(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'MorphCollection', _arg5 : str) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.morph = _arg4
        res.value = _arg5
    ...
    @staticmethod
    def _new686(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'MorphCollection', _arg5 : 'Termin') -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.morph = _arg4
        res.termin = _arg5
    ...
    @staticmethod
    def _new688(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'StreetItemType', _arg5 : 'MorphCollection', _arg6 : str) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.alt_typ = _arg4
        res.morph = _arg5
    ...
    @staticmethod
    def _new689(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'StreetItemType', _arg5 : 'MorphCollection', _arg6 : 'Termin') -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.alt_typ = _arg4
        res.morph = _arg5
    ...
    @staticmethod
    def _new690(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'MorphCollection', _arg5 : bool) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.morph = _arg4
    ...
    @staticmethod
    def _new691(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'MorphCollection', _arg5 : bool, _arg6 : 'Termin') -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.morph = _arg4
        res.is_in_dictionary = _arg5
    ...
    @staticmethod
    def _new694(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'MorphCollection', _arg5 : str, _arg6 : str) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.morph = _arg4
        res.misc = _arg5
    ...
    @staticmethod
    def _new696(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : bool, _arg5 : str, _arg6 : 'MorphCollection') -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
    ...
    @staticmethod
    def _new698(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'Termin', _arg5 : bool) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.termin = _arg4
        res.is_abridge = _arg5
    ...
    @staticmethod
    def _new699(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : bool) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
    ...
    @staticmethod
    def _new700(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : str, _arg5 : bool) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
    ...
    @staticmethod
    def _new702(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'NumberSpellingType', _arg5 : str) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
    ...
    @staticmethod
    def _new706(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'MorphCollection', _arg5 : 'Condition') -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.morph = _arg4
        res._cond = _arg5
    ...
    @staticmethod
    def _new709(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : 'NumberSpellingType', _arg5 : str, _arg6 : bool) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.number_type = _arg4
        res.value = _arg5
    ...
    @staticmethod
    def _new721(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : bool, _arg5 : 'NumberSpellingType', _arg6 : str) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
    ...
    @staticmethod
    def _new725(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : str, _arg5 : str) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.alt_value = _arg5
    ...
    @staticmethod
    def _new730(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : bool, _arg5 : str) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.number_has_prefix = _arg4
        res.value = _arg5
    ...
    @staticmethod
    def _new1412(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : bool) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
    ...
    @staticmethod
    def _new1413(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'StreetItemType', _arg4 : bool, _arg5 : int) -> 'StreetItemToken':
        res = StreetItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.is_railway = _arg4
