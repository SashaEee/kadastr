...
class AddressItemToken(MetaToken):
    ...
    def initialize() -> None:
        ...
        t = None
        t = Termin._new124("ДОМ", AddressItemType.HOUSE)
        t.add_abridge("Д.")
        ...
        t = Termin._new359("БУДИНОК", AddressItemType.HOUSE, MorphLang.UA)
        t.add_abridge("Б.")
        t.add_variant("КОТЕДЖ", False)
        t.add_abridge("БУД.")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new360("ВЛАДЕНИЕ", AddressItemType.HOUSE, AddressHouseType.ESTATE)
        t.add_abridge("ВЛАД.")
        t.add_abridge("ВЛД.")
        t.add_abridge("ВЛ.")
        AddressItemToken.__m_ontology.add(t)
        AddressItemToken.M_OWNER = t
        t = Termin._new360("ДОМОВЛАДЕНИЕ", AddressItemType.HOUSE, AddressHouseType.HOUSEESTATE)
        ...
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new362("ОБЪЕКТ НЕЗАВЕРШЕННОГО СТРОИТЕЛЬСТВА", "ОНС", AddressItemType.HOUSE, AddressHouseType.UNFINISHED)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new124("ПОДЪЕЗД ДОМА", AddressItemType.HOUSE)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new124("ЭТАЖ", AddressItemType.FLOOR)
        t.add_abridge("ЭТ.")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new365("ЦОКОЛЬ", AddressItemType.FLOOR, "цокольный")
        ...
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new365("МАНСАРДА", AddressItemType.FLOOR, "мансарда")
        t.add_variant("МАНСАРДНЫЙ", False)
        t.add_variant("МАНСАРДА ЭТАЖ", False)
        t.add_variant("ЭТАЖ МАНСАРДА", False)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new124("ПОДЪЕЗД", AddressItemType.POTCH)
        t.add_abridge("ПОД.")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new124("КОРПУС", AddressItemType.CORPUS)
        t.add_abridge("КОРП.")
        t.add_abridge("КОР.")
        ...
        t.add_abridge("БЛ/ЖД")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new124("К", AddressItemType.CORPUSORFLAT)
        t.add_abridge("К.")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new124("СТРОЕНИЕ", AddressItemType.BUILDING)
        ...
        t.add_abridge("Д.СТР.")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new362("СООРУЖЕНИЕ", "РК", AddressItemType.BUILDING, AddressBuildingType.CONSTRUCTION)
        t.add_abridge("СООР.")
        t.add_abridge("СООРУЖ.")
        t.add_abridge("СООРУЖЕН.")
        t.add_variant("БАШНЯ", False)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new360("ЛИТЕРА", AddressItemType.BUILDING, AddressBuildingType.LITER)
        t.add_abridge("ЛИТ.")
        t.add_variant("ЛИТЕР", False)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new124("УЧАСТОК", AddressItemType.PLOT)
        t.add_abridge("УЧАСТ.")
        t.add_abridge("УЧ.")
        t.add_abridge("УЧ-К")
        ...
        t = Termin._new124("ПОЛЕ", AddressItemType.FIELD)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new375("ГЕНЕРАЛЬНЫЙ ПЛАН", "ГП", AddressItemType.GENPLAN)
        ...
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new124("КВАРТИРА", AddressItemType.FLAT)
        t.add_abridge("КВАРТ.")
        t.add_abridge("КВАР.")
        t.add_abridge("КВ.")
        t.add_abridge("KB.")
        ...
        t.add_abridge("КВЮ")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new124("ОФИС", AddressItemType.OFFICE)
        t.add_abridge("ОФ.")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new359("ОФІС", AddressItemType.OFFICE, MorphLang.UA)
        t.add_abridge("ОФ.")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new124("ПАВИЛЬОН", AddressItemType.PAVILION)
        t.add_abridge("ПАВ.")
        t.add_variant("ТОРГОВЫЙ ПАВИЛЬОН", False)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new359("ПАВІЛЬЙОН", AddressItemType.PAVILION, MorphLang.UA)
        t.add_abridge("ПАВ.")
        t.add_variant("ТОРГОВИЙ ПАВІЛЬЙОН", False)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new124("СЕКЦИЯ", AddressItemType.BLOCK)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new124("БОКС", AddressItemType.BOX)
        ...
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new124("ЧАСТЬ", AddressItemType.PART)
        t.add_abridge("Ч.")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new124("СКВАЖИНА", AddressItemType.WELL)
        t.add_abridge("СКВАЖ.")
        t.add_variant("СКВАЖИНА ГАЗОКОНДЕНСАТНАЯ ЭКСПЛУАТАЦИОННАЯ", False)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new124("ПОМЕЩЕНИЕ", AddressItemType.SPACE)
        t.add_variant("ПОМЕЩЕНИЕ", False)
        t.add_abridge("ПОМ.")
        t.add_abridge("ПОМЕЩ.")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new386("НЕЖИЛОЕ ПОМЕЩЕНИЕ", "НЕЖИЛОЕ", AddressItemType.SPACE, 1)
        t.add_abridge("Н.П.")
        ...
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new387("МЕСТО ОБЩЕГО ПОЛЬЗОВАНИЯ", "МОП", True, "МОП", AddressItemType.SPACE, 1)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new360("КЛАДОВКА", AddressItemType.SPACE, 1)
        t.add_abridge("КЛАД.")
        t.add_abridge("КЛ.")
        t.add_variant("КЛАДОВАЯ", False)
        t.add_variant("КЛАДОВОЕ ПОМЕЩЕНИЕ", False)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new360("СКЛАД", AddressItemType.SPACE, 1)
        t.add_abridge("СКЛ.")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new360("КОТЕЛЬНАЯ", AddressItemType.SPACE, 1)
        t.add_abridge("КОТ.")
        t.add_abridge("КОТЕЛ.")
        t.add_abridge("КОТЕЛН.")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new360("ТОРГОВЫЙ ЗАЛ", AddressItemType.SPACE, 1)
        t.add_abridge("ТОРГ.ЗАЛ")
        t.add_abridge("ТОРГОВ.ЗАЛ")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new386("ЦЕХ", "цех", AddressItemType.SPACE, 1)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new360("РАБОЧИЙ УЧАСТОК", AddressItemType.SPACE, 1)
        t.add_abridge("РАБ.УЧ.")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new394("ЛЕСТНИЧНАЯ КЛЕТКА", "ЛК", "ЛК", AddressItemType.SPACE, 1)
        t.add_variant("ЛФЛК", False)
        t.add_variant("ЛКЛК", False)
        t.add_variant("МОПЛК", False)
        t.add_variant("МОП ЛК", False)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new360("ПОДВАЛ", AddressItemType.SPACE, 1)
        t.add_variant("ПОДВАЛЬНОЕ ПОМЕЩЕНИЕ", False)
        t.add_abridge("ПОДВ.ПОМ.")
        t.add_abridge("ПОДВАЛ.ПОМ.")
        t.add_abridge("ПОДВ.")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new360("АНТРЕСОЛЬ", AddressItemType.SPACE, 1)
        t.add_variant("АНТРЕСОЛ", False)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new360("МАСТЕРСКАЯ", AddressItemType.SPACE, 1)
        t.add_abridge("МАСТ.")
        AddressItemToken.__m_ontology.add(t)
        for s in ["ЧЕРДАК", "КРЫША", "ПОГРЕБ"]: 
            AddressItemToken.__m_ontology.add(Termin._new360(s, AddressItemType.SPACE, 1))
        for s in ["АПТЕКА", "АТЕЛЬЕ", "ОТЕЛЬ", "ГОСТИНИЦА", "ХОСТЕЛ", "СТУДИЯ", "САРАЙ", "ПАРИКМАХЕРСКАЯ", "СТОЛОВАЯ", "КАФЕ", "РЕСТОРАН", "УНИВЕРМАГ", "УНИВЕРСАМ", "СУПЕРМАРКЕТ"]: 
            AddressItemToken.__m_ontology.add(Termin._new360(s, AddressItemType.SPACE, 1))
        t = Termin._new400("МАГАЗИН", AddressItemType.SPACE, 1, 1)
        t.add_abridge("МАГ.")
        t.add_abridge("МАГ-Н")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new400("АПТЕЧНЫЙ ПУНКТ", AddressItemType.SPACE, 1, 1)
        t.add_abridge("А.П.")
        t.add_abridge("А/П")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new124("МАШИНОМЕСТО", AddressItemType.CARPLACE)
        t.add_abridge("М/М")
        ...
        t.add_abridge("MM")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new124("КОМНАТА", AddressItemType.ROOM)
        t.add_abridge("КОМ.")
        t.add_abridge("КОМН.")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new124("КАБИНЕТ", AddressItemType.OFFICE)
        t.add_abridge("КАБ.")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new124("НОМЕР", AddressItemType.NUMBER)
        t.add_abridge("НОМ.")
        t.add_abridge("№")
        t.add_abridge("N")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new406("БЕЗ НОМЕРА", "Б/Н", AddressItemType.NONUMBER)
        ...
        t.add_abridge("БН")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new407("АБОНЕНТСКИЙ ЯЩИК", AddressItemType.POSTOFFICEBOX, "АЯ")
        t.add_abridge("А.Я.")
        t.add_variant("ПОЧТОВЫЙ ЯЩИК", False)
        t.add_abridge("П.Я.")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new407("ГОРОДСКАЯ СЛУЖЕБНАЯ ПОЧТА", AddressItemType.CSP, "ГСП")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new124("ДОСТАВОЧНЫЙ УЧАСТОК", AddressItemType.DELIVERYAREA)
        t.add_abridge("ДОСТ.УЧАСТОК")
        t.add_abridge("ДОСТ.УЧ.")
        t.add_abridge("ДОСТ.УЧ-К")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new410("АДРЕС", AddressItemType.PREFIX, True)
        ...
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new410("АДРЕСА", AddressItemType.PREFIX, True)
        ...
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new124("КИЛОМЕТР", AddressItemType.KILOMETER)
        t.add_abridge("КИЛОМ.")
        t.add_abridge("КМ.")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new124("ПЕРЕСЕЧЕНИЕ", AddressDetailType.CROSS)
        ...
        AddressItemToken.__m_ontology.add(t)
        AddressItemToken.__m_ontology.add(Termin._new124("НА ТЕРРИТОРИИ", AddressDetailType.NEAR))
        AddressItemToken.__m_ontology.add(Termin._new124("СЕРЕДИНА", AddressDetailType.NEAR))
        AddressItemToken.__m_ontology.add(Termin._new124("ПРИМЫКАТЬ", AddressDetailType.NEAR))
        AddressItemToken.__m_ontology.add(Termin._new124("ГРАНИЧИТЬ", AddressDetailType.NEAR))
        t = Termin._new124("ВБЛИЗИ", AddressDetailType.NEAR)
        ...
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new124("РАЙОН", AddressDetailType.NEAR)
        t.add_abridge("Р-Н")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new406("В РАЙОНЕ", "РАЙОН", AddressDetailType.NEAR)
        t.add_abridge("В Р-НЕ")
        AddressItemToken.__m_ontology.add(t)
        AddressItemToken.__m_ontology.add(Termin._new124("ПРИМЕРНО", AddressDetailType.UNDEFINED))
        AddressItemToken.__m_ontology.add(Termin._new124("ПОРЯДКА", AddressDetailType.UNDEFINED))
        AddressItemToken.__m_ontology.add(Termin._new124("ПРИБЛИЗИТЕЛЬНО", AddressDetailType.UNDEFINED))
        AddressItemToken.__m_ontology.add(Termin._new124("ОРИЕНТИР", AddressDetailType.UNDEFINED))
        AddressItemToken.__m_ontology.add(Termin._new124("НАПРАВЛЕНИЕ", AddressDetailType.UNDEFINED))
        Termin.ASSIGN_ALL_TEXTS_AS_NORMAL = True
        AddressItemToken.__m_ontology.add(Termin._new124("СЕВЕРНЕЕ", AddressDetailType.NORTH))
        AddressItemToken.__m_ontology.add(Termin._new124("СЕВЕР", AddressDetailType.NORTH))
        AddressItemToken.__m_ontology.add(Termin._new124("ЮЖНЕЕ", AddressDetailType.SOUTH))
        AddressItemToken.__m_ontology.add(Termin._new124("ЮГ", AddressDetailType.SOUTH))
        AddressItemToken.__m_ontology.add(Termin._new124("ЗАПАДНЕЕ", AddressDetailType.WEST))
        AddressItemToken.__m_ontology.add(Termin._new124("ЗАПАД", AddressDetailType.WEST))
        AddressItemToken.__m_ontology.add(Termin._new124("ВОСТОЧНЕЕ", AddressDetailType.EAST))
        AddressItemToken.__m_ontology.add(Termin._new124("ВОСТОК", AddressDetailType.EAST))
        AddressItemToken.__m_ontology.add(Termin._new124("СЕВЕРО-ЗАПАДНЕЕ", AddressDetailType.NORTHWEST))
        AddressItemToken.__m_ontology.add(Termin._new124("СЕВЕРО-ЗАПАД", AddressDetailType.NORTHWEST))
        AddressItemToken.__m_ontology.add(Termin._new124("СЕВЕРО-ВОСТОЧНЕЕ", AddressDetailType.NORTHEAST))
        AddressItemToken.__m_ontology.add(Termin._new124("СЕВЕРО-ВОСТОК", AddressDetailType.NORTHEAST))
        AddressItemToken.__m_ontology.add(Termin._new124("ЮГО-ЗАПАДНЕЕ", AddressDetailType.SOUTHWEST))
        AddressItemToken.__m_ontology.add(Termin._new124("ЮГО-ЗАПАД", AddressDetailType.SOUTHWEST))
        AddressItemToken.__m_ontology.add(Termin._new124("ЮГО-ВОСТОЧНЕЕ", AddressDetailType.SOUTHEAST))
        AddressItemToken.__m_ontology.add(Termin._new124("ЮГО-ВОСТОК", AddressDetailType.SOUTHEAST))
        t = Termin._new360("ЦЕНТРАЛЬНАЯ ЧАСТЬ", AddressDetailType.CENTRAL, 1)
        t.add_abridge("ЦЕНТР.ЧАСТЬ")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new360("СЕВЕРНАЯ ЧАСТЬ", AddressDetailType.NORTH, 1)
        t.add_abridge("СЕВ.ЧАСТЬ")
        t.add_abridge("СЕВЕРН.ЧАСТЬ")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new360("СЕВЕРО-ВОСТОЧНАЯ ЧАСТЬ", AddressDetailType.NORTHEAST, 1)
        t.add_variant("СЕВЕРОВОСТОЧНАЯ ЧАСТЬ", False)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new360("СЕВЕРО-ЗАПАДНАЯ ЧАСТЬ", AddressDetailType.NORTHWEST, 1)
        t.add_variant("СЕВЕРОЗАПАДНАЯ ЧАСТЬ", False)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new360("ЮЖНАЯ ЧАСТЬ", AddressDetailType.SOUTH, 1)
        t.add_abridge("ЮЖН.ЧАСТЬ")
        t.add_abridge("ЮЖ.ЧАСТЬ")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new360("ЮГО-ВОСТОЧНАЯ ЧАСТЬ", AddressDetailType.SOUTHEAST, 1)
        t.add_variant("ЮГОВОСТОЧНАЯ ЧАСТЬ", False)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new360("ЮГО-ЗАПАДНАЯ ЧАСТЬ", AddressDetailType.SOUTHWEST, 1)
        t.add_variant("ЮГОЗАПАДНАЯ ЧАСТЬ", False)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new360("ЗАПАДНАЯ ЧАСТЬ", AddressDetailType.WEST, 1)
        t.add_abridge("ЗАП.ЧАСТЬ")
        t.add_abridge("ЗАПАД.ЧАСТЬ")
        t.add_abridge("ЗАПАДН.ЧАСТЬ")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new360("ВОСТОЧНАЯ ЧАСТЬ", AddressDetailType.EAST, 1)
        t.add_abridge("ВОСТ.ЧАСТЬ")
        t.add_abridge("ВОСТОЧ.ЧАСТЬ")
        t.add_abridge("ВОСТОЧН.ЧАСТЬ")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new360("ПРАВАЯ ЧАСТЬ", AddressDetailType.RIGHT, 1)
        t.add_abridge("СПРАВА")
        t.add_abridge("ПРАВ.ЧАСТЬ")
        t.add_variant("ПРАВАЯ СТОРОНА", False)
        t.add_abridge("ПРАВ.СТОРОНА")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new360("ЛЕВАЯ ЧАСТЬ", AddressDetailType.LEFT, 1)
        t.add_abridge("СЛЕВА")
        ...
        t.add_abridge("ТАМЖЕ")
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new453("АВТОЗАПРАВОЧНАЯ СТАНЦИЯ", AddressItemType.HOUSE, AddressHouseType.SPECIAL, "АЗС", True, True)
        t.add_variant("АВТО ЗАПРАВОЧНАЯ СТАНЦИЯ", False)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new453("АВТОНОМНАЯ ТЕПЛОВАЯ СТАНЦИЯ", AddressItemType.HOUSE, AddressHouseType.SPECIAL, "АТС", True, True)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new453("ДОРОЖНО РЕМОНТНЫЙ ПУНКТ", AddressItemType.HOUSE, AddressHouseType.SPECIAL, "ДРП", True, True)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new453("УСТАНОВКА КОМПЛЕКСНОЙ ПОДГОТОВКИ ГАЗА", AddressItemType.HOUSE, AddressHouseType.SPECIAL, "УКПГ", True, True)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new453("УСТАНОВКА ПРЕДВАРИТЕЛЬНОЙ ПОДГОТОВКИ ГАЗА", AddressItemType.HOUSE, AddressHouseType.SPECIAL, "УППГ", True, True)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new453("ЦЕНТРАЛЬНЫЙ ПУНКТ СБОРА НЕФТИ", AddressItemType.HOUSE, AddressHouseType.SPECIAL, "ЦПС", True, True)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new453("КОМПЛЕКТНАЯ ТРАНСФОРМАТОРНАЯ ПОДСТАНЦИЯ", AddressItemType.HOUSE, AddressHouseType.SPECIAL, "КТП", True, True)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new453("ТРАНСФОРМАТОРНАЯ ПОДСТАНЦИЯ", AddressItemType.HOUSE, AddressHouseType.SPECIAL, "ТП", True, True)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new453("ДИСПЕТЧЕРСКАЯ НЕФТЕПРОВОДНАЯ СЛУЖБА", AddressItemType.HOUSE, AddressHouseType.SPECIAL, "ДНС", True, True)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new453("КУСТОВАЯ НАСОСНАЯ СТАНЦИЯ", AddressItemType.HOUSE, AddressHouseType.SPECIAL, "КНС", True, True)
        AddressItemToken.__m_ontology.add(t)
        t = Termin._new453("ЦЕНТРАЛЬНЫЙ РАСПРЕДЕЛИТЕЛЬНЫЙ ПУНКТ", AddressItemType.HOUSE, AddressHouseType.SPECIAL, "ЦРП", True, True)
    ...
    def try_parse_pure_item(t : 'Token', prev : 'AddressItemToken'=None, ad : 'GeoAnalyzerData'=None) -> 'AddressItemToken':
        ...
        if ((prev is not None and (isinstance(t, NumberToken)) and t.length_char == 5) and t.typ == NumberSpellingType.DIGIT and not t.morph.class0_.is_adjective): 
            if (prev.typ == AddressItemType.COUNTRY or prev.typ == AddressItemType.REGION or prev.typ == AddressItemType.CITY): 
                return AddressItemToken._new201(AddressItemType.ZIP, t, t, str(t.value))
        if ((prev is not None and ((prev.typ == AddressItemType.HOUSE or prev.typ == AddressItemType.CORPUS or prev.typ == AddressItemType.BUILDING)) and t.is_value("БЛОК", None)) and (t.whitespaces_after_count < 3)): 
            ...
            if (nn is not None): 
                return AddressItemToken._new201(AddressItemType.BLOCK, t, nn.end_token, nn.value)
    ...
    def __try_parse_pure_item(t : 'Token', prefix_before : bool, prev : 'AddressItemToken') -> 'AddressItemToken':
        ...
        if (isinstance(t, NumberToken)): 
            ...
            if (((n.length_char == 6 or ((n.length_char == 5 and t.kit.base_language.is_ua)))) and n.typ == NumberSpellingType.DIGIT and not n.morph.class0_.is_adjective): 
                return AddressItemToken._new201(AddressItemType.ZIP, t, t, str(n.value))
            ...
            if (tok0 is not None and (isinstance(tok0.termin.tag, AddressItemType))): 
                ...
                if (tok0.end_token.next0_ is None or tok0.end_token.is_newline_after): 
                    ...
                    return AddressItemToken._new201(AddressItemType.HOUSE, t, t, n.value)
                if (t.previous is not None and t.previous.is_comma and tok0.length_char > 1): 
                    ...
                    if (tt is None or tt.is_comma or tok0.is_newline_after): 
                        return AddressItemToken._new201(typ0, t, tok0.end_token, n.value)
                if (typ0 == AddressItemType.FLAT): 
                    ...
                    if ((isinstance(tok0.end_token.next0_, NumberToken)) and (tok0.end_token.whitespaces_after_count < 3)): 
                        if (prev is not None and ((prev.typ == AddressItemType.STREET or prev.typ == AddressItemType.CITY))): 
                            return AddressItemToken._new201(AddressItemType.NUMBER, t, t, str(n.value))
                if (isinstance(tok0.end_token.next0_, NumberToken)): 
                    ...
                    if (next0__ is not None and next0__.typ == AddressItemType.NUMBER): 
                        ...
                        if (next0__ is not None and next0__.value is not None and next0__.value != "0"): 
                            ...
                            return AddressItemToken._new201(typ0, t, tok0.end_token, str(n.value))
        prepos = False
        tok = None
                    ...
                    if (num1 is not None): 
                        ...
                        while tt0 is not None: 
                            if (tt0.is_value("КВАРТАЛ", None) or tt0.is_value("КВ", None) or tt0.is_value("ЛЕСНИЧЕСТВО", None)): 
                                return AddressItemToken._new201(AddressItemType.PLOT, t, num1.end_token, num1.value)
        ...
        if ((((isinstance(t, TextToken)) and t.length_char == 1 and t.chars.is_letter) and not t.is_value("V", None) and not t.is_value("I", None)) and not t.is_value("X", None)): 
            if (t.previous is not None and t.previous.is_comma): 
                if (((t.next0_ is not None and t.next0_.is_comma and (isinstance(t.next0_.next0_, NumberToken))) and t.is_value("Д", None) and prev is not None) and prev.typ == AddressItemType.STREET): 
                    ...
                    return AddressItemToken._new115(AddressItemType.BUILDING, t, t, AddressBuildingType.LITER, t.term)
        if (BracketHelper.is_bracket(t, True)): 
            ...
            if ((br is not None and (isinstance(t.next0_, TextToken)) and t.next0_.length_char <= 2) and t.next0_.next0_ == br.end_token and t.next0_.length_char == 1): 
                return AddressItemToken._new115(AddressItemType.BUILDING, t, br.end_token, AddressBuildingType.LITER, t.next0_.term)
        if (t.is_char('/')): 
        ...
        if (tok is not None): 
            ...
            if (t.is_value("ЛИТЕРА", None)): 
                ...
                if (str.isupper(str0_[len(str0_) - 1]) and str.islower(str0_[len(str0_) - 2])): 
                    return AddressItemToken._new115(AddressItemType.BUILDING, t, t, AddressBuildingType.LITER, str0_[len(str0_) - 1:])
            ...
            if (tok.termin.canonic_text == "ТАМ ЖЕ"): 
                ...
                while True:
                    ...
                    if (isinstance(r, AddressReferent)): 
                        ...
                        if (g is not None): 
                            return AddressItemToken._new476(AddressItemType.CITY, t, tok.end_token, g)
                        break
            ...
            if (tok.termin.canonic_text == "НЕЖИЛОЕ"): 
                ...
                while True:
                    ...
                    if (t1.is_value("ВСТР", None) or t1.is_value("ВСТРОЕН", None) or t1.is_value("ВСТРОЕННЫЙ", None)): 
                        continue
                    if (t1.is_value("ЗДАНИЕ", None)): 
                        build = True
                        continue
                    if (build): 
                        if ((t1.is_comma or t1.is_value("В", None) or t1.is_value("ЧАСТЬ", None)) or t1.is_value("НЕЖИЛОЙ", None)): 
                            continue
                    ...
                    if (tok2.termin.canonic_text == "ПОМЕЩЕНИЕ"): 
                        ...
                        typ_ = AddressItemType.SPACE
                    break
            if (t.is_value("ЖИЛОЙ", None) and t.next0_ is not None and t.next0_.is_comma): 
                return None
            ...
            if (isinstance(tok.termin.tag, AddressItemType)): 
                ...
                if (typ_ == AddressItemType.FLOOR and (isinstance(tok.termin.tag3, str))): 
                    return AddressItemToken._new201(typ_, t, tok.end_token, Utils.asObjectOrNull(tok.termin.tag3, str))
                if (typ_ == AddressItemType.FLOOR and (isinstance(tok.end_token.next0_, TextToken))): 
                    if (tok.end_token.next0_.is_hiphen and not tok.end_token.next0_.is_whitespace_after and (isinstance(tok.end_token.next0_.next0_, NumberToken))): 
                        return AddressItemToken._new201(typ_, t, tok.end_token.next0_.next0_, "-" + tok.end_token.next0_.next0_.value)
                    if ((tok.end_token.next0_.length_char == 1 and tok.end_token.next0_.chars.is_all_upper and (isinstance(tok.end_token.next0_.next0_, NumberToken))) and not tok.end_token.next0_.is_whitespace_after): 
                        return AddressItemToken._new201(typ_, t, tok.end_token.next0_.next0_, tok.end_token.next0_.term + tok.end_token.next0_.next0_.value)
                if (typ_ == AddressItemType.HOUSE and house_typ == AddressHouseType.SPECIAL): 
                    ...
                    if (tt2 is not None and tt2.is_hiphen): 
                        tt2 = tt2.next0_
                    res = AddressItemToken._new481(typ_, t, tok.end_token, house_typ, Utils.ifNotNull(tok.termin.acronym, tok.termin.canonic_text))
                ...
                if (((typ_ == AddressItemType.FLAT or typ_ == AddressItemType.SPACE or typ_ == AddressItemType.OFFICE)) and not (isinstance(tok.end_token.next0_, NumberToken))): 
                    ...
                    if (tt2 is not None and tt2.is_char_of("\\/")): 
                        tt2 = tt2.next0_
                    next0__ = AddressItemToken.__try_parse_pure_item(tt2, False, None)
                    if (next0__ is not None and typ_ != AddressItemType.OFFICE and next0__.typ == AddressItemType.FLAT): 
                        next0__.begin_token = t
                        return next0__
                    if (next0__ is not None and typ_ == AddressItemType.FLAT and next0__.typ == AddressItemType.OFFICE): 
                        next0__.begin_token = t
                        return next0__
                    if (next0__ is not None and next0__.typ == AddressItemType.BUILDING and next0__.building_type == AddressBuildingType.LITER): 
                        return AddressItemToken._new201(typ_, t, next0__.end_token, next0__.value)
                    if (next0__ is not None and ((next0__.typ == AddressItemType.CORPUS or next0__.typ == AddressItemType.HOUSE)) and next0__.begin_token.length_char == 1): 
                        return AddressItemToken._new201(typ_, t, next0__.end_token, "{0}{1}".format(("К" if next0__.typ == AddressItemType.CORPUS else "Д"), next0__.value))
                ...
                if (typ_ == AddressItemType.SPACE and tok.termin.tag3 is not None): 
                    ...
                    if (tok.termin.tag2 is not None): 
                        ...
                        if (org1 is not None and org1.is_building): 
                            return AddressItemToken._new484(typ_, t, org1.end_token, space_detail, org1)
                if (typ_ == AddressItemType.SPACE): 
                    ...
                    if ((isinstance(tok.end_token.next0_, TextToken)) and tok.end_token.next0_.term == "ЗОИ"): 
                        return AddressItemToken._new486(typ_, t, tok.end_token.next0_, "3", "МОП")
                        ...
                        if (tok2 is not None and (isinstance(tok2.termin.tag, AddressItemType))): 
                            ...
                            if (typ2 != typ_ and ((typ2 == AddressItemType.PLOT or ((typ2 == AddressItemType.HOUSE and typ_ == AddressItemType.PLOT))))): 
                                if (t.begin_char > tt2.previous.begin_char): 
                                    return None
                                return AddressItemToken._new487(typ_, t, tt2.previous, "0", house_typ)
                ...
                if (typ_ == AddressItemType.FIELD): 
                    ...
                    if (nt2 is not None and ((nt2.ex_typ == NumberExType.METER2 or nt2.ex_typ == NumberExType.GEKTAR or nt2.ex_typ == NumberExType.AR))): 
                        return AddressItemToken._new201(typ_, t, nt2.end_token, str(nt2))
                ...
                if (typ_ == AddressItemType.NONUMBER): 
                    return AddressItemToken._new489(AddressItemType.NONUMBER, t, tok.end_token, "0", False)
                ...
                if (typ_ != AddressItemType.NUMBER): 
                    if (t1 is None or ((t1.is_comma and not (isinstance(t1.next0_, NumberToken)))) or ((tok.is_newline_after and not (isinstance(t1, NumberToken))))): 
                        if (((prev is not None or MiscLocationHelper.is_user_param_address(t))) and not tok.is_newline_before): 
                            return AddressItemToken._new490(typ_, t, tok.end_token, house_typ, build_typ, ("0" if space_detail is not None or typ_ == AddressItemType.PLOT else None), space_detail)
                if (typ_ == AddressItemType.PLOT or typ_ == AddressItemType.WELL): 
                    num1 = NumToken.try_parse(t1, GeoTokenType.HOUSE)
                    if (num1 is not None): 
                        return AddressItemToken._new201(typ_, t, num1.end_token, num1.value)
                if (typ_ == AddressItemType.PLOT): 
                    tt = t1
                    if (tt is not None): 
                    ...
                    if (tok1 is not None): 
                        if (isinstance(tok1.termin.tag, AddressItemType)): 
                            ...
                            if (ty1 == AddressItemType.HOUSE or ty1 == AddressItemType.BUILDING or ty1 == AddressItemType.CORPUS): 
                                if (tt.previous.begin_char < t.begin_char): 
                                    return None
                                return AddressItemToken._new201(typ_, t, tt.previous, "0")
                if (typ_ == AddressItemType.NUMBER): 
        ...
        if (tok is not None and (isinstance(tok.termin.tag, AddressItemType)) and (Utils.valToEnum(tok.termin.tag, AddressItemType)) == AddressItemType.NUMBER): 
            ...
            re0 = AddressItemToken._new493(typ_, t, tok.end_token, "0", house_typ, build_typ)
        ...
        if (t1 is None): 
            if (typ_ == AddressItemType.GENPLAN): 
                return AddressItemToken._new201(typ_, t, tok00.end_token, "0")
            return None
        ...
        if (nt is not None): 
            if (typ_ == AddressItemType.ROOM or typ_ == AddressItemType.CORPUSORFLAT): 
                ...
                if (nt2 is not None and nt2.ex_typ == NumberExType.METER2): 
                    return AddressItemToken._new201(AddressItemType.ROOM, t, nt2.end_token, str(nt2))
            ...
            if ((re11) is not None): 
                ...
                if ((src is not None and len(src) == 2 and ((src[0] == 'к' or src[0] == 'k'))) and str.isupper(src[1])): 
                    ...
                    if (ch != (chr(0))): 
                        return AddressItemToken._new201(AddressItemType.CORPUS, t1, t1, "{0}".format(ch))
            elif ((isinstance(t1, TextToken)) and t1.length_char == 1 and t1.is_letters): 
                if (t.is_value("САРАЙ", None)): 
                    return None
                ch = AddressItemToken.__correct_char_token(t1)
                if (ch == "З" and build_typ != AddressBuildingType.LITER): 
                    ch = "3"
                if (ch is not None): 
                    if (typ_ == AddressItemType.NUMBER): 
                        return None
                    ...
                    if (ch == "С" and t1.is_whitespace_after): 
                        ...
                        if (next0__ is not None and next0__.typ == AddressItemType.NUMBER): 
                            res1 = AddressItemToken._new499(typ_, t, next0__.end_token, next0__.value, t.morph, house_typ, build_typ)
                            return res1
                        ...
                        if (t1.chars.is_all_lower and ((t1.morph.class0_.is_preposition or t1.morph.class0_.is_conjunction))): 
                            if ((t1.whitespaces_after_count < 2) and t1.next0_.chars.is_letter): 
                                if (typ_ == AddressItemType.HOUSE or typ_ == AddressItemType.PLOT or typ_ == AddressItemType.BOX): 
                                    return AddressItemToken._new201(typ_, t, t1.previous, "0")
                                return None
                        if ((t.chars.is_all_upper and t.length_char == 1 and t.next0_.is_char('.')) and ch != "3"): 
                            return None
                    print(ch, end="", file=num)
                ...
                if ((((typ_ == AddressItemType.BOX or typ_ == AddressItemType.SPACE or typ_ == AddressItemType.PART) or typ_ == AddressItemType.CARPLACE or typ_ == AddressItemType.WELL)) and num.tell() == 0): 
                    ...
                    if (rom is not None): 
                        return AddressItemToken._new201(typ_, t, rom.end_token, str(rom.value))
                ...
                if (t1.is_value("БН", None)): 
                    ...
                    val = "НЕТ"
                return AddressItemToken._new201(typ_, t, t1, val)
            else: 
                ...
                if ((isinstance(t1, TextToken)) and ((typ_ == AddressItemType.HOUSE or typ_ == AddressItemType.BUILDING or typ_ == AddressItemType.CORPUS))): 
                    ...
                    if (ter == "АБ" or ter == "АБВ" or ter == "МГУ"): 
                        return AddressItemToken._new493(typ_, t, t1, ter, house_typ, build_typ)
                    ccc = AddressItemToken.__corr_number(ter)
                    if (ccc is not None): 
                        return AddressItemToken._new493(typ_, t, t1, ccc, house_typ, build_typ)
                ...
                if (typ_ == AddressItemType.PLOT and t1 is not None): 
                    if ((t1.is_value("ОКОЛО", None) or t1.is_value("РЯДОМ", None) or t1.is_value("НАПРОТИВ", None)) or t1.is_value("БЛИЗЬКО", None) or t1.is_value("НАВПАКИ", None)): 
                        return AddressItemToken._new201(typ_, t, t1, t1.get_source_text().lower())
                    det = AddressItemToken.__try_attach_detail(t1, None)
                    if (det is not None): 
                        if (t1.previous is None or (t1.previous.begin_char < t.begin_char)): 
                            return None
                        return AddressItemToken._new201(typ_, t, t1.previous, "0")
                if (((typ_ != AddressItemType.NUMBER and (isinstance(t1, TextToken)) and t1.length_char <= 2) and t1.chars.is_all_upper and t1.chars.is_letter) and ((not t1.is_whitespace_after or typ_ == AddressItemType.PLOT or typ_ == AddressItemType.BOX)) and (isinstance(t1.next0_, NumberToken))): 
                    num1 = NumToken.try_parse(t1.next0_, GeoTokenType.ANY)
                    if (num1 is not None): 
                        return AddressItemToken._new201(typ_, t, num1.end_token, t1.term + num1.value)
                ...
                if (MiscLocationHelper.is_user_param_address(t1) or typ_ != AddressItemType.NUMBER): 
                    ...
                    if (nt1 is not None): 
                        return AddressItemToken._new201(typ_, t, t1, nt1.value)
                ...
                if (typ_ == AddressItemType.NUMBER and t.is_value("ОБЩЕЖИТИЕ", None)): 
                    ...
                    if (num1 is not None): 
                        return AddressItemToken._new201(AddressItemType.HOUSE, t, num1.end_token, num1.value)
                if (t.chars.is_latin_letter and not t.kit.base_language.is_en): 
                    num2 = NumberHelper.try_parse_roman(t)
                    if (num2 is not None): 
                        return AddressItemToken._new201(typ_, t, num2.end_token, num2.value)
                return None
        ...
        if (num.tell() == 0): 
            if (t1 is not None and t1.chars.is_latin_letter and ((not t1.kit.base_language.is_en or MiscLocationHelper.is_user_param_address(t)))): 
                ...
                if (num2 is not None): 
                    return AddressItemToken._new201(typ_, t, num2.end_token, num2.value)
            return None
        res0 = AddressItemToken._new518(typ_, t, t1, Utils.toStringStringIO(num), t.morph, house_typ, build_typ, space_detail)
        t1 = t1.next0_
        if (t1 is not None and t1.is_comma): 
            t1 = t1.next0_
        ...
        if ((typ_ == AddressItemType.NUMBER and t1 is not None and (t1.whitespaces_before_count < 3)) and t1.is_whitespace_before): 
            tok2 = AddressItemToken.__m_ontology.try_parse(t1, TerminParseAttr.NO)
            if (tok2 is not None and not t1.previous.is_comma): 
                next0__ = AddressItemToken.__try_parse_pure_item(t1, False, None)
        ...
        if ((((res0.typ == AddressItemType.SPACE or res0.typ == AddressItemType.FLAT or res0.typ == AddressItemType.OFFICE) or res0.typ == AddressItemType.ROOM or ((res0.typ == AddressItemType.NUMBER and has_num_prefix)))) and res0.value is not None): 
            n0 = 0
            wrapn0520 = RefOutArgWrapper(0)
            Utils.tryParseInt(Utils.ifNotNull(res0.value, ""), wrapn0520)
            n0 = wrapn0520.value
            ...
            while tt is not None: 
                ...
                if (tok2 is not None): 
                    break
                n = 0
                wrapn519 = RefOutArgWrapper(0)
                Utils.tryParseInt(nn.value, wrapn519)
                n = wrapn519.value
                if (tt.is_hiphen): 
    ...
    def __try_attachvch(t : 'Token', ty : 'AddressItemType') -> 'AddressItemToken':
        ...
        if ((((tt.is_value("В", None) or tt.is_value("B", None))) and tt.next0_ is not None and tt.next0_.is_char_of("./\\")) and (isinstance(tt.next0_.next0_, TextToken)) and tt.next0_.next0_.is_value("Ч", None)): 
            ...
            if (tt.next0_ is not None and (isinstance(tt.next0_, NumberToken)) and (tt.whitespaces_after_count < 2)): 
                tt = tt.next0_
            return AddressItemToken._new201(ty, t, tt, "В/Ч")
    ...
    def __try_attach_detail_range(t : 'Token') -> 'AddressItemToken':
        ...
        if (t1.next0_ is None or not t1.next0_.is_char('+') or not (isinstance(t1.next0_.next0_, NumberToken))): 
            return None
        res = AddressItemToken._new525(AddressItemType.DETAIL, t, t1.next0_.next0_, AddressDetailType.RANGE)
        ...
        if (tok is None): 
            ...
            if (isinstance(tt, NumberToken)): 
                ...
                if (nex is not None and ((nex.ex_typ == NumberExType.METER or nex.ex_typ == NumberExType.KILOMETER))): 
                    ...
                    wraptyy526 = RefOutArgWrapper(tyy)
                    res.detail_meters = (math.floor(nex.normalize_value(wraptyy526)))
                    tyy = wraptyy526.value
            ...
            if (t.is_value("У", None)): 
                if (t.next0_ is None or t.next0_.is_char_of(",.;")): 
                    return None
            res = AddressItemToken._new525(AddressItemType.DETAIL, t, tok.end_token, Utils.valToEnum(tok.termin.tag, AddressDetailType))
        tt = res.end_token.next0_
        first_pass3340 = True
        while True:
            ...
            if ((isinstance(tt, NumberToken)) and tt.next0_ is not None): 
                ...
                if (nex is not None and ((nex.ex_typ == NumberExType.METER or nex.ex_typ == NumberExType.KILOMETER))): 
                    ...
                    res.end_token = tt
                    tyy = NumberExType.METER
                    wraptyy528 = RefOutArgWrapper(tyy)
                    res.detail_meters = (math.floor(nex.normalize_value(wraptyy528)))
                    tyy = wraptyy528.value
                    continue
            break
    ...
    def __try_parse_list_int(t : 'Token', max_count : int=20) -> typing.List['AddressItemToken']:
        ...
        while True:
            ...
            if (len(res) > 1): 
                if (last.is_newline_before and res[len(res) - 2].typ != AddressItemType.PREFIX): 
                    ...
                    first_pass3342 = True
                    while True:
                        if first_pass3342: first_pass3342 = False
                        else: i += 1
            ...
            if (t.is_char_of("\\/")): 
                ...
                if (last.typ == AddressItemType.STREET and last.is_doubt): 
                    break
                it = AddressItemToken._new525(AddressItemType.DETAIL, t, t, AddressDetailType.CROSS)
                res.append(it)
                continue
            ...
            if (it.typ == AddressItemType.KILOMETER or ((it.typ == AddressItemType.HOUSE and it.value is not None and ((len(res) == 1 or res[len(res) - 2].typ != AddressItemType.STREET))))): 
                if (not t.is_newline_before): 
                    pre = True
            if (t.is_value2("НЕ", "УКАЗАН") or t.is_value2("НЕ", "ЗАДАН")): 
                t = t.next0_
                continue
            it0 = AddressItemToken.try_parse(t, pre, it, None)
            if (it0 is None): 
                hous = False
                wraphous531 = RefOutArgWrapper(False)
                tt = AddressItemToken.goto_end_of_address(t.previous, wraphous531)
                hous = wraphous531.value
                if (tt is not None and tt.end_char >= t.end_char and tt.next0_ is not None): 
                    ...
                    if (it0 is None and hous and it.typ == AddressItemType.STREET): 
                        res.append(AddressItemToken._new201(AddressItemType.HOUSE, t, tt, "0"))
                if (it.typ == AddressItemType.CITY): 
                    sit = StreetItemToken.try_parse(t, None, False, None)
            ...
            if (it0 is None): 
                ...
                if (it.typ == AddressItemType.HOUSE or it.typ == AddressItemType.BUILDING or it.typ == AddressItemType.NUMBER): 
                    if ((not t.is_whitespace_before and t.length_char == 1 and t.chars.is_letter) and not t.is_whitespace_after and (isinstance(t.next0_, NumberToken))): 
                        ...
                        if (ch == "К" or ch == "С"): 
                            it0 = AddressItemToken._new201((AddressItemType.CORPUS if ch == "К" else AddressItemType.BUILDING), t, t.next0_, str(t.next0_.value))
                            it = it0
                            res.append(it)
                            t = it.end_token
                            tt = t.next0_
                            if (((tt is not None and not tt.is_whitespace_before and tt.length_char == 1) and tt.chars.is_letter and not tt.is_whitespace_after) and (isinstance(tt.next0_, NumberToken))): 
                                ...
                                if (ch == "К" or ch == "С"): 
                                    it = AddressItemToken._new201((AddressItemType.CORPUS if ch == "К" else AddressItemType.BUILDING), tt, tt.next0_, str(tt.next0_.value))
                                    res.append(it)
                                    t = it.end_token
                            continue
                if (t.morph.class0_.is_preposition): 
        ...
        if (len(res) > 0): 
            ...
            if (it.typ == AddressItemType.NUMBER or it.typ == AddressItemType.ZIP): 
                del0_ = False
                if (it.begin_token.previous is not None and it.begin_token.previous.morph.class0_.is_preposition): 
                    if (len(res) > 1 and res[len(res) - 2].end_token.next0_ == it.begin_token): 
                        pass
                    else: 
                        del0_ = True
        ...
        first_pass3343 = True
        while True:
            if first_pass3343: first_pass3343 = False
            else: i += 1
            if (not (i < (len(res) - 1))): break
        ...
        first_pass3344 = True
        while True:
            if first_pass3344: first_pass3344 = False
            else: i += 1
            if (not (i < (len(res) - 1))): break
    ...
    def try_parse(t : 'Token', prefix_before : bool=False, prev : 'AddressItemToken'=None, ad : 'GeoAnalyzerData'=None) -> 'AddressItemToken':
        ...
        if ((res is None and t.is_value("З", None) and (isinstance(t.next0_, NumberToken))) and prev is not None and prev.typ == AddressItemType.STREET): 
            ...
            if (num is not None and num.typ == AddressItemType.NUMBER): 
                res = AddressItemToken._new201(AddressItemType.HOUSE, t, num.end_token, num.value)
    ...
    def __try_parse(t : 'Token', prefix_before : bool, prev : 'AddressItemToken', ad : 'GeoAnalyzerData') -> 'AddressItemToken':
        ...
        if (isinstance(t, ReferentToken)): 
            ...
            if (geo is not None): 
                ...
                res = AddressItemToken._new476(ty, t, t, rt.referent)
        ...
        if (sli is not None): 
            ...
            if (rt is None and sli[0].typ != StreetItemType.FIX): 
                ...
                if (org0_ is not None and not org0_.is_building): 
                    si = StreetItemToken._new536(t, org0_.end_token, StreetItemType.FIX, org0_)
                    sli.clear()
                    sli.append(si)
                    ...
                    if (org0_ is not None): 
                        ...
                        sli.append(si)
                        rt = StreetDefineHelper._try_parse_street(sli, prefix_before or prev is not None, False, False, None)
                        if (rt is not None and (isinstance(rt.referent, StreetReferent))): 
                        ...
                        if (st1 is not None and st1.end_char == rt0.end_char): 
                            ...
                            if (rt is not None): 
                                rt.end_token = rt0
            if ((rt is None and prev is not None and ((prev.typ == AddressItemType.CITY or prev.typ == AddressItemType.REGION))) and MiscLocationHelper.is_user_param_address(sli[0])): 
                if (len(sli) == 1 and not sli[0].is_newline_before and (((sli[0].typ == StreetItemType.NAME or sli[0].typ == StreetItemType.STDNAME or sli[0].typ == StreetItemType.STDADJECTIVE) or ((sli[0].typ == StreetItemType.NUMBER and sli[0].begin_token.morph.class0_.is_adjective))))): 
            ...
            if ((len(sli) == 1 and sli[0].typ == StreetItemType.NAME and prev is not None) and prev.typ == AddressItemType.CITY and MiscLocationHelper.is_user_param_address(sli[0])): 
                ...
                if (AddressItemToken.check_street_after(tt3, False)): 
                    ...
                    return AddressItemToken._new538(AddressItemType.REGION, sli[0].begin_token, sli[0].end_token, rr, ReferentToken(rr, sli[0].begin_token, sli[0].end_token))
        ...
        if ((t.length_char == 1 and t.chars.is_letter and prev is not None) and prev.typ == AddressItemType.CITY and MiscLocationHelper.is_user_param_address(t)): 
            ...
            if ((isinstance(tt, NumberToken)) and ch is not None): 
                ...
                return AddressItemToken._new538(AddressItemType.STREET, t, tt, micr, ReferentToken(micr, t, tt))
        return None
    ...
    def _prepare_all_data(t0 : 'Token') -> None:
        ...
        while t is not None: 
            ...
            first_pass3351 = True
            while True:
                if first_pass3351: first_pass3351 = False
    ...
    def create_address(txt : str) -> 'ReferentToken':
        ...
        ar = None
        try: 
            ar = ProcessorService.get_empty_processor().process(SourceOfAnalysis._new129(txt, "ADDRESS"), None, None)
    ...
    @staticmethod
    def _new115(_arg1 : 'AddressItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : 'AddressBuildingType', _arg5 : str) -> 'AddressItemToken':
    ...
    @staticmethod
    def _new201(_arg1 : 'AddressItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : str) -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
        res.value = _arg4
        return res
    
    @staticmethod
    def _new476(_arg1 : 'AddressItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : 'Referent') -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
        res.referent = _arg4
        return res
    
    @staticmethod
    def _new481(_arg1 : 'AddressItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : 'AddressHouseType', _arg5 : str) -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
    ...
    @staticmethod
    def _new484(_arg1 : 'AddressItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : str, _arg5 : 'ReferentToken') -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
    ...
    @staticmethod
    def _new486(_arg1 : 'AddressItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : str, _arg5 : str) -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
        res.value = _arg4
    ...
    @staticmethod
    def _new487(_arg1 : 'AddressItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : str, _arg5 : 'AddressHouseType') -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
        res.value = _arg4
    ...
    @staticmethod
    def _new489(_arg1 : 'AddressItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : str, _arg5 : bool) -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
        res.value = _arg4
        res.is_doubt = _arg5
        return res
    ...
    @staticmethod
    def _new490(_arg1 : 'AddressItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : 'AddressHouseType', _arg5 : 'AddressBuildingType', _arg6 : str, _arg7 : str) -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
        res.house_type = _arg4
    ...
    @staticmethod
    def _new493(_arg1 : 'AddressItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : str, _arg5 : 'AddressHouseType', _arg6 : 'AddressBuildingType') -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
        res.value = _arg4
        res.house_type = _arg5
    ...
    @staticmethod
    def _new499(_arg1 : 'AddressItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : str, _arg5 : 'MorphCollection', _arg6 : 'AddressHouseType', _arg7 : 'AddressBuildingType') -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
        res.value = _arg4
        res.morph = _arg5
    ...
    @staticmethod
    def _new518(_arg1 : 'AddressItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : str, _arg5 : 'MorphCollection', _arg6 : 'AddressHouseType', _arg7 : 'AddressBuildingType', _arg8 : str) -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
        res.value = _arg4
        res.morph = _arg5
        res.house_type = _arg6
    ...
    @staticmethod
    def _new525(_arg1 : 'AddressItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : 'AddressDetailType') -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
        res.detail_type = _arg4
        return res
    
    @staticmethod
    def _new538(_arg1 : 'AddressItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : 'Referent', _arg5 : 'ReferentToken') -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
        res.referent = _arg4
        res.ref_token = _arg5
        return res
    ...
    @staticmethod
    def _new543(_arg1 : 'AddressItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : 'Referent', _arg5 : bool) -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
        res.referent = _arg4
        res.is_doubt = _arg5
        return res
    ...
    @staticmethod
    def _new563(_arg1 : 'AddressItemType', _arg2 : 'Token', _arg3 : 'Token', _arg4 : 'ReferentToken', _arg5 : 'AddressDetailType') -> 'AddressItemToken':
        res = AddressItemToken(_arg1, _arg2, _arg3)
        res.ref_token = _arg4
