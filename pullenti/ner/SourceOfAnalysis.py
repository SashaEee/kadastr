...
class SourceOfAnalysis:
    ...
    @property
    def styles(self) -> bytearray:
        """ Это если есть информация о стилях символов, то можно её закодировать здесь.
        Styles.Length = Text.Length.  Бит 0 - bold, бит 1 - italic.
        Пока используется только при анализе структуры НПА """
        return self.__styles
    @styles.setter
    def styles(self, value) -> bytearray:
        self.__styles = value
        return self.__styles
    ...
    @staticmethod
    def _new111(_arg1 : str, _arg2 : typing.List[tuple], _arg3 : bool, _arg4 : str) -> 'SourceOfAnalysis':
        res = SourceOfAnalysis(_arg1)
        res.correction_dict = _arg2
        res.do_word_correction_by_morph = _arg3
        res.user_params = _arg4
        return res
    
    @staticmethod
    def _new129(_arg1 : str, _arg2 : str) -> 'SourceOfAnalysis':
        res = SourceOfAnalysis(_arg1)
        res.user_params = _arg2
        return res
    
    @staticmethod
    def _new927(_arg1 : str, _arg2 : bool) -> 'SourceOfAnalysis':
        res = SourceOfAnalysis(_arg1)
