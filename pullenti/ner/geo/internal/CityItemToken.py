...
class CityItemToken(MetaToken):
    ...
    def initialize() -> None:
        ...
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1308("ГОРОД-ГЕРОЙ", "ГОРОД")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1330("МІСТО-ГЕРОЙ", MorphLang.UA, "МІСТО")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1308("ГОРОД-КУРОРТ", "ГОРОД")
        t.add_abridge("Г.К.")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1330("МІСТО-КУРОРТ", MorphLang.UA, "МІСТО")
        t.add_abridge("М.К.")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin("СЕЛО")
        ...
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin("АГРОГОРОДОК")
        t.tag = CityItemToken.ItemType.NOUN
        t.add_variant("АГРО ГОРОДОК", False)
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin("ПОСЕЛОК")
        t.add_abridge("ПОС.")
        t.tag = CityItemToken.ItemType.NOUN
        ...
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1333("ГОРОДСКОЕ ПОСЕЛЕНИЕ", "ГП", True)
        t.add_abridge("Г.П.")
        t.tag = CityItemToken.ItemType.NOUN
        t.add_abridge("Г.ПОС.")
        t.add_abridge("ГОР.П.")
        ...
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new406("ПОСЕЛКОВОЕ ПОСЕЛЕНИЕ", "ПОСЕЛОК", CityItemToken.ItemType.NOUN)
        CityItemToken.M_ONTOLOGY.add(t)
        ...
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1308("СТОЛИЦА", "ГОРОД")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1330("СТОЛИЦЯ", MorphLang.UA, "МІСТО")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin("СТАНЦИЯ")
        t.add_abridge("СТАНЦ.")
        ...
        t.tag = CityItemToken.ItemType.NOUN
        t.add_abridge("Ж/Д СТАНЦИЯ")
        t.add_abridge("Ж/Д СТ.")
        t.add_abridge("Ж/Д СТАНЦ.")
        CityItemToken.M_ONTOLOGY.add(t)
        ...
        t.add_abridge("Б.Н.П.")
        t.add_abridge("НП")
        CityItemToken.M_NASEL_PUNKT = t
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin("НАСЕЛЕНИЙ ПУНКТ", MorphLang.UA)
        t.tag = CityItemToken.ItemType.NOUN
        t.add_abridge("НП")
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1308("РАЙОННЫЙ ЦЕНТР", "НАСЕЛЕННЫЙ ПУНКТ")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1330("РАЙОННИЙ ЦЕНТР", MorphLang.UA, "НАСЕЛЕНИЙ ПУНКТ")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1308("ОБЛАСТНОЙ ЦЕНТР", "НАСЕЛЕННЫЙ ПУНКТ")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin._new1330("ОБЛАСНИЙ ЦЕНТР", MorphLang.UA, "НАСЕЛЕНИЙ ПУНКТ")
        t.tag = CityItemToken.ItemType.NOUN
        CityItemToken.M_ONTOLOGY.add(t)
        t = Termin("ПОЧИНОК")
        t.tag = CityItemToken.ItemType.NOUN
        ...
        CityItemToken.M_ONTOLOGY.add(t)
        for s in ["ЖИТЕЛЬ", "МЭР"]: 
            CityItemToken.M_ONTOLOGY.add(Termin._new124(s, CityItemToken.ItemType.MISC))
        for s in ["ЖИТЕЛЬ", "МЕР"]: 
            CityItemToken.M_ONTOLOGY.add(Termin._new816(s, MorphLang.UA, CityItemToken.ItemType.MISC))
        t = Termin._new124("АДМИНИСТРАЦИЯ", CityItemToken.ItemType.MISC)
        t.add_abridge("АДМ.")
        CityItemToken.M_ONTOLOGY.add(t)
    ...
    def __load_big_city(xml0_ : xml.etree.ElementTree.Element) -> None:
        ...
        if (not Utils.isNullOrEmpty(adj)): 
            ...
            if (spb): 
                city_adj.add(Termin._new816(adj[6:], lang, ci))
    ...
    def check_keyword_before(last : 'Token') -> 'MetaToken':
        ...
        while True:
            ...
            res = CityItemToken.check_keyword(tt)
            if (res is None): 
                continue
    ...
    def try_parse_list(t : 'Token', max_count : int, ad : 'GeoAnalyzerData'=None) -> typing.List['CityItemToken']:
            ...
            if (ci0 is None): 
                ...
                if (ci.typ == CityItemToken.ItemType.NOUN and BracketHelper.can_be_start_of_sequence(t, True, False)): 
                    ...
                    if ((br is not None and (br.length_char < 50) and t.next0_.chars.is_cyrillic_letter) and not t.next0_.chars.is_all_lower): 
                        ci0 = CityItemToken._new1346(br.begin_token, br.end_token, CityItemToken.ItemType.PROPERNAME)
        ...
        if ((len(li) >= 2 and li[0].typ == CityItemToken.ItemType.PROPERNAME and li[1].typ == CityItemToken.ItemType.NOUN) and li[1].doubtful): 
            pass
        return li
    ...
    def __init__(self, begin : 'Token', end : 'Token') -> None:
        ...
        self.__m_geo_object_after = False
    ...
    @property
    def geo_object_after(self) -> bool:
        return self.__m_geo_object_after
    @geo_object_after.setter
    def geo_object_after(self, value_) -> bool:
        self.__m_geo_object_after = value_
        return value_
    ...
    def try_parse(t : 'Token', prev : 'CityItemToken'=None, dont_normalize : bool=False, ad : 'GeoAnalyzerData'=None) -> 'CityItemToken':
        ...
        if (t.is_value("НП", None)): 
            res0 = CityItemToken._new1347(t, t, CityItemToken.ItemType.NOUN, "населенный пункт", True)
            ...
            if (ttt is not None): 
                ...
                if (ok): 
                    ...
                    if (next0__ is not None and next0__.typ == CityItemToken.ItemType.PROPERNAME): 
                        return CityItemToken._new1348(t, ttt.end_token, CityItemToken.ItemType.NOUN, "участок")
        ...
        if (((res is not None and res.typ == CityItemToken.ItemType.PROPERNAME and res.value is not None) and not res.doubtful and res.begin_token == res.end_token) and len(res.value) > 4): 
            if (LanguageHelper.ends_with_ex(res.value, "ГРАД", "ГОРОД", None, None)): 
                if (res.alt_value is not None and res.alt_value.endswith("А")): 
                    pass
                else: 
                    res.alt_value = (None)
        ...
        if (res is not None and ((res.typ == CityItemToken.ItemType.CITY or res.typ == CityItemToken.ItemType.PROPERNAME)) and MiscLocationHelper.is_user_param_address(res)): 
            ...
            if (tt is not None and tt.is_hiphen and (isinstance(tt.next0_, NumberToken))): 
                ...
                nt = None
                if (tt is not None and tt.is_hiphen): 
                    nt = NumberHelper.try_parse_roman(tt.next0_)
                elif ((res.whitespaces_after_count < 3) and tt is not None and tt.chars.is_latin_letter): 
                    nt = NumberHelper.try_parse_roman(tt)
                if (nt is not None): 
                    res.end_token = nt.end_token
                    res.value = "{0}-{1}".format((res.onto_item.canonic_text if res.onto_item is not None else res.value), nt.value)
                    res.typ = CityItemToken.ItemType.PROPERNAME
                    res.onto_item = (None)
        return res
    ...
    def __try_parse_int(t : 'Token', prev : 'CityItemToken', dont_normalize : bool, ad : 'GeoAnalyzerData') -> 'CityItemToken':
            ...
            if (res is None): 
                ...
                if (det is not None): 
                    ...
                    while ttt is not None and ttt.end_char <= det.end_char: 
                        ...
                        ttt = ttt.next0_
                    if (cou < 6): 
                        re = CityItemToken._new1346(det.begin_token, det.end_token, CityItemToken.ItemType.PROPERNAME)
        ...
        if (res is None): 
            ...
            if (isinstance(t, TextToken)): 
                ...
                if (txt == "ИМ" or txt == "ИМЕНИ"): 
                    ...
                    if (t1 is None): 
                        return None
                    nnn = CityItemToken._new1346(t1, t1, CityItemToken.ItemType.NOUN)
            ...
            if (ooo): 
                ...
                if (isinstance(tt, TextToken)): 
                    dd = Utils.asObjectOrNull(tt.tag, GeoTokenData)
                    if (dd is not None and dd.no_city): 
                        return None
                    ...
                    if (((txt == "Д" or txt == "С" or txt == "C") or txt == "П" or txt == "Х") or ((((txt == "А" or txt == "У")) and MiscLocationHelper.is_user_param_address(tt)))): 
                        if (tt.chars.is_all_lower or MiscLocationHelper.is_user_param_address(tt) or ((tt.next0_ is not None and tt.next0_.is_char_of(".,")))): 
                            ...
                            if (txt == "А" or txt == "С"): 
                                ...
                                if (ait is not None): 
                                    return None
                                st = StreetItemToken.try_parse(tt, None, False, None)
                                if (st is not None and st.typ == StreetItemType.NOUN): 
                                    return None
                                if (tt.next0_ is not None): 
                                    if (tt.next0_.is_value("ЗАКОН", None) or tt.next0_.is_value("ПОСТАНОВЛЕНИЕ", None)): 
                                        return None
                            if (txt == "У"): 
                            ...
                            if (tokn is not None): 
                                return CityItemToken._new1348(tt, tokn.end_token, CityItemToken.ItemType.PROPERNAME, tokn.termin.canonic_text)
                            tt1 = tt
                            ...
                            if ((txt == "Д" and (isinstance(tt2, NumberToken)) and not tt2.is_newline_before) and not tt2.previous.is_comma): 
                                ...
                                if (tt.chars.is_all_upper): 
                                    ...
                                    if (rtt is not None): 
                                        ...
                                        if (AddressItemToken.check_house_after(ttt2, False, False) or AddressItemToken.check_street_after(ttt2, False)): 
                                            ...
                                            tli = TerrItemToken.try_parse_list(ttt2, 3, None)
                                            if (tli is not None and len(tli) == 2): 
                                                if (tli[0].termin_item is not None or tli[1].termin_item is not None): 
                                                    ok = True
                                ...
                                if (not ok and tt1.next0_ is not None): 
                                    ...
                                    if (MiscLocationHelper.is_user_param_address(tt)): 
                                        noun = CityItemToken._new1348(tt, tt, CityItemToken.ItemType.NOUN, "СЕЛО")
                            ...
                            if (ok): 
                                res = CityItemToken._new1346(tt0, tt1, CityItemToken.ItemType.NOUN)
                                if (tt1.is_comma): 
                    ...
                    if ((txt == "СП" or txt == "РП" or txt == "ГП") or txt == "ДП"): 
                        ...
                        if (tt.next0_ is not None and tt.next0_.chars.is_capital_upper): 
                            return CityItemToken._new1355(tt0, tt, CityItemToken.ItemType.NOUN, True, Condition._new1354(t), ("РАБОЧИЙ ПОСЕЛОК" if txt == "РП" else (("ГОРОДСКОЕ ПОСЕЛЕНИЕ" if txt == "ГП" else (("ДАЧНЫЙ ПОСЕЛОК" if txt == "ДП" else "СЕЛЬСКОЕ ПОСЕЛЕНИЕ"))))))
                    ...
                    if (tt.chars.is_all_upper and tt.length_char > 2 and tt.chars.is_cyrillic_letter): 
                        return CityItemToken._new1348(tt, tt, CityItemToken.ItemType.PROPERNAME, tt.term)
            if ((isinstance(t, NumberToken)) and t.next0_ is not None): 
                ...
                if (net is not None and net.ex_typ == NumberExType.KILOMETER): 
                    return CityItemToken._new1348(t, net.end_token, CityItemToken.ItemType.PROPERNAME, "{0}КМ".format(math.floor(net.real_value)))
            ...
            if ((rt is not None and (isinstance(rt.referent, GeoReferent)) and rt.begin_token == rt.end_token) and rt.referent.is_state): 
                ...
                if (t.previous.morph.number == MorphNumber.SINGULAR and t.morph.case_.is_nominative and not t.morph.case_.is_genitive): 
                    return CityItemToken._new1348(t, t, CityItemToken.ItemType.PROPERNAME, rt.get_source_text().upper())
            return None
        if (res.typ == CityItemToken.ItemType.NOUN): 
            ...
            if ((res.begin_token.length_char == 1 and res.begin_token.chars.is_all_upper and res.begin_token.next0_ is not None) and res.begin_token.next0_.is_char('.')): 
                ne = CityItemToken.__try_parse_int(res.begin_token.next0_.next0_, (res if res.value == "ГОРОД" else None), False, ad)
                if (ne is not None and ne.typ == CityItemToken.ItemType.CITY and ((not ne.doubtful or not res.doubtful or MiscLocationHelper.is_user_param_address(ne)))): 
                    pass
        ...
        if (res.typ == CityItemToken.ItemType.PROPERNAME or res.typ == CityItemToken.ItemType.CITY or res.can_be_name): 
            ...
            t1 = res.end_token
            num = None
            if ((not t1.is_whitespace_after and t1.next0_ is not None and t1.next0_.is_hiphen) and not t1.next0_.is_whitespace_after): 
                if ((isinstance(t1.next0_.next0_, NumberToken)) and t1.next0_.next0_.int_value is not None and (t1.next0_.next0_.int_value < 30)): 
                    num = (Utils.asObjectOrNull(t1.next0_.next0_, NumberToken))
                elif (isinstance(t1.next0_.next0_, TextToken)): 
                    num = NumberHelper.try_parse_roman(t1.next0_.next0_)
            if (num is not None): 
                res.end_token = (num.end_token if num.typ == NumberSpellingType.ROMAN else num)
                res.value = "{0}-{1}".format(val, num.value)
                if (res.alt_value is not None): 
                    res.alt_value = "{0}-{1}".format(res.alt_value, num.value)
                res.typ = CityItemToken.ItemType.PROPERNAME
                res.onto_item = (None)
    ...
    def __try_parse(t : 'Token', prev : 'CityItemToken', dont_normalize : bool, ad : 'GeoAnalyzerData') -> 'CityItemToken':
        ...
        if (not (isinstance(t, TextToken))): 
            if ((isinstance(t, ReferentToken)) and (isinstance(t.get_referent(), DateReferent))): 
                ...
                if (aii is not None): 
                    if (len(aii) > 1 and aii[0].typ == StreetItemType.NUMBER and aii[1].typ == StreetItemType.STDNAME): 
                        res2 = CityItemToken._new1346(t, aii[1].end_token, CityItemToken.ItemType.PROPERNAME)
            ...
            if ((isinstance(t, NumberToken)) and t.typ != NumberSpellingType.DIGIT and MiscLocationHelper.is_user_param_address(t)): 
                return CityItemToken._new1348(t, t, CityItemToken.ItemType.PROPERNAME, t.value)
            return None
        ...
        if (li is None): 
            ...
            if (stri is not None and stri.typ == StreetItemType.NOUN): 
                return None
        if ((li is None and (isinstance(t, TextToken)) and not t.term.endswith("О")) and ((t.next0_ is None or ((not t.next0_.is_hiphen and not t.next0_.is_value("ПОСАД", None)))))): 
            if (t.is_value("ИМ", None) or t.is_value("ИМЕНИ", None) or ((t.get_morph_class_in_dictionary().is_proper_name and MiscLocationHelper.is_user_param_address(t) and not t.is_value("ВЛАДИМИР", None)))): 
                nam = NameToken.try_parse(t, GeoTokenType.CITY, 0, False)
                if (nam is not None and nam.end_token != t): 
                    if (t.get_morph_class_in_dictionary().is_proper_name): 
                        ters = TerrItemToken.try_parse_list(t.next0_, 5, None)
                        if (ters is not None): 
                            ttt = TerrDefineHelper.try_define(ters, ad, False, None, None)
                            if (ttt is not None): 
                                nam = (None)
                    if (nam is not None): 
                        res1 = CityItemToken._new1348(t, nam.end_token, CityItemToken.ItemType.PROPERNAME, nam.name)
                        if (nam.misc_typ is not None): 
                            res1.misc = nam.misc_typ
                        return res1
        if (li is None and (isinstance(t, TextToken)) and t.is_value("КР", None)): 
            tt2 = t.next0_
            if (tt2 is not None and ((tt2.is_char('.') or tt2.is_hiphen))): 
                tt2 = tt2.next0_
            next0__ = CityItemToken.__try_parse_int(tt2, prev, dont_normalize, ad)
            if (next0__ is not None and next0__.typ == CityItemToken.ItemType.PROPERNAME): 
                next0__.begin_token = t
                next0__.value = ("КРАСНЫЙ " + next0__.value)
                return next0__
        if (li is not None and len(li) > 0): 
            if (isinstance(t, TextToken)): 
                ...
                for nt in li: 
                    if (nt.item is not None and nt.item.canonic_text == tt.term): 
                        if (MiscLocationHelper.is_user_param_address(nt) or not MiscHelper.is_all_characters_lower(nt.begin_token, nt.end_token, False)): 
                            ci = CityItemToken._new1362(nt.begin_token, nt.end_token, CityItemToken.ItemType.CITY, nt.item, nt.morph)
                ...
                if (li is not None): 
                    for nt in li: 
                        if (nt.item is not None): 
                            if (not MiscHelper.is_all_characters_lower(nt.begin_token, nt.end_token, False) or ((prev is not None and prev.typ == CityItemToken.ItemType.NOUN))): 
                                ci = CityItemToken._new1362(nt.begin_token, nt.end_token, CityItemToken.ItemType.CITY, nt.item, nt.morph)
            ...
            if (li is not None): 
                for nt in li: 
                    if (nt.item is None): 
                        ...
                        ci = CityItemToken._new1364(nt.begin_token, nt.end_token, ty, nt.morph)
                        ci.value = nt.termin.canonic_text
                        if (ci.value == "СТАНЦИЯ" and t.previous is not None): 
                            if (t.previous.is_value("НЕФТЕПЕРЕКАЧИВАЮЩАЯ", None)): 
                                return None
                        ...
                        if (ty == CityItemToken.ItemType.NOUN and not t.chars.is_all_lower): 
                            if (t.morph.class0_.is_proper_surname): 
                                ci.doubtful = True
                        if (t.is_value("ДЕР", None)): 
                            if (t.previous is not None and t.previous.is_value("ФОН", None)): 
                                return None
                        if ((prev is not None and prev.typ == CityItemToken.ItemType.NOUN and (isinstance(t, TextToken))) and t.is_value("СЕЛО", None) and not t.chars.is_all_lower): 
                            if (MiscLocationHelper.is_user_param_address(t)): 
                                return CityItemToken._new1348(t, t, CityItemToken.ItemType.PROPERNAME, t.term)
                            ...
                            if (nt.begin_token.is_value("Г", None)): 
                                ...
                                if (nt.is_newline_before): 
                                    ...
                                    if (not nt.begin_token.chars.is_all_lower and not MiscLocationHelper.is_user_param_address(nt)): 
                                        ok = False
                                        next0__ = CityItemToken.try_parse(nt.end_token.next0_, ci, False, None)
                                        if (next0__ is not None and next0__.typ == CityItemToken.ItemType.CITY): 
                                            if (nt.length_char == 1 and not nt.is_whitespace_before and (isinstance(t.previous, NumberToken))): 
                                                return None
                                            if (next0__.begin_token.get_morph_class_in_dictionary().is_proper_surname): 
                                                pass
                                            else: 
                                                ok = True
                                                ci.doubtful = False
                        ...
                        if (ci.end_token.next0_ is not None and ci.end_token.next0_.is_char('.')): 
                            if (ci.length_char < 3): 
                                ci.end_token = ci.end_token.next0_
                            elif (t.previous is not None and t.previous.is_comma and MiscLocationHelper.is_user_param_address(t)): 
                                ci.end_token = ci.end_token.next0_
                        return ci
        if (not (isinstance(t, TextToken))): 
            return None
        if (t.term == "СПБ" and not t.chars.is_all_lower and CityItemToken.M_ST_PETERBURG is not None): 
            return CityItemToken._new1366(t, t, CityItemToken.ItemType.CITY, CityItemToken.M_ST_PETERBURG, CityItemToken.M_ST_PETERBURG.canonic_text)
        if (t.term == "НЕТ"): 
            return None
        ...
        if (t.chars.is_all_lower): 
            ...
            if (ait is not None): 
                if (ait.typ == AddressItemType.DETAIL): 
                    return None
        if (MiscLocationHelper.check_territory(t) is not None): 
            return None
        ...
        t1 = t
        doubt = False
        if (t.morph.contains_attr("к.ф.", None)): 
            ptok = NameToken.M_PREF_ONTO.try_parse(t, TerminParseAttr.NO)
            if (ptok is not None): 
                tt = ptok.end_token.next0_
                if (tt is not None and tt.is_hiphen): 
                    tt = tt.next0_
                next0__ = CityItemToken.try_parse(tt, prev, dont_normalize, ad)
                if (next0__ is not None and ((next0__.typ == CityItemToken.ItemType.CITY or next0__.typ == CityItemToken.ItemType.PROPERNAME)) and next0__.begin_token == next0__.end_token): 
                    if (next0__.value is None): 
                        next0__.value = MiscHelper.get_text_value_of_meta_token(next0__, GetTextAttr.NO)
                    next0__.value = "{0}{1}".format(ptok.termin.canonic_text, next0__.value)
                    next0__.onto_item = (None)
                    next0__.begin_token = t
                    return next0__
        name = io.StringIO()
        altname = None
        ...
        while tt is not None: 
            ...
            if (tt.is_whitespace_after or tt.next0_.is_whitespace_after): 
                ...
                if (ttt is not None and not ttt.is_newline_after): 
                    if (ttt.chars.is_letter): 
                        break
            kw = CityItemToken.check_keyword(tt.next0_.next0_)
            if (kw is not None): 
                if (kw.is_newline_after or kw.end_token.next0_ is None or kw.end_token.next0_.is_comma): 
                    pass
                else: 
                    break
            tt = tt.next0_
        ...
        if (k > 0): 
            ...
            ii = 0
            while ii < name.tell(): 
                if (LanguageHelper.is_cyrillic_vowel(Utils.getCharAtStringIO(name, ii)) or LanguageHelper.is_latin_vowel(Utils.getCharAtStringIO(name, ii))): 
                    ww += 1
                else: 
                    nw += 1
                ii += 1
            if (nw == 0 or ww == 0): 
                return None
            reee = CityItemToken._new1347(t, t1, CityItemToken.ItemType.PROPERNAME, Utils.toStringStringIO(name), doubt)
            if (altname is not None): 
        ...
        if (npt is not None): 
            ...
            if (MiscLocationHelper.is_user_param_gar_address(npt)): 
                pass
            elif (mc.is_noun): 
        ...
        if (npt is not None): 
            ttt = npt.begin_token
            while ttt.end_char < npt.end_char: 
        ...
        if ((npt is not None and npt.end_token != t and len(npt.adjectives) > 0) and not npt.adjectives[0].end_token.next0_.is_comma): 
            ...
            if (cit is not None and cit.typ == CityItemToken.ItemType.NOUN and ((LanguageHelper.ends_with_ex(cit.value, "ПУНКТ", "ПОСЕЛЕНИЕ", "ПОСЕЛЕННЯ", "ПОСЕЛОК") or t.next0_.is_value("ГОРОДОК", None) or t.next0_.is_value("СЕЛО", None)))): 
                ...
                if (not mc.is_adjective): 
                    ...
                    ok2 = True
                if (ok2): 
                    return CityItemToken._new1368(t, t, CityItemToken.ItemType.CITY, t.get_normal_case_text(None, MorphNumber.UNDEFINED, MorphGender.UNDEFINED, False), npt.morph)
            check_ = True
                ...
                if (npt.end_token.is_value("КИЛОМЕТР", None)): 
                    ...
                    if (aid is not None): 
                        ...
                        if (rt1 is not None and rt1.end_token == npt.end_token): 
                            ...
                            ttt2 = npt.end_token.next0_
                            if (ttt2 is not None and ttt2.is_comma): 
                                ttt2 = ttt2.next0_
                            tli = TerrItemToken.try_parse_list(ttt2, 3, None)
                            if (tli is not None and len(tli) >= 2 and ((tli[0].termin_item is not None or tli[1].termin_item is not None))): 
                                pass
                            else: 
                                npt = (None)
                ...
                if (npt is not None): 
                    ...
                    if (npt1 is None or len(npt1.adjectives) == 0): 
                        ...
                        if ((si is None or si.typ != StreetItemType.NOUN or si.termin.canonic_text == "МОСТ") or si.termin.canonic_text == "ПАРК" or si.termin.canonic_text == "САД"): 
                            ...
                            return CityItemToken._new1369(t, t1, CityItemToken.ItemType.PROPERNAME, npt.get_normal_case_text(None, MorphNumber.UNDEFINED, MorphGender.UNDEFINED, False), doubt, npt.morph)
        if (t.next0_ is not None and t.next0_.chars.equals(t.chars) and not t.is_newline_after): 
            ...
            if (TerrItemToken.check_onto_item(t.next0_) is not None): 
                pass
            elif (CityItemToken.check_keyword(t.next0_) is not None): 
                pass
                ...
                if (not ok1 and t.get_morph_class_in_dictionary().is_proper_name and MiscLocationHelper.is_user_param_address(t)): 
                    ...
                    if (pp is not None and pp.end_token != t and (isinstance(pp.end_token, TextToken))): 
                        if (TerrItemToken.check_keyword(pp.end_token.next0_) is None): 
                            return CityItemToken._new1370(t, pp.end_token, CityItemToken.ItemType.PROPERNAME, pp.end_token.term, MiscHelper.get_text_value_of_meta_token(pp, GetTextAttr.NO), pp.morph)
                if (ok1): 
                    ...
                    if (tne is not None and tne.typ == CityItemToken.ItemType.NOUN): 
                        ...
                        t1 = t.next0_
                        return CityItemToken._new1371(t, t1, CityItemToken.ItemType.PROPERNAME, Utils.toStringStringIO(name), (None if altname is None else Utils.toStringStringIO(altname)), doubt, t.next0_.morph)
        if (t.length_char < 2): 
            return None
        ...
        if (StreetItemToken.check_keyword(t)): 
            if (AddressItemToken.check_street_after(t, False)): 
                if (prev is not None and prev.typ == CityItemToken.ItemType.NOUN and t.chars.is_capital_upper): 
                    ...
                    return None
        res = CityItemToken._new1371(t, t1, CityItemToken.ItemType.PROPERNAME, Utils.toStringStringIO(name), (None if altname is None else Utils.toStringStringIO(altname)), doubt, t.morph)
    ...
    def __try_parse_spec(t : 'Token') -> 'CityItemToken':
        ...
        if (org0_ is not None): 
            return CityItemToken._new1373(t, org0_.end_token, CityItemToken.ItemType.PROPERNAME, org0_)
        tok1 = CityItemToken.M_SPEC_NAMES.try_parse(t, TerminParseAttr.NO)
        if (tok1 is not None): 
            res = CityItemToken._new1348(t, tok1.end_token, CityItemToken.ItemType.PROPERNAME, tok1.termin.canonic_text)
            if ((t.length_char < len(res.value)) and (isinstance(t, TextToken)) and t == res.end_token): 
                res.alt_value = t.term
            return res
        ...
        if (tok1 is not None): 
            ...
            if (BracketHelper.can_be_start_of_sequence(tt, True, False)): 
                ...
                if (br is not None): 
                    res = CityItemToken._new1346(t, br.end_token, CityItemToken.ItemType.PROPERNAME)
                    res.value = MiscHelper.get_text_value_of_meta_token(br, GetTextAttr.NO)
            elif (tt is not None): 
                tmp = CityItemToken._new1348(tt.previous, tt.previous, CityItemToken.ItemType.NOUN, "ГОРОД")
        ...
        while True:
            ...
            if (only_noun): 
                ...
                if (vv is not None and vv.end_token == t): 
                    return CityItemToken._new1348(tt, t, CityItemToken.ItemType.NOUN, vv.termin.canonic_text)
            else: 
    ...
    @staticmethod
    def _new1346(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        return res
    
    @staticmethod
    def _new1347(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str, _arg5 : bool) -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.doubtful = _arg5
    ...
    @staticmethod
    def _new1348(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str) -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        return res
    ...
    @staticmethod
    def _new1355(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : bool, _arg5 : 'Condition', _arg6 : str) -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.doubtful = _arg4
        res._cond = _arg5
    ...
    @staticmethod
    def _new1362(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : 'IntOntologyItem', _arg5 : 'MorphCollection') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.onto_item = _arg4
        res.morph = _arg5
    ...
    @staticmethod
    def _new1364(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : 'MorphCollection') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.morph = _arg4
        return res
    ...
    @staticmethod
    def _new1366(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : 'IntOntologyItem', _arg5 : str) -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.onto_item = _arg4
        res.value = _arg5
    ...
    @staticmethod
    def _new1368(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str, _arg5 : 'MorphCollection') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.morph = _arg5
    ...
    @staticmethod
    def _new1369(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str, _arg5 : bool, _arg6 : 'MorphCollection') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.doubtful = _arg5
    ...
    @staticmethod
    def _new1370(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str, _arg5 : str, _arg6 : 'MorphCollection') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.alt_value = _arg5
    ...
    @staticmethod
    def _new1371(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : str, _arg5 : str, _arg6 : bool, _arg7 : 'MorphCollection') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.value = _arg4
        res.alt_value = _arg5
    ...
    @staticmethod
    def _new1373(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'ItemType', _arg4 : 'ReferentToken') -> 'CityItemToken':
        res = CityItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.org_ref = _arg4
        return res