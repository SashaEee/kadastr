...
class FundsItemToken(MetaToken):
    ...
    def try_parse(t : 'Token', prev : 'FundsItemToken'=None) -> 'FundsItemToken':
        ...
        while True:
            ...
            if (isinstance(re, OrganizationReferent)): 
                return FundsItemToken._new762(t, tt, FundsItemTyp.ORG, re)
            if (isinstance(re, MoneyReferent)): 
                ...
                if ((tt.next0_ is not None and tt.next0_.is_value("ЗА", None) and tt.next0_.next0_ is not None) and ((tt.next0_.next0_.is_value("АКЦИЯ", None) or tt.next0_.next0_.is_value("АКЦІЯ", None)))): 
                    typ0 = FundsItemTyp.PRICE
                res = FundsItemToken._new762(t, tt, typ0, re)
                return res
            if (re is not None): 
                break
            ...
            if (npt is not None): 
                ...
                if (npt.noun.is_value("АКЦІЯ", None) or npt.noun.is_value("АКЦИЯ", None)): 
                    res = FundsItemToken._new764(t, npt.end_token, FundsItemTyp.NOUN, FundsKind.STOCK)
                    if (len(npt.adjectives) > 0): 
                        for v in FundsItemToken.__m_act_types: 
                            if (npt.adjectives[0].is_value(v, None)): 
                                res.string_val = npt.get_normal_case_text(None, MorphNumber.SINGULAR, MorphGender.UNDEFINED, False).lower()
                    ...
                    res = FundsItemToken._new765(t, npt.end_token, FundsItemTyp.NOUN, FundsKind.STOCK, "ценные бумаги")
                    ...
                    res = FundsItemToken._new764(t, npt.end_token, FundsItemTyp.NOUN, FundsKind.CAPITAL)
                if (res is not None): 
                    rt = res.kit.process_referent(OrganizationAnalyzer.ANALYZER_NAME, res.end_token.next0_, None)
                    if (rt is not None): 
                        res.ref = rt.referent
            ...
            if (prev is not None and prev.typ == FundsItemTyp.COUNT): 
                ...
                if (val is not None): 
                    ...
                    first_pass3377 = True
                    while True:
                        if first_pass3377: first_pass3377 = False
                    ...
                    if (not ok): 
                        ...
                        while ttt is not None: 
                            ...
                            ttt = ttt.next0_
                    if (ok): 
                        res = FundsItemToken._new767(t, tt, FundsKind.STOCK, FundsItemTyp.NOUN)
            ...
            if (isinstance(tt, NumberToken)): 
                ...
                if (num is not None): 
                    ...
                    if (num.ex_typ == NumberExType.PERCENT): 
                        res = FundsItemToken._new768(t, num.end_token, FundsItemTyp.PERCENT, num)
                ...
                if (t1.next0_ is not None and t1.next0_.is_value("ШТУКА", None)): 
                    t1 = t1.next0_
                return FundsItemToken._new768(t, t1, FundsItemTyp.COUNT, Utils.asObjectOrNull(tt, NumberToken))
            break
        return None
    ...
    def try_attach(t : 'Token') -> 'ReferentToken':
        ...
        first_pass3378 = True
        while True:
            if first_pass3378: first_pass3378 = False
            else: tt = tt.next0_
            if (not (tt is not None)): break
    ...
    @staticmethod
    def _new762(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'FundsItemTyp', _arg4 : 'Referent') -> 'FundsItemToken':
    ...
    @staticmethod
    def _new764(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'FundsItemTyp', _arg4 : 'FundsKind') -> 'FundsItemToken':
        res = FundsItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.kind = _arg4
        return res
    ...
    @staticmethod
    def _new765(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'FundsItemTyp', _arg4 : 'FundsKind', _arg5 : str) -> 'FundsItemToken':
        res = FundsItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.kind = _arg4
    ...
    @staticmethod
    def _new767(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'FundsKind', _arg4 : 'FundsItemTyp') -> 'FundsItemToken':
        res = FundsItemToken(_arg1, _arg2)
        res.kind = _arg3
        res.typ = _arg4
        return res
    ...
    @staticmethod
    def _new768(_arg1 : 'Token', _arg2 : 'Token', _arg3 : 'FundsItemTyp', _arg4 : 'NumberToken') -> 'FundsItemToken':
        res = FundsItemToken(_arg1, _arg2)
        res.typ = _arg3
        res.num_val = _arg4
        return res
