...
class BusinessAnalyzer(Analyzer):
    ...
    def images(self) -> typing.List[tuple]:
        res = dict()
        res[MetaBusinessFact.IMAGE_ID] = ResourceHelper3.get_bytes("businessfact.png")
        res[FundsMeta.IMAGE_ID] = ResourceHelper3.get_bytes("creditcards.png")
        return res
    ...
    def process(self, kit : 'AnalysisKit') -> None:
        ...
        first_pass3379 = True
        while True:
            if first_pass3379: first_pass3379 = False
            else: t = t.next0_
    ...
    def __analize_get(self, bfi : 'BusinessFactItem') -> 'ReferentToken':
        ...
        if ((isinstance(t1.get_referent(), FundsReferent)) and not (isinstance(bef.referent, FundsReferent))): 
            ...
            bfr = BusinessFactReferent._new770(bfi.base_kind)
    ...
    def __analize_get2(self, t : 'Token') -> 'ReferentToken':
        ...
        if (master is not None and slave is not None): 
            bfr = BusinessFactReferent._new770(BusinessFactKind.HAVE)
            bfr.who = master
    ...
    def __analize_profit(self, bfi : 'BusinessFactItem') -> 'ReferentToken':
        ...
        if (org0_ is not None): 
            ...
            rt = t.kit.process_referent(OrganizationAnalyzer.ANALYZER_NAME, t.next0_, None)
            if (rt is not None): 
    ...
    def __analize_agreement(self, bfi : 'BusinessFactItem') -> 'ReferentToken':
        ...
        if (first is None or second is None): 
            return None
        bf = BusinessFactReferent._new770(bfi.base_kind)
        bf.who = first
    ...
    def __analize_likelihoods(self, rt : 'ReferentToken') -> typing.List['ReferentToken']:
        ...
        i = 0
        while i < len(whos): 
            bfr = BusinessFactReferent._new781(bfr0.kind, bfr0.typ)
