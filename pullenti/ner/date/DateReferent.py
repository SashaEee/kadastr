...
class DateReferent(Referent):
    ...
    def calculate_date_range(self, now : datetime.datetime, from0_ : datetime.datetime, to : datetime.datetime, tense : int=0) -> bool:
        ...
        """
        from pullenti.ner.date.internal.DateRelHelper import DateRelHelper
        inoutres1293 = DateRelHelper.calculate_date_range(self, now, from0_, to, tense)
        return inoutres1293
        ...
        if (self.is_relative): 
            ...
            for s in self.slots: 
                if (s.type_name == DateReferent.ATTR_CENTURY): 
                    word = "век"
                    wrapval1295 = RefOutArgWrapper(0)
                    Utils.tryParseInt(Utils.asObjectOrNull(s.value, str), wrapval1295)
                    val = wrapval1295.value
                elif (s.type_name == DateReferent.ATTR_DECADE): 
                    word = "декада"
                    wrapval1296 = RefOutArgWrapper(0)
                    Utils.tryParseInt(Utils.asObjectOrNull(s.value, str), wrapval1296)
                    val = wrapval1296.value
                elif (s.type_name == DateReferent.ATTR_HALFYEAR): 
                    word = "полугодие"
                    wrapval1297 = RefOutArgWrapper(0)
                    Utils.tryParseInt(Utils.asObjectOrNull(s.value, str), wrapval1297)
                    val = wrapval1297.value
                elif (s.type_name == DateReferent.ATTR_SEASON): 
                    wrapval1298 = RefOutArgWrapper(0)
                    Utils.tryParseInt(Utils.asObjectOrNull(s.value, str), wrapval1298)
                    val = wrapval1298.value
                    if (val == 1): 
                    ...
                    word = "год"
                    wrapval1299 = RefOutArgWrapper(0)
                    Utils.tryParseInt(Utils.asObjectOrNull(s.value, str), wrapval1299)
                    val = wrapval1299.value
                elif (s.type_name == DateReferent.ATTR_MONTH): 
                    word = "месяц"
                    wrapval1300 = RefOutArgWrapper(0)
                    Utils.tryParseInt(Utils.asObjectOrNull(s.value, str), wrapval1300)
                    val = wrapval1300.value
                    ...
                    word = "день"
                    wrapval1301 = RefOutArgWrapper(0)
                    Utils.tryParseInt(Utils.asObjectOrNull(s.value, str), wrapval1301)
                    val = wrapval1301.value
                    ...
                    word = "квартал"
                    wrapval1302 = RefOutArgWrapper(0)
                    Utils.tryParseInt(Utils.asObjectOrNull(s.value, str), wrapval1302)
                    val = wrapval1302.value
                elif (s.type_name == DateReferent.ATTR_WEEK): 
                    word = "неделя"
                    wrapval1303 = RefOutArgWrapper(0)
                    Utils.tryParseInt(Utils.asObjectOrNull(s.value, str), wrapval1303)
                    val = wrapval1303.value
                elif (s.type_name == DateReferent.ATTR_HOUR): 
                    word = "час"
                    wrapval1304 = RefOutArgWrapper(0)
                    Utils.tryParseInt(Utils.asObjectOrNull(s.value, str), wrapval1304)
                    val = wrapval1304.value
                    if (not is_local_rel): 
                        print("{0}:{1}".format("{:02d}".format(val), "{:02d}".format(self.minute)), end="", file=res, flush=True)
                elif (s.type_name == DateReferent.ATTR_MINUTE): 
                    word = "минута"
                    wrapval1305 = RefOutArgWrapper(0)
                    Utils.tryParseInt(Utils.asObjectOrNull(s.value, str), wrapval1305)
                    val = wrapval1305.value
                elif (s.type_name == DateReferent.ATTR_DAYOFWEEK): 
                    wrapval1306 = RefOutArgWrapper(0)
                    Utils.tryParseInt(Utils.asObjectOrNull(s.value, str), wrapval1306)
                    val = wrapval1306.value
                    if (not is_local_rel): 
    ...
    @staticmethod
    def _new1205(_arg1 : 'DateReferent', _arg2 : int) -> 'DateReferent':
        res = DateReferent()
        res.higher = _arg1
        res.day = _arg2
        return res
    ...
    @staticmethod
    def _new1206(_arg1 : int, _arg2 : int) -> 'DateReferent':
        res = DateReferent()
        res.month = _arg1
        res.day = _arg2
        return res
    ...
    @staticmethod
    def _new1207(_arg1 : int) -> 'DateReferent':
        res = DateReferent()
        res.year = _arg1
        return res
    
    @staticmethod
    def _new1212(_arg1 : int, _arg2 : int) -> 'DateReferent':
        res = DateReferent()
        res.hour = _arg1
        res.minute = _arg2
        return res
    ...
    @staticmethod
    def _new1214(_arg1 : 'DatePointerType') -> 'DateReferent':
        res = DateReferent()
        res.pointer = _arg1
        return res
    
    @staticmethod
    def _new1226(_arg1 : int, _arg2 : 'DateReferent') -> 'DateReferent':
        res = DateReferent()
        res.month = _arg1
        res.higher = _arg2
        return res
    ...
    @staticmethod
    def _new1231(_arg1 : int, _arg2 : 'DateReferent') -> 'DateReferent':
        res = DateReferent()
        res.day = _arg1
        res.higher = _arg2
        return res
    ...
    @staticmethod
    def _new1244(_arg1 : int) -> 'DateReferent':
        res = DateReferent()
        res.month = _arg1
        return res
    
    @staticmethod
    def _new1246(_arg1 : int, _arg2 : int, _arg3 : 'DateReferent') -> 'DateReferent':
        res = DateReferent()
        res.hour = _arg1
        res.minute = _arg2
        res.higher = _arg3
    ...
    @staticmethod
    def _new1265(_arg1 : int, _arg2 : bool) -> 'DateReferent':
        res = DateReferent()
        res.century = _arg1
    ...
    @staticmethod
    def _new1266(_arg1 : int, _arg2 : bool) -> 'DateReferent':
        res = DateReferent()
        res.decade = _arg1
        res.is_relative = _arg2
        return res
    ...
    @staticmethod
    def _new1273(_arg1 : int) -> 'DateReferent':
        res = DateReferent()
        res.day = _arg1
        return res
    
    @staticmethod
    def _new1275(_arg1 : 'DateReferent') -> 'DateReferent':
        res = DateReferent()
        res.higher = _arg1
        return res
    
    @staticmethod
    def _new1276(_arg1 : 'DateReferent', _arg2 : int) -> 'DateReferent':
        res = DateReferent()
        res.higher = _arg1
        res.month = _arg2
        return res
    ...
    @staticmethod
    def _new1286(_arg1 : int) -> 'DateReferent':
        res = DateReferent()
