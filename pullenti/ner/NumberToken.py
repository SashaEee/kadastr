...
class NumberToken(MetaToken):
    ...
    def value(self, value_) -> str:
        ...
        n = 0
        wrapn3143 = RefOutArgWrapper(0)
        inoutres3144 = Utils.tryParseInt(self.__m_value, wrapn3143)
        n = wrapn3143.value
        if (inoutres3144): 
            self.__m_int_val = n
        else: 
    ...
    @staticmethod
    def _new942(_arg1 : 'Token', _arg2 : 'Token', _arg3 : str, _arg4 : 'NumberSpellingType', _arg5 : 'MorphCollection') -> 'NumberToken':
