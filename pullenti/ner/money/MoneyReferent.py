...
class MoneyReferent(Referent):
    ...
    def value(self) -> float:
        ...
        if (val is None): 
            return 0
        v = 0
        wrapv1941 = RefOutArgWrapper(0)
        inoutres1942 = Utils.tryParseFloat(val, wrapv1941)
        v = wrapv1941.value
        if (not inoutres1942): 
            return 0
        return v
    ...
    def alt_value(self) -> float:
        ...
        if (val is None): 
            return None
        v = 0
        wrapv1943 = RefOutArgWrapper(0)
        inoutres1944 = Utils.tryParseFloat(val, wrapv1943)
        v = wrapv1943.value
        if (not inoutres1944): 
            return None
        return v
    ...
    def rest(self) -> int:
        ...
        if (val is None): 
            return 0
        v = 0
        wrapv1945 = RefOutArgWrapper(0)
        inoutres1946 = Utils.tryParseInt(val, wrapv1945)
        v = wrapv1945.value
        if (not inoutres1946): 
            return 0
        return v
    ...
    def alt_rest(self) -> int:
        ...
        if (val is None): 
            return None
        v = 0
        wrapv1947 = RefOutArgWrapper(0)
        inoutres1948 = Utils.tryParseInt(val, wrapv1947)
        v = wrapv1947.value
        if (not inoutres1948): 
            return None
        return v
