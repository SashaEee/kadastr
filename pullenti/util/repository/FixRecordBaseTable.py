...
class FixRecordBaseTable(KeyBaseTable):
    """ Таблица репозитория типа "ключ - значение фиксированной структуры" """
    ...
    class FixRecordsBuffer:
        ...
        def cut(self, max_count_ : int, float_ind : int) -> bool:
            ...
            while i < len(self.__m_floats[float_ind]): 
                li.append(FixRecordBaseTable.Temp._new3211(i, self.__m_floats[float_ind][i]))
                i += 1
    ...
    class Temp(object):
        ...
        @staticmethod
        def _new3211(_arg1 : int, _arg2 : float) -> 'Temp':
    ...
    def begin_fetch_all_fix_records_buffer(self, first_id : int=1) -> None:
        """ Начать массовое извлечение термов
