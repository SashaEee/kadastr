...
class ConsoleHelper:
        ...
        try: 
            if (pathlib.Path(ConsoleHelper.get_log_file_name()).is_file()): 
                if (save_log): 
                    ...
                    except Exception as ex3237: 
                        pass
                try: 
                    pathlib.Path(ConsoleHelper.get_log_file_name()).unlink()
                except Exception as ex3238: 
                    pass
    ...
    def __write(str0_ : str) -> None:
        ...
        try: 
            ...
            if (str0_.find('\n') >= 0 or ConsoleHelper.__m_stream.length == (0)): 
                ...
                if (ConsoleHelper.__m_stream.length == (0)): 
                    str0_ = "{0} {1}".format(time.strip(), str0_)
                str0_ = str0_.replace("\n", time)
