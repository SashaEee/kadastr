...
class MorphLang:
    ...
    def __and__(self : 'MorphLang', arg2 : 'MorphLang') -> 'MorphLang':
        ...
        if (arg2 is not None): 
            val2 = arg2.value
        return MorphLang._new330(((val1) & (val2)))
    ...
    @staticmethod
    def _new330(_arg1 : int) -> 'MorphLang':
        res = MorphLang()
        res.value = _arg1
        return res
    
    @staticmethod
    def _new332(_arg1 : bool) -> 'MorphLang':
        res = MorphLang()
        res.is_ru = _arg1
        return res
    
    @staticmethod
    def _new333(_arg1 : bool) -> 'MorphLang':
        res = MorphLang()
        res.is_ua = _arg1
        return res
    
    @staticmethod
    def _new334(_arg1 : bool) -> 'MorphLang':
        res = MorphLang()
        res.is_by = _arg1
        return res
    
    @staticmethod
    def _new335(_arg1 : bool) -> 'MorphLang':
        res = MorphLang()
        res.is_en = _arg1
        return res
    
    @staticmethod
    def _new336(_arg1 : bool) -> 'MorphLang':
        res = MorphLang()
        res.is_it = _arg1
        return res
    
    @staticmethod
    def _new337(_arg1 : bool) -> 'MorphLang':
        res = MorphLang()
        res.is_kz = _arg1
        return res
    ...
    def _static_ctor():
        ...
        MorphLang.RU = MorphLang._new332(True)
        MorphLang.UA = MorphLang._new333(True)
        MorphLang.BY = MorphLang._new334(True)
        MorphLang.EN = MorphLang._new335(True)
        MorphLang.IT = MorphLang._new336(True)
        MorphLang.KZ = MorphLang._new337(True)
