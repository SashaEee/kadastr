...
class MorphClass:
    ...
    def __and__(self : 'MorphClass', arg2 : 'MorphClass') -> 'MorphClass':
        ...
        if (arg2 is not None): 
            val2 = arg2.value
        return MorphClass._new327(((val1) & (val2)))
    ...
    @staticmethod
    def _new318(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_undefined = _arg1
        return res
    
    @staticmethod
    def _new319(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_noun = _arg1
        return res
    
    @staticmethod
    def _new320(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_pronoun = _arg1
        return res
    
    @staticmethod
    def _new321(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_personal_pronoun = _arg1
        return res
    
    @staticmethod
    def _new322(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_verb = _arg1
        return res
    
    @staticmethod
    def _new323(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_adjective = _arg1
        return res
    
    @staticmethod
    def _new324(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_adverb = _arg1
        return res
    
    @staticmethod
    def _new325(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_preposition = _arg1
        return res
    
    @staticmethod
    def _new326(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
        res.is_conjunction = _arg1
        return res
    
    @staticmethod
    def _new327(_arg1 : int) -> 'MorphClass':
        res = MorphClass()
        res.value = _arg1
        return res
    
    @staticmethod
    def _new2871(_arg1 : bool) -> 'MorphClass':
        res = MorphClass()
    ...
    def _static_ctor():
        ...
        MorphClass.UNDEFINED = MorphClass._new318(True)
        MorphClass.NOUN = MorphClass._new319(True)
        MorphClass.PRONOUN = MorphClass._new320(True)
        MorphClass.PERSONAL_PRONOUN = MorphClass._new321(True)
        MorphClass.VERB = MorphClass._new322(True)
        MorphClass.ADJECTIVE = MorphClass._new323(True)
        MorphClass.ADVERB = MorphClass._new324(True)
        MorphClass.PREPOSITION = MorphClass._new325(True)
        MorphClass.CONJUNCTION = MorphClass._new326(True)
